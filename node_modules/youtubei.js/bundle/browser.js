...
var Maybe = class {
  ...
  isObserved() {
    var _a3;
    return (_a3 = __classPrivateFieldGet(this, _Maybe_value, "f")) === null || _a3 === void 0 ? void 0 : _a3[isObserved];
  }
  parsed() {
...
var DropdownItem = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "icon")) {
      this.icon_type = (_a3 = data2.icon) === null || _a3 === void 0 ? void 0 : _a3.iconType;
    }
...
var NavigationEndpoint = class extends YTNode {
  constructor(data2) {
    ...
    this.metadata = {};
    if ((_b = (_a3 = data2 === null || data2 === void 0 ? void 0 : data2.commandMetadata) === null || _a3 === void 0 ? void 0 : _a3.webCommandMetadata) === null || _b === void 0 ? void 0 : _b.url) {
...
var EmojiRun = class {
  constructor(data2) {
    ...
    this.text = ((_a3 = data2.emoji) === null || _a3 === void 0 ? void 0 : _a3.emojiId) || ((_c = (_b = data2.emoji) === null || _b === void 0 ? void 0 : _b.shortcuts) === null || _c === void 0 ? void 0 : _c[0]) || "";
    this.emoji = {
...
var Text = class {
  ...
  static fromAttributed(data2) {
    ...
    const command_runs = data2.commandRuns;
    ...
    if (command_runs) {
      for (const item of command_runs) {
        ...
        if (Reflect.has(item, "onTap")) {
          let attachment = null;
          if (Reflect.has(data2, "attachmentRuns")) {
            const attachment_runs = data2.attachmentRuns;
...
var ExpandableVideoDescriptionBody = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "attributedDescriptionBodyText")) {
      this.attributed_description_body_text = (_a3 = data2.attributedDescriptionBodyText) === null || _a3 === void 0 ? void 0 : _a3.content;
    }
  }
};
...
var ExpandableMetadata = class extends YTNode {
  constructor(data2) {
    ...
    this.expanded_content = parser_default.parseItem(data2.expandedContent, [HorizontalCardList_default, HorizontalList_default]);
...
var Video = class extends YTNode {
  constructor(data2) {
    var _a3, _b, _c;
    super();
    const overlay_time_status = ((_a3 = data2.thumbnailOverlays.find((overlay) => overlay.thumbnailOverlayTimeStatusRenderer)) === null || _a3 === void 0 ? void 0 : _a3.thumbnailOverlayTimeStatusRenderer.text) || "N/A";
...
var UploadTimeFactoid = class extends YTNode {
  constructor(data2) {
    super();
    this.factoid = parser_default.parseItem(data2.factoid, Factoid_default);
  }
};
...
var VideoDescriptionHeader = class extends YTNode {
  constructor(data2) {
    ...
    this.factoids = parser_default.parseArray(data2.factoid, [Factoid_default, ViewCountFactoid_default, UploadTimeFactoid_default]);
  }
};
...
var VideoDescriptionInfocardsSection = class extends YTNode {
  constructor(data2) {
    ...
    this.creator_videos_button = parser_default.parseItem(data2.creatorVideosButton, Button_default);
    this.creator_about_button = parser_default.parseItem(data2.creatorAboutButton, Button_default);
...
var CarouselLockup = class extends YTNode {
  constructor(data2) {
    super();
    this.info_rows = parser_default.parseArray(data2.infoRows, InfoRow_default);
    this.video_lockup = parser_default.parseItem(data2.videoLockup, CompactVideo_default);
  }
};
...
var VideoDescriptionMusicSection = class extends YTNode {
  constructor(data2) {
    super();
    this.carousel_lockups = parser_default.parseArray(data2.carouselLockups, CarouselLockup_default);
    this.section_title = new Text(data2.sectionTitle);
  }
};
...
var VideoDescriptionTranscriptSection = class extends YTNode {
  constructor(data2) {
    ...
    this.primary_button = parser_default.parseItem(data2.primaryButton, Button_default);
  }
};
...
var VideoDescriptionCourseSection = class extends YTNode {
  constructor(data2) {
    super();
    this.section_title = new Text(data2.sectionTitle);
    this.media_lockups = parser_default.parseArray(data2.mediaLockups, [StructuredDescriptionPlaylistLockup_default]);
  }
};
...
var EngagementPanelSectionList = class extends YTNode {
  constructor(data2) {
    super();
    this.header = parser_default.parseItem(data2.header, EngagementPanelTitleHeader_default);
    this.content = parser_default.parseItem(data2.content, [SectionList_default, ContinuationItem_default, StructuredDescriptionContent_default, MacroMarkersList_default, ProductList_default]);
...
var Format = class {
  constructor(data2, this_response_nsig_cache) {
    ...
    this.color_info = data2.colorInfo ? {
      primaries: (_a3 = data2.colorInfo.primaries) === null || _a3 === void 0 ? void 0 : _a3.replace("COLOR_PRIMARIES_", ""),
      transfer_characteristics: (_b = data2.colorInfo.transferCharacteristics) === null || _b === void 0 ? void 0 : _b.replace("COLOR_TRANSFER_CHARACTERISTICS_", ""),
      matrix_coefficients: (_c = data2.colorInfo.matrixCoefficients) === null || _c === void 0 ? void 0 : _c.replace("COLOR_MATRIX_COEFFICIENTS_", "")
    } : void 0;
    if (this.has_audio) {
...
var AppendContinuationItemsAction = class extends YTNode {
  constructor(data2) {
    super();
    this.contents = parser_default.parseArray(data2.continuationItems);
...
var TranscriptFooter = class extends YTNode {
  constructor(data2) {
    super();
    this.language_menu = parser_default.parseItem(data2.languageMenu, SortFilterSubMenu_default);
  }
};
...
var TranscriptSegmentList = class extends YTNode {
  constructor(data2) {
    super();
    this.initial_segments = parser_default.parseArray(data2.initialSegments, [TranscriptSegment_default, TranscriptSectionHeader_default]);
...
var TranscriptSearchPanel = class extends YTNode {
  constructor(data2) {
    super();
    this.header = parser_default.parseItem(data2.header, TranscriptSearchBox_default);
    this.body = parser_default.parseItem(data2.body, TranscriptSegmentList_default);
    this.footer = parser_default.parseItem(data2.footer, TranscriptFooter_default);
    this.target_id = data2.targetId;
  }
};
...
var Transcript = class extends YTNode {
  constructor(data2) {
    super();
    this.content = parser_default.parseItem(data2.content, TranscriptSearchPanel_default);
  }
};
...
var UpdateEngagementPanelAction = class extends YTNode {
  constructor(data2) {
    super();
    this.target_id = data2.targetId;
    this.content = parser_default.parseItem(data2.content, Transcript_default);
  }
};
...
var AutomixPreviewVideo = class extends YTNode {
  constructor(data2) {
    var _a3, _b;
    super();
    if ((_b = (_a3 = data2 === null || data2 === void 0 ? void 0 : data2.content) === null || _a3 === void 0 ? void 0 : _a3.automixPlaylistVideoRenderer) === null || _b === void 0 ? void 0 : _b.navigationEndpoint) {
      this.playlist_video = {
...
var ToggleButton = class extends YTNode {
  constructor(data2) {
    ...
    this.is_disabled = data2.isDisabled;
    this.icon_type = (_a3 = data2.defaultIcon) === null || _a3 === void 0 ? void 0 : _a3.iconType;
  ...
  constructor(data2) {
    ...
    this.heart_color = {
      basic_color_palette_data: {
        foreground_title_color: (_b = (_a3 = data2.heartColor) === null || _a3 === void 0 ? void 0 : _a3.basicColorPaletteData) === null || _b === void 0 ? void 0 : _b.foregroundTitleColor
      }
    };
...
var BackstagePost = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "voteButton")) {
      this.vote_button = parser_default.parseItem(data2.voteButton, Button_default);
    }
    if (Reflect.has(data2, "navigationEndpoint")) {
      this.endpoint = new NavigationEndpoint_default(data2.navigationEndpoint);
    }
...
var ChannelHeaderLinks = class extends YTNode {
  constructor(data2) {
    var _a3, _b;
    super();
    this.primary = observe(((_a3 = data2.primaryLinks) === null || _a3 === void 0 ? void 0 : _a3.map((link) => new HeaderLink(link))) || []);
...
var SubscribeButton = class extends YTNode {
  constructor(data2) {
    ...
    this.endpoint = new NavigationEndpoint_default(((_a3 = data2.serviceEndpoints) === null || _a3 === void 0 ? void 0 : _a3[0]) || ((_b = data2.onSubscribeEndpoints) === null || _b === void 0 ? void 0 : _b[0]));
  }
};
...
var C4TabbedHeader = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "headerLinks")) {
      this.header_links = parser_default.parseItem(data2.headerLinks, [ChannelHeaderLinks_default, ChannelHeaderLinksView_default]);
    }
...
var ChannelAboutFullMetadata = class extends YTNode {
  constructor(data2) {
    ...
    this.primary_links = (_b = (_a3 = data2.primaryLinks) === null || _a3 === void 0 ? void 0 : _a3.map((link) => ({
...
var ChannelThumbnailWithLink = class extends YTNode {
  constructor(data2) {
    ...
    this.thumbnails = Thumbnail.fromResponse(data2.thumbnail);
    this.endpoint = new NavigationEndpoint_default(data2.navigationEndpoint);
    this.label = (_b = (_a3 = data2.accessibility) === null || _a3 === void 0 ? void 0 : _a3.accessibilityData) === null || _b === void 0 ? void 0 : _b.label;
  }
};
...
var PdgCommentChip = class extends YTNode {
  constructor(data2) {
    ...
    this.color_pallette = {
      background_color: (_a3 = data2.chipColorPalette) === null || _a3 === void 0 ? void 0 : _a3.backgroundColor,
...
function encodeMusicSearchFilters(filters) {
  ...
  if (filters.type && filters.type !== "all" && ((_a3 = data2.filters) === null || _a3 === void 0 ? void 0 : _a3.type))
...
var CommentThread = class extends YTNode {
  ...
  getContinuation() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet(this, _CommentThread_actions, "f"))
        throw new InnertubeError("Actions instance not set for this thread.");
      const load_more_button = (_a3 = __classPrivateFieldGet(this, _CommentThread_continuation, "f").button) === null || _a3 === void 0 ? void 0 : _a3.as(Button_default);
      if (!load_more_button)
...
var Playlist = class extends YTNode {
  constructor(data2) {
    ...
    this.title = new Text(data2.title);
    this.author = ((_a3 = data2.shortBylineText) === null || _a3 === void 0 ? void 0 : _a3.simpleText) ? new Text(data2.shortBylineText) : new Author_default(data2.longBylineText, data2.ownerBadges, null);
    ...
    if (Reflect.has(data2, "thumbnailRenderer")) {
      this.thumbnail_renderer = parser_default.parseItem(data2.thumbnailRenderer, [PlaylistVideoThumbnail_default, PlaylistCustomThumbnail_default]) || void 0;
    }
...
var ContentPreviewImageView = class extends YTNode {
  constructor(data2) {
    super();
    this.image = data2.image.sources.map((x) => new Thumbnail(x)).sort((a, b) => b.width - a.width);
    this.style = data2.style;
  }
};
...
var MultiMarkersPlayerBar = class extends YTNode {
  constructor(data2) {
    var _a3;
    super();
    this.markers_map = observe(((_a3 = data2.markersMap) === null || _a3 === void 0 ? void 0 : _a3.map((marker) => new Marker(marker))) || []);
  }
};
...
var ChildElement = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "type") && Reflect.has(data2.type, "textType")) {
      this.text = (_a3 = data2.type.textType.text) === null || _a3 === void 0 ? void 0 : _a3.content;
    }
...
var Element = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "newElement") && Reflect.has(data2.newElement, "childElements")) {
      this.child_elements = observe(((_a3 = data2.newElement.childElements) === null || _a3 === void 0 ? void 0 : _a3.map((el) => new ChildElement_default(el))) || []);
    }
  }
};
...
var Grid = class extends YTNode {
  constructor(data2) {
    ...
    this.continuation = ((_c = (_b = (_a3 = data2.continuations) === null || _a3 === void 0 ? void 0 : _a3[0]) === null || _b === void 0 ? void 0 : _b.nextContinuationData) === null || _c === void 0 ? void 0 : _c.continuation) || null;
  }
  get contents() {
    return this.items;
  }
...
var GridMix = class extends YTNode {
  constructor(data2) {
    ...
    this.id = data2.playlistId;
    this.title = new Text(data2.title);
    this.author = ((_a3 = data2.shortBylineText) === null || _a3 === void 0 ? void 0 : _a3.simpleText) ? new Text(data2.shortBylineText) : ((_b = data2.longBylineText) === null || _b === void 0 ? void 0 : _b.simpleText) ? new Text(data2.longBylineText) : null;
    this.thumbnails = Thumbnail.fromResponse(data2.thumbnail);
    this.video_count = new Text(data2.videoCountText);
    this.video_count_short = new Text(data2.videoCountShortText);
    this.endpoint = new NavigationEndpoint_default(data2.navigationEndpoint);
...
var GridMovie = class extends YTNode {
  constructor(data2) {
    var _a3;
    super();
    const length_alt = (_a3 = data2.thumbnailOverlays.find((overlay) => overlay.hasOwnProperty("thumbnailOverlayTimeStatusRenderer"))) === null || _a3 === void 0 ? void 0 : _a3.thumbnailOverlayTimeStatusRenderer;
    this.id = data2.videoId;
    this.title = new Text(data2.title);
    this.thumbnails = Thumbnail.fromResponse(data2.thumbnail);
...
var GridPlaylist = class extends YTNode {
  constructor(data2) {
    ...
    this.sidebar_thumbnails = [].concat(...((_a3 = data2.sidebarThumbnails) === null || _a3 === void 0 ? void 0 : _a3.map((thumbnail) => Thumbnail.fromResponse(thumbnail))) || []) || null;
    this.video_count = new Text(data2.thumbnailText);
    this.video_count_short = new Text(data2.videoCountShortText);
  }
};
...
var ItemSection = class extends YTNode {
  constructor(data2) {
    ...
    if (data2.continuations) {
      this.continuation = (_c = (_b = (_a3 = data2.continuations) === null || _a3 === void 0 ? void 0 : _a3.at(0)) === null || _b === void 0 ? void 0 : _b.nextContinuationData) === null || _c === void 0 ? void 0 : _c.continuation;
    }
  }
};
...
var LiveChat = class extends YTNode {
  constructor(data2) {
    ...
    this.continuation = (_b = (_a3 = data2.continuations[0]) === null || _a3 === void 0 ? void 0 : _a3.reloadContinuationData) === null || _b === void 0 ? void 0 : _b.continuation;
...
var LiveChatTickerPaidMessageItem = class extends YTNode {
  constructor(data2) {
    ...
    this.show_item = parser_default.parseItem((_b = (_a3 = data2.showItemEndpoint) === null || _a3 === void 0 ? void 0 : _a3.showLiveChatItemEndpoint) === null || _b === void 0 ? void 0 : _b.renderer);
...
var ReplayChatItemAction = class extends YTNode {
  constructor(data2) {
    var _a3;
    super();
    this.actions = parser_default.parseArray((_a3 = data2.actions) === null || _a3 === void 0 ? void 0 : _a3.map((action) => {
...
var MenuPopup = class extends YTNode {
  constructor(data2) {
    super();
    this.items = parser_default.parseArray(data2.items, [MenuNavigationItem_default, MenuServiceItem_default]);
  }
};
...
var MusicMultiSelectMenu = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "title") && Reflect.has(data2.title, "musicMenuTitleRenderer")) {
      this.title = new Text((_a3 = data2.title.musicMenuTitleRenderer) === null || _a3 === void 0 ? void 0 : _a3.primaryText);
    }
...
var MovingThumbnail = class extends YTNode {
  constructor(data2) {
    var _a3;
    super();
    return (_a3 = data2.movingThumbnailDetails) === null || _a3 === void 0 ? void 0 : _a3.thumbnails.map((thumbnail) => new Thumbnail(thumbnail)).sort((a, b) => b.width - a.width);
  }
};
...
var MusicPlayButton = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "accessibilityPlayData")) {
      this.play_label = (_a3 = data2.accessibilityPlayData.accessibilityData) === null || _a3 === void 0 ? void 0 : _a3.label;
    }
...
var MusicResponsiveListItem = class extends YTNode {
  constructor(data2) {
    ...
    __classPrivateFieldSet(this, _MusicResponsiveListItem_playlist_item_data, {
      video_id: ((_a3 = data2 === null || data2 === void 0 ? void 0 : data2.playlistItemData) === null || _a3 === void 0 ? void 0 : _a3.videoId) || null,
...
_MusicResponsiveListItem_playlist_item_data = /* @__PURE__ */ new WeakMap(), _MusicResponsiveListItem_instances = /* @__PURE__ */ new WeakSet(), _MusicResponsiveListItem_parseOther = /* @__PURE__ */ __name(function _MusicResponsiveListItem_parseOther2() {
  ...
  this.id = __classPrivateFieldGet(this, _MusicResponsiveListItem_playlist_item_data, "f").video_id || ((_b = (_a3 = this.endpoint) === null || _a3 === void 0 ? void 0 : _a3.payload) === null || _b === void 0 ? void 0 : _b.videoId);
  this.title = this.flex_columns.first().title.toString();
...
var MusicCarouselShelf = class extends YTNode {
  constructor(data2) {
    ...
    this.contents = parser_default.parseArray(data2.contents, [MusicTwoRowItem_default, MusicResponsiveListItem_default, MusicMultiRowListItem_default, MusicNavigationButton_default]);
...
var PlaylistPanelVideo = class extends YTNode {
  constructor(data2) {
    ...
    const album = (_a3 = new Text(data2.longBylineText).runs) === null || _a3 === void 0 ? void 0 : _a3.find((run) => {
      var _a4, _b2, _c2;
...
var PlaylistPanel = class extends YTNode {
  constructor(data2) {
    ...
    this.continuation = ((_c = (_b = (_a3 = data2.continuations) === null || _a3 === void 0 ? void 0 : _a3[0]) === null || _b === void 0 ? void 0 : _b.nextRadioContinuationData) === null || _c === void 0 ? void 0 : _c.continuation) || ((_f = (_e = (_d = data2.continuations) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.nextContinuationData) === null || _f === void 0 ? void 0 : _f.continuation);
...
var MusicShelf = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "continuations")) {
      this.continuation = ((_b = (_a3 = data2.continuations) === null || _a3 === void 0 ? void 0 : _a3[0].nextContinuationData) === null || _b === void 0 ? void 0 : _b.continuation) || ((_d = (_c = data2.continuations) === null || _c === void 0 ? void 0 : _c[0].reloadContinuationData) === null || _d === void 0 ? void 0 : _d.continuation);
    }
...
var MusicVisualHeader = class extends YTNode {
  constructor(data2) {
    ...
    super();
    this.title = new Text(data2.title);
    this.thumbnail = data2.thumbnail ? Thumbnail.fromResponse((_a3 = data2.thumbnail.musicThumbnailRenderer) === null || _a3 === void 0 ? void 0 : _a3.thumbnail) : [];
    this.menu = parser_default.parseItem(data2.menu, Menu_default);
...
var PageHeaderView = class extends YTNode {
  constructor(data2) {
    super();
    this.image = parser_default.parseItem(data2.image, ContentPreviewImageView_default);
    this.title = parser_default.parseItem(data2.title, DynamicTextView_default);
  }
};
...
var PageHeader = class extends YTNode {
  constructor(data2) {
    ...
    this.content = parser_default.parseItem(data2.content, PageHeaderView_default);
  }
};
...
var PlayerMicroformat = class extends YTNode {
  constructor(data2) {
    ...
    this.available_countries = data2.availableCountries;
    this.start_timestamp = ((_a3 = data2.liveBroadcastDetails) === null || _a3 === void 0 ? void 0 : _a3.startTimestamp) ? new Date(data2.liveBroadcastDetails.startTimestamp) : null;
  }
};
...
var PlaylistHeader = class extends YTNode {
  constructor(data2) {
    ...
    this.author = data2.ownerText || data2.ownerEndpoint ? new Author_default(Object.assign(Object.assign({}, data2.ownerText), { navigationEndpoint: data2.ownerEndpoint }), data2.ownerBadges, null) : null;
    this.description = new Text(data2.descriptionText);
...
var ProductListItem = class extends YTNode {
  constructor(data2) {
    ...
    this.view_button = parser_default.parseItem(data2.viewButton, Button_default);
  }
};
...
var TopicChannelDetails = class extends YTNode {
  constructor(data2) {
    ...
    super();
    this.title = new Text(data2.title);
    this.avatar = Thumbnail.fromResponse((_a3 = data2.thumbnail) !== null && _a3 !== void 0 ? _a3 : data2.avatar);
    this.subtitle = new Text(data2.subtitle);
    this.subscribe_button = parser_default.parseItem(data2.subscribeButton, SubscribeButton_default);
    this.endpoint = new NavigationEndpoint_default(data2.navigationEndpoint);
  }
...
var TwoColumnWatchNextResults = class extends YTNode {
  constructor(data2) {
    ...
    this.results = parser_default.parseArray((_a3 = data2.results) === null || _a3 === void 0 ? void 0 : _a3.results.contents);
...
var VideoPrimaryInfo = class extends YTNode {
  constructor(data2) {
    ...
    this.view_count = new Text((_b = (_a3 = data2.viewCount) === null || _a3 === void 0 ? void 0 : _a3.videoViewCountRenderer) === null || _b === void 0 ? void 0 : _b.viewCount);
...
var WatchCardHeroVideo = class extends YTNode {
  constructor(data2) {
    ...
    this.label = ((_a3 = data2.lengthText) === null || _a3 === void 0 ? void 0 : _a3.accessibility.accessibilityData.label) || "";
  }
};
...
var AnchoredSection = class extends YTNode {
  constructor(data2) {
    ...
    this.category_assets = {
      asset_key: (_a3 = data2.categoryAssets) === null || _a3 === void 0 ? void 0 : _a3.assetKey,
...
var KidsBlocklistPickerItem = class extends YTNode {
  constructor(data2) {
    ...
    this.avatar = Thumbnail.fromResponse(data2.avatar);
    this.block_button = parser_default.parseItem(data2.blockButton, [ToggleButton_default]);
...
var KidsBlocklistPicker = class extends YTNode {
  constructor(data2) {
    super();
    this.title = new Text(data2.title);
    this.child_rows = parser_default.parse(data2.childRows, true, [KidsBlocklistPickerItem_default]);
    this.done_button = parser_default.parseItem(data2.doneButton, [Button_default]);
...
function createRuntimeClass(classname, key_info, logger) {
  ...
  const node = (_a3 = /* @__PURE__ */ __name(class extends YTNode {
    static set key_info(key_info2) {
      __classPrivateFieldSet(this, _a3, new Map(key_info2), "f", _key_info);
    }
    static get key_info() {
      return [...__classPrivateFieldGet(this, _a3, "f", _key_info).entries()];
    }
    constructor(data2) {
      super();
  ...
  }, "_a"), __setFunctionName(_a3, "node"), _a3.type = classname, _key_info = { value: /* @__PURE__ */ new Map() }, _a3);
    ...
    case "misc":
      switch (inference_type.misc_type) {
        ...
        case "Author": {
          ...
          return author_should_optional ? new Author_default(accessDataFromKeyPath({ data: data2 }, [...key_path, inference_type.params[0]]), inference_type.params[1] ? accessDataFromKeyPath({ data: data2 }, [...key_path, inference_type.params[1]]) : void 0) : void 0;
        }
      }
      throw new Error("Unreachable code reached! Switch missing case!");
    case "primative":
...
var SectionListContinuation = class extends YTNode {
  constructor(data2) {
    ...
    this.continuation = ((_c = (_b = (_a3 = data2.continuations) === null || _a3 === void 0 ? void 0 : _a3[0]) === null || _b === void 0 ? void 0 : _b.nextContinuationData) === null || _c === void 0 ? void 0 : _c.continuation) || ((_f = (_e = (_d = data2.continuations) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.reloadContinuationData) === null || _f === void 0 ? void 0 : _f.continuation) || null;
  }
};
...
var MusicPlaylistShelfContinuation = class extends YTNode {
  constructor(data2) {
    ...
    super();
    this.contents = parse(data2.contents, true);
    this.continuation = ((_a3 = data2.continuations) === null || _a3 === void 0 ? void 0 : _a3[0].nextContinuationData.continuation) || null;
  }
};
...
var MusicShelfContinuation = class extends YTNode {
  constructor(data2) {
    ...
    super();
    this.contents = parseArray(data2.contents);
    this.continuation = ((_b = (_a3 = data2.continuations) === null || _a3 === void 0 ? void 0 : _a3[0].nextContinuationData) === null || _b === void 0 ? void 0 : _b.continuation) || ((_d = (_c = data2.continuations) === null || _c === void 0 ? void 0 : _c[0].reloadContinuationData) === null || _d === void 0 ? void 0 : _d.continuation) || null;
  }
};
...
var Continuation = class extends YTNode {
  constructor(data2) {
    ...
    this.timeout_ms = (_a3 = data2.continuation) === null || _a3 === void 0 ? void 0 : _a3.timeoutMs;
...
var LiveChatContinuation = class extends YTNode {
  constructor(data2) {
    var _a3, _b, _c, _d, _e, _f, _g, _h;
    super();
    this.actions = parse((_a3 = data2.actions) === null || _a3 === void 0 ? void 0 : _a3.map((action) => {
      delete action.clickTrackingParams;
      return action;
    }), true) || observe([]);
...
var ERROR_HANDLER = /* @__PURE__ */ __name((_a3) => {
  var { classname } = _a3, context = __rest(_a3, ["classname"]);
...
function parseResponse(data2) {
  ...
  _clearMemo();
  applyMutations(contents_memo, (_b = (_a3 = data2.frameworkUpdates) === null || _a3 === void 0 ? void 0 : _a3.entityBatchUpdate) === null || _b === void 0 ? void 0 : _b.mutations);
...
var Analytics = class {
  constructor(response) {
    ...
    this.sections = (_a3 = __classPrivateFieldGet(this, _Analytics_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(Element_default).map((el) => el.model).flatMap((el) => !el ? [] : el);
  }
  get page() {
...
var Feed = class {
  ...
  get page_contents() {
    var _a3;
    const tab_content = (_a3 = __classPrivateFieldGet(this, _Feed_memo, "f").getType(Tab_default)) === null || _a3 === void 0 ? void 0 : _a3.first().content;
  ...
  get secondary_contents() {
    var _a3, _b;
    if (!((_a3 = __classPrivateFieldGet(this, _Feed_page, "f").contents) === null || _a3 === void 0 ? void 0 : _a3.is_node))
      return void 0;
...
var TabbedFeed = class extends Feed_default {
  constructor(actions, data2, already_parsed = false) {
    ...
    __classPrivateFieldSet(this, _TabbedFeed_tabs, (_a3 = this.page.contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(Tab_default), "f");
  }
  get tabs() {
    var _a3, _b;
    return (_b = (_a3 = __classPrivateFieldGet(this, _TabbedFeed_tabs, "f")) === null || _a3 === void 0 ? void 0 : _a3.map((tab) => tab.title.toString())) !== null && _b !== void 0 ? _b : [];
  }
  getTabByName(title) {
    var _a3;
    return __awaiter(this, void 0, void 0, function* () {
      const tab = (_a3 = __classPrivateFieldGet(this, _TabbedFeed_tabs, "f")) === null || _a3 === void 0 ? void 0 : _a3.find((tab2) => tab2.title.toLowerCase() === title.toLowerCase());
      if (!tab)
  ...
  getTabByURL(url) {
    var _a3;
    return __awaiter(this, void 0, void 0, function* () {
      const tab = (_a3 = __classPrivateFieldGet(this, _TabbedFeed_tabs, "f")) === null || _a3 === void 0 ? void 0 : _a3.find((tab2) => {
        var _a4;
  ...
  hasTabWithURL(url) {
    var _a3, _b;
    return (_b = (_a3 = __classPrivateFieldGet(this, _TabbedFeed_tabs, "f")) === null || _a3 === void 0 ? void 0 : _a3.some((tab) => {
      var _a4;
...
var Comments = class {
  constructor(actions, data2, already_parsed = false) {
    ...
    this.contents = observe(threads.map((thread) => {
      var _a4;
      (_a4 = thread.comment) === null || _a4 === void 0 ? void 0 : _a4.setActions(__classPrivateFieldGet(this, _Comments_actions, "f"));
...
var LiveChat2 = class extends EventEmitterLike_default {
  constructor(video_info) {
    ...
    __classPrivateFieldSet(this, _LiveChat_continuation, (_a3 = video_info.livechat) === null || _a3 === void 0 ? void 0 : _a3.continuation, "f");
...
_LiveChat_actions = /* @__PURE__ */ new WeakMap(), _LiveChat_video_id = /* @__PURE__ */ new WeakMap(), _LiveChat_channel_id = /* @__PURE__ */ new WeakMap(), _LiveChat_continuation = /* @__PURE__ */ new WeakMap(), _LiveChat_mcontinuation = /* @__PURE__ */ new WeakMap(), _LiveChat_retry_count = /* @__PURE__ */ new WeakMap(), _LiveChat_instances = /* @__PURE__ */ new WeakSet(), _LiveChat_pollLivechat = /* @__PURE__ */ __name(function _LiveChat_pollLivechat2() {
  (() => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      this.emit("error", err);
      if ((__classPrivateFieldSet(this, _LiveChat_retry_count, (_b = __classPrivateFieldGet(this, _LiveChat_retry_count, "f"), _a3 = _b++, _b), "f"), _a3) < 10) {
        yield __classPrivateFieldGet(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
        __classPrivateFieldGet(this, _LiveChat_instances, "m", _LiveChat_pollLivechat2).call(this);
      } else {
  ...
  (() => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      __classPrivateFieldSet(this, _LiveChat_mcontinuation, (_a3 = data2.continuation) === null || _a3 === void 0 ? void 0 : _a3.token, "f");
      this.metadata = {
...
var Settings = class {
  constructor(actions, response) {
    ...
    this.sidebar = (_a3 = __classPrivateFieldGet(this, _Settings_page, "f").sidebar) === null || _a3 === void 0 ? void 0 : _a3.as(SettingsSidebar_default);
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            if (!body)
              throw new InnertubeError("Could not get ReadableStream from fetch Response.", { error_type: "FETCH_FAILED", response });
            try {
              for (var _d = true, _e = __asyncValues(streamToIterable(body)), _f; _f = yield _e.next(), _a3 = _f.done, !_a3; _d = true) {
                _c = _f.value;
                _d = false;
                const chunk = _c;
...
var TranscriptInfo = class {
  constructor(actions, response) {
    ...
    __classPrivateFieldSet(this, _TranscriptInfo_page, parser_default.parseResponse(response.data), "f");
...
var MediaInfo = class {
  constructor(data2, actions, cpn) {
    ...
    const next = ((_a3 = data2 === null || data2 === void 0 ? void 0 : data2[1]) === null || _a3 === void 0 ? void 0 : _a3.data) ? parser_default.parseResponse(data2[1].data) : void 0;
  ...
  toDash(url_transformer, format_filter, options = { include_thumbnails: false }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return toDash(this.streaming_data, url_transformer, format_filter, __classPrivateFieldGet(this, _MediaInfo_cpn, "f"), __classPrivateFieldGet(this, _MediaInfo_actions, "f").session.player, __classPrivateFieldGet(this, _MediaInfo_actions, "f"), storyboards);
    });
  }
  getStreamingInfo(url_transformer, format_filter) {
    var _a3;
    return getStreamingInfo(this.streaming_data, url_transformer, format_filter, this.cpn, __classPrivateFieldGet(this, _MediaInfo_actions, "f").session.player, __classPrivateFieldGet(this, _MediaInfo_actions, "f"), ((_a3 = __classPrivateFieldGet(this, _MediaInfo_page, "f")[0].storyboards) === null || _a3 === void 0 ? void 0 : _a3.is(PlayerStoryboardSpec_default)) ? __classPrivateFieldGet(this, _MediaInfo_page, "f")[0].storyboards : void 0);
  }
  ...
  download(options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return download(options, __classPrivateFieldGet(this, _MediaInfo_actions, "f"), this.playability_status, this.streaming_data, __classPrivateFieldGet(this, _MediaInfo_actions, "f").session.player, this.cpn);
    });
  }
  getTranscript() {
    var _a3;
...
var VideoInfo = class extends MediaInfo_default {
  constructor(data2, actions, cpn) {
    ...
    if (results && secondary_results) {
      ...
      if (this.watch_next_feed && Array.isArray(this.watch_next_feed) && ((_5 = this.watch_next_feed.at(-1)) === null || _5 === void 0 ? void 0 : _5.is(ContinuationItem_default)))
        __classPrivateFieldSet(this, _VideoInfo_watch_next_continuation, (_6 = this.watch_next_feed.pop()) === null || _6 === void 0 ? void 0 : _6.as(ContinuationItem_default), "f");
  ...
  getWatchNextContinuation() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const response = yield (_a3 = __classPrivateFieldGet(this, _VideoInfo_watch_next_continuation, "f")) === null || _a3 === void 0 ? void 0 : _a3.endpoint.call(this.actions, { parse: true });
...
var Album = class {
  constructor(response) {
    ...
    this.header = (_a3 = __classPrivateFieldGet(this, _Album_page, "f").header) === null || _a3 === void 0 ? void 0 : _a3.item().as(MusicDetailHeader_default);
...
var Explore = class {
  constructor(response) {
    ...
    const tab = (_a3 = __classPrivateFieldGet(this, _Explore_page, "f").contents) === null || _a3 === void 0 ? void 0 : _a3.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find target tab.");
...
var HomeFeed2 = class {
  constructor(response, actions) {
    ...
    const tab = (_a3 = __classPrivateFieldGet(this, _HomeFeed_page, "f").contents) === null || _a3 === void 0 ? void 0 : _a3.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
...
var Library2 = class {
  constructor(response, actions) {
    ...
    const section_list = (_a3 = __classPrivateFieldGet(this, _Library_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(SectionList_default).first();
  ...
  applySort(sort_by) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (typeof sort_by === "string") {
        const button = (_a3 = __classPrivateFieldGet(this, _Library_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(MusicSortFilterButton_default).first();
  ...
  applyFilter(filter) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      let target_chip;
      const chip_cloud = (_a3 = __classPrivateFieldGet(this, _Library_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(ChipCloud_default).first();
      if (typeof filter === "string") {
  ...
  get filters() {
    var _a3, _b;
    return ((_b = (_a3 = __classPrivateFieldGet(this, _Library_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(ChipCloud_default)) === null || _b === void 0 ? void 0 : _b.first().chips.map((chip) => chip.text)) || [];
  }
  get page() {
...
var Playlist3 = class {
  constructor(response, actions) {
    ...
    if (__classPrivateFieldGet(this, _Playlist_page, "f").continuation_contents) {
      const data2 = (_a3 = __classPrivateFieldGet(this, _Playlist_page, "f").continuation_contents) === null || _a3 === void 0 ? void 0 : _a3.as(MusicPlaylistShelfContinuation);
  ...
  getRelated() {
    var _a3, _b, _c, _d, _e;
    return __awaiter(this, void 0, void 0, function* () {
      let section_continuation = (_b = (_a3 = __classPrivateFieldGet(this, _Playlist_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(SectionList_default)) === null || _b === void 0 ? void 0 : _b[0].continuation;
...
_Playlist_page = /* @__PURE__ */ new WeakMap(), _Playlist_actions = /* @__PURE__ */ new WeakMap(), _Playlist_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_last_fetched_suggestions = /* @__PURE__ */ new WeakMap(), _Playlist_suggestions_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_instances2 = /* @__PURE__ */ new WeakSet(), _Playlist_fetchSuggestions = /* @__PURE__ */ __name(function _Playlist_fetchSuggestions2() {
  var _a3, _b, _c, _d, _e;
  return __awaiter(this, void 0, void 0, function* () {
    const continuation = __classPrivateFieldGet(this, _Playlist_suggestions_continuation, "f") || ((_b = (_a3 = __classPrivateFieldGet(this, _Playlist_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.get("SectionList")) === null || _b === void 0 ? void 0 : _b[0].as(SectionList_default).continuation);
    if (continuation) {
...
var Recap = class {
  constructor(response, actions) {
    ...
    const header = (_a3 = __classPrivateFieldGet(this, _Recap_page, "f").header) === null || _a3 === void 0 ? void 0 : _a3.item();
...
var Search2 = class {
  ...
  get did_you_mean() {
    var _a3;
    return (_a3 = __classPrivateFieldGet(this, _Search_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(DidYouMean_default).first();
  }
  get showing_results_for() {
    var _a3;
    return (_a3 = __classPrivateFieldGet(this, _Search_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(ShowingResultsFor_default).first();
  }
  get message() {
    var _a3;
    return (_a3 = __classPrivateFieldGet(this, _Search_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(Message_default).first();
  }
  get songs() {
    var _a3;
...
var SearchContinuation = class {
  constructor(actions, response) {
    ...
    this.header = (_a3 = __classPrivateFieldGet(this, _SearchContinuation_page, "f").header) === null || _a3 === void 0 ? void 0 : _a3.item().as(MusicHeader_default);
...
var Author = class {
  constructor(item, badges, thumbs, id) {
    ...
    this.id = id || ((_e = (_d = (_c = (_b = (_a3 = __classPrivateFieldGet(this, _Author_nav_text, "f")) === null || _a3 === void 0 ? void 0 : _a3.runs) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.endpoint) === null || _d === void 0 ? void 0 : _d.payload) === null || _e === void 0 ? void 0 : _e.browseId) || ((_h = (_g = (_f = __classPrivateFieldGet(this, _Author_nav_text, "f")) === null || _f === void 0 ? void 0 : _f.endpoint) === null || _g === void 0 ? void 0 : _g.payload) === null || _h === void 0 ? void 0 : _h.browseId) || "N/A";
...
var Builtins = class {
  static has(node, visitor) {
    ...
    if (node.callee.type === "MemberExpression") {
      return !!((_a3 = this.builtins) === null || _a3 === void 0 ? void 0 : _a3[visitor.getName(node.callee.property) || ""]);
    }
    return false;
  }
...
var Jinter = class {
  constructor(input) {
    ...
    this.visitor = new Visitor(__classPrivateFieldGet5(this, _Jinter_ast, "f"));
  ...
  execute(endpoint, args) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (args === null || args === void 0 ? void 0 : args.parse) {
        ...
        if (__classPrivateFieldGet(this, _Actions_instances, "m", _Actions_isBrowse).call(this, parsed_response) && ((_b = (_a3 = parsed_response.on_response_received_actions) === null || _a3 === void 0 ? void 0 : _a3.first()) === null || _b === void 0 ? void 0 : _b.type) === "navigateAction") {
...
var Player = class {
  constructor(signature_timestamp, sig_sc, nsig_sc, player_id) {
    ...
    __classPrivateFieldSet(this, _Player_nsig_cache, /* @__PURE__ */ new Map(), "f");
  }
  ...
  static extractNSigSourceCode(data2) {
    const sc = `function descramble_nsig(a) { let b=a.split("")${getStringBetweenStrings(data2, 'b=a.split("")', '}return b.join("")}')}} return b.join(""); } descramble_nsig(nsig)`;
    if (!sc)
...
var OAuth = class {
  ...
  cacheCredentials() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield (_a3 = __classPrivateFieldGet(this, _OAuth_session, "f").cache) === null || _a3 === void 0 ? void 0 : _a3.set("youtubei_oauth_credentials", data2.buffer);
    });
  }
  removeCache() {
    var _a3;
    return __awaiter(this, void 0, void 0, function* () {
      yield (_a3 = __classPrivateFieldGet(this, _OAuth_session, "f").cache) === null || _a3 === void 0 ? void 0 : _a3.remove("youtubei_oauth_credentials");
    });
  }
  refreshIfRequired() {
    return __awaiter(this, void 0, void 0, function* () {
...
_OAuth_identity = /* @__PURE__ */ new WeakMap(), _OAuth_session = /* @__PURE__ */ new WeakMap(), _OAuth_credentials = /* @__PURE__ */ new WeakMap(), _OAuth_polling_interval = /* @__PURE__ */ new WeakMap(), _OAuth_instances = /* @__PURE__ */ new WeakSet(), _OAuth_loadCachedCredentials = /* @__PURE__ */ __name(function _OAuth_loadCachedCredentials2() {
  var _a3;
  return __awaiter(this, void 0, void 0, function* () {
    const data2 = yield (_a3 = __classPrivateFieldGet(this, _OAuth_session, "f").cache) === null || _a3 === void 0 ? void 0 : _a3.get("youtubei_oauth_credentials");
    if (!data2)
      return false;
    const decoder = new TextDecoder();
  ...
  static getSessionData(lang = "", location = "", account_index = 0, visitor_data = "", enable_safety_mode = false, generate_session_locally = false, device_category = "desktop", client_name = ClientType.WEB, tz = Intl.DateTimeFormat().resolvedOptions().timeZone, fetch = Platform.shim.fetch, on_behalf_of_user) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (generate_session_locally) {
        session_data = __classPrivateFieldGet(this, _a2, "m", _Session_generateSessionData).call(this, session_args);
      } else {
        try {
          session_data = yield __classPrivateFieldGet(this, _a2, "m", _Session_retrieveSessionData).call(this, session_args, fetch);
        } catch (err) {
          session_data = __classPrivateFieldGet(this, _a2, "m", _Session_generateSessionData).call(this, session_args);
        }
      }
  ...
  getInfo(video_id) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      const player_payload = PlayerEndpoint_exports.build({
        sts: (_a3 = __classPrivateFieldGet(this, _Kids_session, "f").player) === null || _a3 === void 0 ? void 0 : _a3.sts,
        client: "YTKIDS",
        video_id
      });
...
_Music_session = /* @__PURE__ */ new WeakMap(), _Music_actions = /* @__PURE__ */ new WeakMap(), _Music_instances = /* @__PURE__ */ new WeakSet(), _Music_fetchInfoFromVideoId = /* @__PURE__ */ __name(function _Music_fetchInfoFromVideoId2(video_id) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    const player_payload = PlayerEndpoint_exports.build({
      video_id,
      sts: (_a3 = __classPrivateFieldGet(this, _Music_session, "f").player) === null || _a3 === void 0 ? void 0 : _a3.sts,
      client: "YTMUSIC"
    });
    const next_payload = NextEndpoint_exports.build({
      video_id,
    ...
    const player_response = list_item.endpoint.call(__classPrivateFieldGet(this, _Music_actions, "f"), {
      ...
      playbackContext: {
        contentPlaybackContext: Object.assign({
          signatureTimestamp: (_a3 = __classPrivateFieldGet(this, _Music_session, "f").player) === null || _a3 === void 0 ? void 0 : _a3.sts
        })
      }
    });
  ...
  getBasicInfo(video_id, client) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const response = yield this.actions.execute(PlayerEndpoint_exports.PATH, PlayerEndpoint_exports.build({
        video_id,
        client,
        sts: (_a3 = __classPrivateFieldGet(this, _Innertube_session, "f").player) === null || _a3 === void 0 ? void 0 : _a3.sts
      }));
      const cpn = generateRandomString(16);
      return new VideoInfo_default([response], this.actions, cpn);
    });
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onsuccess = function() {
          var _a3;
          const result = (_a3 = this.result) === null || _a3 === void 0 ? void 0 : _a3.v;
...
Platform.load({
  ...
  uuidv4() {
    var _a3;
    if ((_a3 = globalThis.crypto) === null || _a3 === void 0 ? void 0 : _a3.randomUUID()) {
