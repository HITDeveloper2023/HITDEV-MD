...
var Maybe = class {
  ...
  isObserved() {
    var _a3;
    return (_a3 = (0, import_tslib.__classPrivateFieldGet)(this, _Maybe_value, "f")) === null || _a3 === void 0 ? void 0 : _a3[isObserved];
  }
  parsed() {
...
var DropdownItem = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "icon")) {
      this.icon_type = (_a3 = data.icon) === null || _a3 === void 0 ? void 0 : _a3.iconType;
    }
...
var NavigationEndpoint = class extends YTNode {
  constructor(data) {
    ...
    this.metadata = {};
    if ((_b = (_a3 = data === null || data === void 0 ? void 0 : data.commandMetadata) === null || _a3 === void 0 ? void 0 : _a3.webCommandMetadata) === null || _b === void 0 ? void 0 : _b.url) {
...
var EmojiRun = class {
  constructor(data) {
    ...
    this.text = ((_a3 = data.emoji) === null || _a3 === void 0 ? void 0 : _a3.emojiId) || ((_c = (_b = data.emoji) === null || _b === void 0 ? void 0 : _b.shortcuts) === null || _c === void 0 ? void 0 : _c[0]) || "";
    this.emoji = {
...
var Text = class {
  constructor(data) {
    ...
    if (!this.endpoint) {
      if ((_b = (_a3 = this.runs) === null || _a3 === void 0 ? void 0 : _a3[0]) === null || _b === void 0 ? void 0 : _b.endpoint) {
...
var ExpandableVideoDescriptionBody = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "attributedDescriptionBodyText")) {
      this.attributed_description_body_text = (_a3 = data.attributedDescriptionBodyText) === null || _a3 === void 0 ? void 0 : _a3.content;
    }
  }
};
...
var ExpandableMetadata = class extends YTNode {
  constructor(data) {
    ...
    this.expanded_content = parser_default.parseItem(data.expandedContent, [HorizontalCardList_default, HorizontalList_default]);
...
var Video = class extends YTNode {
  constructor(data) {
    var _a3, _b, _c;
    super();
    const overlay_time_status = ((_a3 = data.thumbnailOverlays.find((overlay) => overlay.thumbnailOverlayTimeStatusRenderer)) === null || _a3 === void 0 ? void 0 : _a3.thumbnailOverlayTimeStatusRenderer.text) || "N/A";
    ...
    this.author = new Author_default(data.ownerText, data.ownerBadges, (_c = (_b = data.channelThumbnailSupportedRenderers) === null || _b === void 0 ? void 0 : _b.channelThumbnailWithLinkRenderer) === null || _c === void 0 ? void 0 : _c.thumbnail);
  ...
  get description() {
    ...
    return ((_a3 = this.description_snippet) === null || _a3 === void 0 ? void 0 : _a3.toString()) || "";
  }
  get is_live() {
    var _a3;
    return this.badges.some((badge) => {
      if (badge.style === "BADGE_STYLE_TYPE_LIVE_NOW" || badge.label === "LIVE")
        return true;
    }) || ((_a3 = this.thumbnail_overlays.firstOfType(ThumbnailOverlayTimeStatus_default)) === null || _a3 === void 0 ? void 0 : _a3.style) === "LIVE";
  }
  get is_upcoming() {
...
var UploadTimeFactoid = class extends YTNode {
  constructor(data) {
    super();
    this.factoid = parser_default.parseItem(data.factoid, Factoid_default);
  }
};
...
var VideoDescriptionHeader = class extends YTNode {
  constructor(data) {
    ...
    this.factoids = parser_default.parseArray(data.factoid, [Factoid_default, ViewCountFactoid_default, UploadTimeFactoid_default]);
  }
};
...
var VideoDescriptionTranscriptSection = class extends YTNode {
  constructor(data) {
    ...
    this.primary_button = parser_default.parseItem(data.primaryButton, Button_default);
  }
};
...
var VideoDescriptionCourseSection = class extends YTNode {
  constructor(data) {
    super();
    this.section_title = new Text(data.sectionTitle);
    this.media_lockups = parser_default.parseArray(data.mediaLockups, [StructuredDescriptionPlaylistLockup_default]);
  }
};
...
var EngagementPanelSectionList = class extends YTNode {
  constructor(data) {
    ...
    this.content = parser_default.parseItem(data.content, [SectionList_default, ContinuationItem_default, StructuredDescriptionContent_default, MacroMarkersList_default, ProductList_default]);
...
var Format = class {
  constructor(data, this_response_nsig_cache) {
    ...
    if (this_response_nsig_cache) {
      (0, import_tslib2.__classPrivateFieldSet)(this, _Format_this_response_nsig_cache, this_response_nsig_cache, "f");
    }
    this.itag = data.itag;
    ...
    this.color_info = data.colorInfo ? {
      primaries: (_a3 = data.colorInfo.primaries) === null || _a3 === void 0 ? void 0 : _a3.replace("COLOR_PRIMARIES_", ""),
  ...
  decipher(player) {
    ...
    return player.decipher(this.url, this.signature_cipher, this.cipher, (0, import_tslib2.__classPrivateFieldGet)(this, _Format_this_response_nsig_cache, "f"));
  }
};
    ...
    if (Reflect.has(data, "subMenuItems")) {
      this.sub_menu_items = data.subMenuItems.map((item) => {
        ...
        return {
          ...
          continuation: (_b = (_a3 = item.continuation) === null || _a3 === void 0 ? void 0 : _a3.reloadContinuationData) === null || _b === void 0 ? void 0 : _b.continuation,
...
var TranscriptFooter = class extends YTNode {
  constructor(data) {
    super();
    this.language_menu = parser_default.parseItem(data.languageMenu, SortFilterSubMenu_default);
  }
};
...
var TranscriptSegmentList = class extends YTNode {
  constructor(data) {
    super();
    this.initial_segments = parser_default.parseArray(data.initialSegments, [TranscriptSegment_default, TranscriptSectionHeader_default]);
...
var TranscriptSearchPanel = class extends YTNode {
  constructor(data) {
    super();
    this.header = parser_default.parseItem(data.header, TranscriptSearchBox_default);
    this.body = parser_default.parseItem(data.body, TranscriptSegmentList_default);
    this.footer = parser_default.parseItem(data.footer, TranscriptFooter_default);
    this.target_id = data.targetId;
  }
};
...
var Transcript = class extends YTNode {
  constructor(data) {
    super();
    this.content = parser_default.parseItem(data.content, TranscriptSearchPanel_default);
  }
};
...
var UpdateEngagementPanelAction = class extends YTNode {
  constructor(data) {
    super();
    this.target_id = data.targetId;
    this.content = parser_default.parseItem(data.content, Transcript_default);
  }
};
...
var AutomixPreviewVideo = class extends YTNode {
  constructor(data) {
    var _a3, _b;
    super();
    if ((_b = (_a3 = data === null || data === void 0 ? void 0 : data.content) === null || _a3 === void 0 ? void 0 : _a3.automixPlaylistVideoRenderer) === null || _b === void 0 ? void 0 : _b.navigationEndpoint) {
      this.playlist_video = {
...
var ToggleButton = class extends YTNode {
  constructor(data) {
    ...
    this.is_disabled = data.isDisabled;
    this.icon_type = (_a3 = data.defaultIcon) === null || _a3 === void 0 ? void 0 : _a3.iconType;
  ...
  constructor(data) {
    ...
    this.heart_color = {
      basic_color_palette_data: {
        foreground_title_color: (_b = (_a3 = data.heartColor) === null || _a3 === void 0 ? void 0 : _a3.basicColorPaletteData) === null || _b === void 0 ? void 0 : _b.foregroundTitleColor
      }
    };
...
var BackstagePost = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "voteButton")) {
      this.vote_button = parser_default.parseItem(data.voteButton, Button_default);
    }
    if (Reflect.has(data, "navigationEndpoint")) {
      this.endpoint = new NavigationEndpoint_default(data.navigationEndpoint);
    }
...
var ChannelHeaderLinks = class extends YTNode {
  constructor(data) {
    var _a3, _b;
    super();
    this.primary = observe(((_a3 = data.primaryLinks) === null || _a3 === void 0 ? void 0 : _a3.map((link) => new HeaderLink(link))) || []);
...
var SubscribeButton = class extends YTNode {
  constructor(data) {
    ...
    this.endpoint = new NavigationEndpoint_default(((_a3 = data.serviceEndpoints) === null || _a3 === void 0 ? void 0 : _a3[0]) || ((_b = data.onSubscribeEndpoints) === null || _b === void 0 ? void 0 : _b[0]));
  }
};
...
var ChannelAboutFullMetadata = class extends YTNode {
  constructor(data) {
    ...
    this.primary_links = (_b = (_a3 = data.primaryLinks) === null || _a3 === void 0 ? void 0 : _a3.map((link) => ({
...
var ChannelThumbnailWithLink = class extends YTNode {
  constructor(data) {
    ...
    this.thumbnails = Thumbnail.fromResponse(data.thumbnail);
    this.endpoint = new NavigationEndpoint_default(data.navigationEndpoint);
    this.label = (_b = (_a3 = data.accessibility) === null || _a3 === void 0 ? void 0 : _a3.accessibilityData) === null || _b === void 0 ? void 0 : _b.label;
  }
};
...
var AuthorCommentBadge = class extends YTNode {
  constructor(data) {
    ...
    (0, import_tslib3.__classPrivateFieldSet)(this, _AuthorCommentBadge_data, data, "f");
  }
  get orig_badge() {
    return (0, import_tslib3.__classPrivateFieldGet)(this, _AuthorCommentBadge_data, "f");
  }
};
...
var PdgCommentChip = class extends YTNode {
  constructor(data) {
    ...
    this.color_pallette = {
      background_color: (_a3 = data.chipColorPalette) === null || _a3 === void 0 ? void 0 : _a3.backgroundColor,
...
function encodeMusicSearchFilters(filters) {
  ...
  if (filters.type && filters.type !== "all" && ((_a3 = data.filters) === null || _a3 === void 0 ? void 0 : _a3.type))
...
var Comment = class extends YTNode {
  constructor(data) {
    ...
    this.author = new Author_default(Object.assign(Object.assign({}, data.authorText), { navigationEndpoint: data.authorEndpoint }), this.author_badge ? [{
      metadataBadgeRenderer: (_a3 = this.author_badge) === null || _a3 === void 0 ? void 0 : _a3.orig_badge
  ...
  like() {
    ...
    return (0, import_tslib4.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib4.__classPrivateFieldGet)(this, _Comment_actions, "f"))
        throw new InnertubeError("An active caller must be provide to perform this operation.");
      const button = (_a3 = this.action_buttons) === null || _a3 === void 0 ? void 0 : _a3.like_button;
      if (!button)
      ...
      const response = yield button.endpoint.call((0, import_tslib4.__classPrivateFieldGet)(this, _Comment_actions, "f"), { parse: false });
      return response;
    });
  }
  dislike() {
    ...
    return (0, import_tslib4.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib4.__classPrivateFieldGet)(this, _Comment_actions, "f"))
        throw new InnertubeError("An active caller must be provide to perform this operation.");
      const button = (_a3 = this.action_buttons) === null || _a3 === void 0 ? void 0 : _a3.dislike_button;
      if (!button)
  ...
  reply(text) {
    ...
    return (0, import_tslib4.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib4.__classPrivateFieldGet)(this, _Comment_actions, "f"))
        throw new InnertubeError("An active caller must be provide to perform this operation.");
      if (!((_a3 = this.action_buttons) === null || _a3 === void 0 ? void 0 : _a3.reply_button))
      ...
      const response = yield dialog_button.endpoint.call((0, import_tslib4.__classPrivateFieldGet)(this, _Comment_actions, "f"), { commentText: text });
      return response;
    });
  }
  translate(target_language) {
    ...
    return (0, import_tslib4.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib4.__classPrivateFieldGet)(this, _Comment_actions, "f").execute("comment/perform_comment_action", { action, client: "ANDROID" });
      const mutations = (_b = (_a3 = response.data.frameworkUpdates) === null || _a3 === void 0 ? void 0 : _a3.entityBatchUpdate) === null || _b === void 0 ? void 0 : _b.mutations;
  ...
  setActions(actions) {
    (0, import_tslib4.__classPrivateFieldSet)(this, _Comment_actions, actions, "f");
  }
};
...
var CommentThread = class extends YTNode {
  ...
  getReplies() {
    ...
    return (0, import_tslib5.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_actions, "f"))
      ...
      const continuation = (_a3 = this.comment_replies_data.contents) === null || _a3 === void 0 ? void 0 : _a3.firstOfType(ContinuationItem_default);
      if (!continuation)
        throw new InnertubeError("Replies continuation not found.");
      const response = yield continuation.endpoint.call((0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_actions, "f"), { parse: true });
      if (!response.on_response_received_endpoints_memo)
        throw new InnertubeError("Unexpected response.", response);
      this.replies = observe(response.on_response_received_endpoints_memo.getType(Comment_default).map((comment) => {
        comment.setActions((0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_actions, "f"));
        return comment;
      }));
      (0, import_tslib5.__classPrivateFieldSet)(this, _CommentThread_continuation, response === null || response === void 0 ? void 0 : response.on_response_received_endpoints_memo.getType(ContinuationItem_default).first(), "f");
      return this;
    });
  }
  getContinuation() {
    ...
    return (0, import_tslib5.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      if (!(0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_actions, "f"))
        throw new InnertubeError("Actions instance not set for this thread.");
      const load_more_button = (_a3 = (0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_continuation, "f").button) === null || _a3 === void 0 ? void 0 : _a3.as(Button_default);
      if (!load_more_button)
        throw new InnertubeError('"Load more" button not found.');
      const response = yield load_more_button.endpoint.call((0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_actions, "f"), { parse: true });
      if (!response.on_response_received_endpoints_memo)
        throw new InnertubeError("Unexpected response.", response);
      this.replies = observe(response.on_response_received_endpoints_memo.getType(Comment_default).map((comment) => {
        comment.setActions((0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_actions, "f"));
      ...
      (0, import_tslib5.__classPrivateFieldSet)(this, _CommentThread_continuation, response.on_response_received_endpoints_memo.getType(ContinuationItem_default).first(), "f");
      return this;
    });
  }
  get has_continuation() {
    ...
    return !!(0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_continuation, "f");
  }
  setActions(actions) {
    (0, import_tslib5.__classPrivateFieldSet)(this, _CommentThread_actions, actions, "f");
  }
};
...
var Playlist = class extends YTNode {
  constructor(data) {
    ...
    this.title = new Text(data.title);
    this.author = ((_a3 = data.shortBylineText) === null || _a3 === void 0 ? void 0 : _a3.simpleText) ? new Text(data.shortBylineText) : new Author_default(data.longBylineText, data.ownerBadges, null);
...
var MultiMarkersPlayerBar = class extends YTNode {
  constructor(data) {
    var _a3;
    super();
    this.markers_map = observe(((_a3 = data.markersMap) === null || _a3 === void 0 ? void 0 : _a3.map((marker) => new Marker(marker))) || []);
  }
};
...
var ChildElement = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "type") && Reflect.has(data.type, "textType")) {
      this.text = (_a3 = data.type.textType.text) === null || _a3 === void 0 ? void 0 : _a3.content;
    }
...
var Element = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "newElement") && Reflect.has(data.newElement, "childElements")) {
      this.child_elements = observe(((_a3 = data.newElement.childElements) === null || _a3 === void 0 ? void 0 : _a3.map((el) => new ChildElement_default(el))) || []);
    }
  }
};
...
var Grid = class extends YTNode {
  constructor(data) {
    ...
    this.continuation = ((_c = (_b = (_a3 = data.continuations) === null || _a3 === void 0 ? void 0 : _a3[0]) === null || _b === void 0 ? void 0 : _b.nextContinuationData) === null || _c === void 0 ? void 0 : _c.continuation) || null;
  }
  get contents() {
    return this.items;
  }
...
var GridMix = class extends YTNode {
  constructor(data) {
    ...
    this.id = data.playlistId;
    this.title = new Text(data.title);
    this.author = ((_a3 = data.shortBylineText) === null || _a3 === void 0 ? void 0 : _a3.simpleText) ? new Text(data.shortBylineText) : ((_b = data.longBylineText) === null || _b === void 0 ? void 0 : _b.simpleText) ? new Text(data.longBylineText) : null;
    this.thumbnails = Thumbnail.fromResponse(data.thumbnail);
    this.video_count = new Text(data.videoCountText);
    this.video_count_short = new Text(data.videoCountShortText);
    this.endpoint = new NavigationEndpoint_default(data.navigationEndpoint);
...
var GridMovie = class extends YTNode {
  constructor(data) {
    var _a3;
    super();
    const length_alt = (_a3 = data.thumbnailOverlays.find((overlay) => overlay.hasOwnProperty("thumbnailOverlayTimeStatusRenderer"))) === null || _a3 === void 0 ? void 0 : _a3.thumbnailOverlayTimeStatusRenderer;
    this.id = data.videoId;
    this.title = new Text(data.title);
    this.thumbnails = Thumbnail.fromResponse(data.thumbnail);
...
var GridPlaylist = class extends YTNode {
  constructor(data) {
    ...
    this.sidebar_thumbnails = [].concat(...((_a3 = data.sidebarThumbnails) === null || _a3 === void 0 ? void 0 : _a3.map((thumbnail) => Thumbnail.fromResponse(thumbnail))) || []) || null;
    this.video_count = new Text(data.thumbnailText);
    this.video_count_short = new Text(data.videoCountShortText);
  }
};
...
var ItemSection = class extends YTNode {
  constructor(data) {
    ...
    if (data.continuations) {
      this.continuation = (_c = (_b = (_a3 = data.continuations) === null || _a3 === void 0 ? void 0 : _a3.at(0)) === null || _b === void 0 ? void 0 : _b.nextContinuationData) === null || _c === void 0 ? void 0 : _c.continuation;
    }
  }
};
...
var LiveChat = class extends YTNode {
  constructor(data) {
    ...
    this.continuation = (_b = (_a3 = data.continuations[0]) === null || _a3 === void 0 ? void 0 : _a3.reloadContinuationData) === null || _b === void 0 ? void 0 : _b.continuation;
...
var LiveChatTickerPaidMessageItem = class extends YTNode {
  constructor(data) {
    ...
    this.show_item = parser_default.parseItem((_b = (_a3 = data.showItemEndpoint) === null || _a3 === void 0 ? void 0 : _a3.showLiveChatItemEndpoint) === null || _b === void 0 ? void 0 : _b.renderer);
...
var ReplayChatItemAction = class extends YTNode {
  constructor(data) {
    var _a3;
    super();
    this.actions = parser_default.parseArray((_a3 = data.actions) === null || _a3 === void 0 ? void 0 : _a3.map((action) => {
...
var MenuPopup = class extends YTNode {
  constructor(data) {
    super();
    this.items = parser_default.parseArray(data.items, [MenuNavigationItem_default, MenuServiceItem_default]);
  }
};
...
var MusicMultiSelectMenu = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "title") && Reflect.has(data.title, "musicMenuTitleRenderer")) {
      this.title = new Text((_a3 = data.title.musicMenuTitleRenderer) === null || _a3 === void 0 ? void 0 : _a3.primaryText);
    }
...
var MovingThumbnail = class extends YTNode {
  constructor(data) {
    var _a3;
    super();
    return (_a3 = data.movingThumbnailDetails) === null || _a3 === void 0 ? void 0 : _a3.thumbnails.map((thumbnail) => new Thumbnail(thumbnail)).sort((a, b) => b.width - a.width);
  }
};
...
var MusicPlayButton = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "accessibilityPlayData")) {
      this.play_label = (_a3 = data.accessibilityPlayData.accessibilityData) === null || _a3 === void 0 ? void 0 : _a3.label;
    }
...
var MusicResponsiveListItem = class extends YTNode {
  constructor(data) {
    ...
    (0, import_tslib6.__classPrivateFieldSet)(this, _MusicResponsiveListItem_playlist_item_data, {
      video_id: ((_a3 = data === null || data === void 0 ? void 0 : data.playlistItemData) === null || _a3 === void 0 ? void 0 : _a3.videoId) || null,
    ...
    if (!page_type) {
      const is_non_music_track = this.flex_columns.find((col) => {
        var _a4, _b2, _c2, _d2;
        return ((_d2 = (_c2 = (_b2 = (_a4 = col.title.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b2 === void 0 ? void 0 : _b2.browseEndpointContextSupportedConfigs) === null || _c2 === void 0 ? void 0 : _c2.browseEndpointContextMusicConfig) === null || _d2 === void 0 ? void 0 : _d2.pageType) === "MUSIC_PAGE_TYPE_NON_MUSIC_AUDIO_TRACK_PAGE";
      });
    ...
    switch (page_type) {
      case "MUSIC_PAGE_TYPE_ALBUM":
        ...
        (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseAlbum).call(this);
        break;
      case "MUSIC_PAGE_TYPE_PLAYLIST":
        this.item_type = "playlist";
        (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parsePlaylist).call(this);
        break;
      case "MUSIC_PAGE_TYPE_ARTIST":
      case "MUSIC_PAGE_TYPE_USER_CHANNEL":
        this.item_type = "artist";
        (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseArtist).call(this);
        break;
      case "MUSIC_PAGE_TYPE_LIBRARY_ARTIST":
        this.item_type = "library_artist";
        (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseLibraryArtist).call(this);
        break;
      case "MUSIC_PAGE_TYPE_NON_MUSIC_AUDIO_TRACK_PAGE":
        this.item_type = "non_music_track";
        (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseNonMusicTrack).call(this);
        break;
      default:
        if (this.flex_columns[1]) {
          (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseVideoOrSong).call(this);
        } else {
          (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseOther).call(this);
        }
    }
  ...
  get thumbnails() {
    var _a3;
    return ((_a3 = this.thumbnail) === null || _a3 === void 0 ? void 0 : _a3.contents) || [];
  }
};
...
_MusicResponsiveListItem_playlist_item_data = /* @__PURE__ */ new WeakMap(), _MusicResponsiveListItem_instances = /* @__PURE__ */ new WeakSet(), _MusicResponsiveListItem_parseOther = /* @__PURE__ */ __name(function _MusicResponsiveListItem_parseOther2() {
  ...
  var _a3, _b;
  const is_video = (_b = (_a3 = this.flex_columns.at(1)) === null || _a3 === void 0 ? void 0 : _a3.title.runs) === null || _b === void 0 ? void 0 : _b.some((run) => run.text.match(/(.*?) views/));
  if (is_video) {
    this.item_type = "video";
    (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseVideo).call(this);
  } else {
    this.item_type = "song";
    (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseSong).call(this);
  }
  ...
  var _a3, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q;
  this.id = (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_playlist_item_data, "f").video_id || ((_b = (_a3 = this.endpoint) === null || _a3 === void 0 ? void 0 : _a3.payload) === null || _b === void 0 ? void 0 : _b.videoId);
  this.title = this.flex_columns.first().title.toString();
  ...
  if (artist_runs) {
    this.artists = artist_runs.map((run) => {
      ...
      return {
        name: run.text,
        channel_id: isTextRun(run) ? (_b2 = (_a4 = run.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b2 === void 0 ? void 0 : _b2.browseId : void 0,
  ...
  this.id = (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_playlist_item_data, "f").video_id;
  this.title = this.flex_columns.first().title.toString();
  this.views = (_c = (_b = (_a3 = this.flex_columns.at(1)) === null || _a3 === void 0 ? void 0 : _a3.title.runs) === null || _b === void 0 ? void 0 : _b.find((run) => run.text.match(/(.*?) views/))) === null || _c === void 0 ? void 0 : _c.toString();
  ...
  var _a3, _b, _c, _d, _e, _f;
  this.id = (_b = (_a3 = this.endpoint) === null || _a3 === void 0 ? void 0 : _a3.payload) === null || _b === void 0 ? void 0 : _b.browseId;
  ...
  var _a3, _b, _c, _d;
  this.name = this.flex_columns.first().title.toString();
  this.subtitle = (_a3 = this.flex_columns.at(1)) === null || _a3 === void 0 ? void 0 : _a3.title;
...
var MusicTwoRowItem = class extends YTNode {
  constructor(data) {
    ...
    this.title = new Text(data.title);
    this.endpoint = new NavigationEndpoint_default(data.navigationEndpoint);
    this.id = ((_b = (_a3 = this.endpoint) === null || _a3 === void 0 ? void 0 : _a3.payload) === null || _b === void 0 ? void 0 : _b.browseId) || ((_d = (_c = this.endpoint) === null || _c === void 0 ? void 0 : _c.payload) === null || _d === void 0 ? void 0 : _d.videoId);
    this.subtitle = new Text(data.subtitle);
    ...
    if (this.item_type == "artist") {
      ...
      const artists = (_q = this.subtitle.runs) === null || _q === void 0 ? void 0 : _q.filter((run) => {
        var _a4, _b2;
        return (_b2 = (_a4 = run.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b2 === void 0 ? void 0 : _b2.browseId.startsWith("UC");
      });
      if (artists) {
        this.artists = artists.map((artist) => {
          ...
          return {
            name: artist.text,
            channel_id: (_b2 = (_a4 = artist.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b2 === void 0 ? void 0 : _b2.browseId,
      ...
      const author = (_u = this.subtitle.runs) === null || _u === void 0 ? void 0 : _u.find((run) => {
        var _a4, _b2, _c2;
        return (_c2 = (_b2 = (_a4 = run.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b2 === void 0 ? void 0 : _b2.browseId) === null || _c2 === void 0 ? void 0 : _c2.startsWith("UC");
      });
      if (author) {
        this.author = {
      ...
      if (artists) {
        this.artists = artists.map((artist) => {
          ...
          return {
            ...
            channel_id: (_b2 = (_a4 = artist === null || artist === void 0 ? void 0 : artist.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b2 === void 0 ? void 0 : _b2.browseId,
...
var MusicDetailHeader = class extends YTNode {
  constructor(data) {
    ...
    this.year = ((_b = (_a3 = this.subtitle.runs) === null || _a3 === void 0 ? void 0 : _a3.find((run) => /^[12][0-9]{3}$/.test(run.text))) === null || _b === void 0 ? void 0 : _b.text) || "";
    ...
    const author = (_g = this.subtitle.runs) === null || _g === void 0 ? void 0 : _g.find((run) => {
      var _a4, _b2;
      return (_b2 = (_a4 = run === null || run === void 0 ? void 0 : run.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b2 === void 0 ? void 0 : _b2.browseId.startsWith("UC");
    });
    if (author) {
      this.author = {
        name: author.text,
...
var PlaylistPanelVideo = class extends YTNode {
  constructor(data) {
    ...
    const album = (_a3 = new Text(data.longBylineText).runs) === null || _a3 === void 0 ? void 0 : _a3.find((run) => {
      var _a4, _b2, _c2;
      return (_c2 = (_b2 = (_a4 = run.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b2 === void 0 ? void 0 : _b2.browseId) === null || _c2 === void 0 ? void 0 : _c2.startsWith("MPR");
    });
...
var PlaylistPanel = class extends YTNode {
  constructor(data) {
    ...
    this.continuation = ((_c = (_b = (_a3 = data.continuations) === null || _a3 === void 0 ? void 0 : _a3[0]) === null || _b === void 0 ? void 0 : _b.nextRadioContinuationData) === null || _c === void 0 ? void 0 : _c.continuation) || ((_f = (_e = (_d = data.continuations) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.nextContinuationData) === null || _f === void 0 ? void 0 : _f.continuation);
...
var MusicShelf = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "continuations")) {
      this.continuation = ((_b = (_a3 = data.continuations) === null || _a3 === void 0 ? void 0 : _a3[0].nextContinuationData) === null || _b === void 0 ? void 0 : _b.continuation) || ((_d = (_c = data.continuations) === null || _c === void 0 ? void 0 : _c[0].reloadContinuationData) === null || _d === void 0 ? void 0 : _d.continuation);
    }
...
var MusicVisualHeader = class extends YTNode {
  constructor(data) {
    ...
    super();
    this.title = new Text(data.title);
    this.thumbnail = data.thumbnail ? Thumbnail.fromResponse((_a3 = data.thumbnail.musicThumbnailRenderer) === null || _a3 === void 0 ? void 0 : _a3.thumbnail) : [];
    this.menu = parser_default.parseItem(data.menu, Menu_default);
...
var PlayerMicroformat = class extends YTNode {
  constructor(data) {
    ...
    this.available_countries = data.availableCountries;
    this.start_timestamp = ((_a3 = data.liveBroadcastDetails) === null || _a3 === void 0 ? void 0 : _a3.startTimestamp) ? new Date(data.liveBroadcastDetails.startTimestamp) : null;
  }
};
...
var PlaylistVideo = class extends YTNode {
  ...
  get is_live() {
    var _a3;
    return ((_a3 = this.thumbnail_overlays.firstOfType(ThumbnailOverlayTimeStatus_default)) === null || _a3 === void 0 ? void 0 : _a3.style) === "LIVE";
  }
  get is_upcoming() {
    var _a3;
    return ((_a3 = this.thumbnail_overlays.firstOfType(ThumbnailOverlayTimeStatus_default)) === null || _a3 === void 0 ? void 0 : _a3.style) === "UPCOMING";
  }
};
...
var ProductListItem = class extends YTNode {
  constructor(data) {
    ...
    this.view_button = parser_default.parseItem(data.viewButton, Button_default);
  }
};
...
var TopicChannelDetails = class extends YTNode {
  constructor(data) {
    ...
    super();
    this.title = new Text(data.title);
    this.avatar = Thumbnail.fromResponse((_a3 = data.thumbnail) !== null && _a3 !== void 0 ? _a3 : data.avatar);
    this.subtitle = new Text(data.subtitle);
    this.subscribe_button = parser_default.parseItem(data.subscribeButton, SubscribeButton_default);
    this.endpoint = new NavigationEndpoint_default(data.navigationEndpoint);
  }
...
var TwoColumnWatchNextResults = class extends YTNode {
  constructor(data) {
    ...
    this.results = parser_default.parseArray((_a3 = data.results) === null || _a3 === void 0 ? void 0 : _a3.results.contents);
    ...
    if (autoplayData) {
      this.autoplay = {
        sets: autoplayData.sets.map((set) => (0, import_tslib7.__classPrivateFieldGet)(this, _TwoColumnWatchNextResults_instances, "m", _TwoColumnWatchNextResults_parseAutoplaySet).call(this, set))
      };
      if (autoplayData.modifiedSets) {
        this.autoplay.modified_sets = autoplayData.modifiedSets.map((set) => (0, import_tslib7.__classPrivateFieldGet)(this, _TwoColumnWatchNextResults_instances, "m", _TwoColumnWatchNextResults_parseAutoplaySet).call(this, set));
      }
...
var VideoPrimaryInfo = class extends YTNode {
  constructor(data) {
    ...
    this.view_count = new Text((_b = (_a3 = data.viewCount) === null || _a3 === void 0 ? void 0 : _a3.videoViewCountRenderer) === null || _b === void 0 ? void 0 : _b.viewCount);
...
var WatchCardHeroVideo = class extends YTNode {
  constructor(data) {
    ...
    this.label = ((_a3 = data.lengthText) === null || _a3 === void 0 ? void 0 : _a3.accessibility.accessibilityData.label) || "";
  }
};
...
var AnchoredSection = class extends YTNode {
  constructor(data) {
    ...
    this.category_assets = {
      asset_key: (_a3 = data.categoryAssets) === null || _a3 === void 0 ? void 0 : _a3.assetKey,
...
var KidsBlocklistPickerItem = class extends YTNode {
  constructor(data) {
    ...
    this.avatar = Thumbnail.fromResponse(data.avatar);
    this.block_button = parser_default.parseItem(data.blockButton, [ToggleButton_default]);
    this.blocked_entity_key = data.blockedEntityKey;
  }
  blockChannel() {
    return (0, import_tslib8.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib8.__classPrivateFieldGet)(this, _KidsBlocklistPickerItem_actions, "f"))
        throw new InnertubeError("An active caller must be provide to perform this operation.");
      ...
      const response = yield button.endpoint.call((0, import_tslib8.__classPrivateFieldGet)(this, _KidsBlocklistPickerItem_actions, "f"), { parse: false });
      return response;
    });
  }
  setActions(actions) {
    (0, import_tslib8.__classPrivateFieldSet)(this, _KidsBlocklistPickerItem_actions, actions, "f");
  }
};
...
var KidsBlocklistPicker = class extends YTNode {
  constructor(data) {
    super();
    this.title = new Text(data.title);
    this.child_rows = parser_default.parse(data.childRows, true, [KidsBlocklistPickerItem_default]);
    this.done_button = parser_default.parseItem(data.doneButton, [Button_default]);
...
function introspectKeysSecondPass(key_info) {
  ...
  const channel_nav = key_info.filter(([, value]) => {
    ...
    if (!(value.misc_type === "NavigationEndpoint" || value.misc_type === "Text"))
      return false;
    return ((_a4 = value.endpoint) === null || _a4 === void 0 ? void 0 : _a4.metadata.page_type) === "WEB_PAGE_TYPE_CHANNEL";
  });
  ...
  if (cannonical_channel_nav) {
    ...
    const cannonical_badges = (_a3 = likely_badges[0]) !== null && _a3 !== void 0 ? _a3 : badges[0];
...
function createRuntimeClass(classname, key_info, logger) {
  ...
  const node = (_a3 = /* @__PURE__ */ __name(class extends YTNode {
    static set key_info(key_info2) {
      (0, import_tslib9.__classPrivateFieldSet)(this, _a3, new Map(key_info2), "f", _key_info);
    }
    static get key_info() {
      return [...(0, import_tslib9.__classPrivateFieldGet)(this, _a3, "f", _key_info).entries()];
    }
    constructor(data) {
      super();
  ...
  }, "_a"), (0, import_tslib9.__setFunctionName)(_a3, "node"), _a3.type = classname, _key_info = { value: /* @__PURE__ */ new Map() }, _a3);
...
var MusicPlaylistShelfContinuation = class extends YTNode {
  constructor(data) {
    ...
    super();
    this.contents = parse(data.contents, true);
    this.continuation = ((_a3 = data.continuations) === null || _a3 === void 0 ? void 0 : _a3[0].nextContinuationData.continuation) || null;
  }
};
...
var MusicShelfContinuation = class extends YTNode {
  constructor(data) {
    ...
    super();
    this.contents = parseArray(data.contents);
    this.continuation = ((_b = (_a3 = data.continuations) === null || _a3 === void 0 ? void 0 : _a3[0].nextContinuationData) === null || _b === void 0 ? void 0 : _b.continuation) || ((_d = (_c = data.continuations) === null || _c === void 0 ? void 0 : _c[0].reloadContinuationData) === null || _d === void 0 ? void 0 : _d.continuation) || null;
  }
};
...
var Continuation = class extends YTNode {
  constructor(data) {
    ...
    this.timeout_ms = (_a3 = data.continuation) === null || _a3 === void 0 ? void 0 : _a3.timeoutMs;
...
var LiveChatContinuation = class extends YTNode {
  constructor(data) {
    var _a3, _b, _c, _d, _e, _f, _g, _h;
    super();
    this.actions = parse((_a3 = data.actions) === null || _a3 === void 0 ? void 0 : _a3.map((action) => {
      delete action.clickTrackingParams;
      return action;
    }), true) || observe([]);
...
var MEMO = null;
var ERROR_HANDLER = /* @__PURE__ */ __name((_a3) => {
  var { classname } = _a3, context = (0, import_tslib10.__rest)(_a3, ["classname"]);
...
function parseResponse(data) {
  ...
  _clearMemo();
  applyMutations(contents_memo, (_b = (_a3 = data.frameworkUpdates) === null || _a3 === void 0 ? void 0 : _a3.entityBatchUpdate) === null || _b === void 0 ? void 0 : _b.mutations);
  ...
  if (music_multi_select_menu_items.length > 0 && !mutations) {
    ...
    for (const menu_item of music_multi_select_menu_items) {
      const mutation = mutations.find((mutation2) => {
        var _a3, _b;
        return ((_b = (_a3 = mutation2.payload) === null || _a3 === void 0 ? void 0 : _a3.musicFormBooleanChoice) === null || _b === void 0 ? void 0 : _b.id) === menu_item.form_item_entity_key;
      });
...
var AccountInfo = class {
  constructor(response) {
    ...
    (0, import_tslib11.__classPrivateFieldSet)(this, _AccountInfo_page, parser_default.parseResponse(response.data), "f");
    if (!(0, import_tslib11.__classPrivateFieldGet)(this, _AccountInfo_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const account_section_list = (0, import_tslib11.__classPrivateFieldGet)(this, _AccountInfo_page, "f").contents.array().as(AccountSectionList_default).first();
  ...
  get page() {
    return (0, import_tslib11.__classPrivateFieldGet)(this, _AccountInfo_page, "f");
  }
};
...
var Analytics = class {
  constructor(response) {
    ...
    (0, import_tslib12.__classPrivateFieldSet)(this, _Analytics_page, parser_default.parseResponse(response.data), "f");
    this.sections = (_a3 = (0, import_tslib12.__classPrivateFieldGet)(this, _Analytics_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(Element_default).map((el) => el.model).flatMap((el) => !el ? [] : el);
  }
  get page() {
    return (0, import_tslib12.__classPrivateFieldGet)(this, _Analytics_page, "f");
  }
};
...
var Feed = class {
  constructor(actions, response, already_parsed = false) {
    ...
    if ((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_instances, "m", _Feed_isParsed).call(this, response) || already_parsed) {
      (0, import_tslib13.__classPrivateFieldSet)(this, _Feed_page, response, "f");
    } else {
      (0, import_tslib13.__classPrivateFieldSet)(this, _Feed_page, parser_default.parseResponse(response.data), "f");
    }
    const memo = concatMemos(...[
      (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").contents_memo,
      (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").continuation_contents_memo,
      (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").on_response_received_commands_memo,
      (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").on_response_received_endpoints_memo,
      (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").on_response_received_actions_memo,
      (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").sidebar_memo,
      (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").header_memo
    ]);
    if (!memo)
      throw new InnertubeError("No memo found in feed");
    (0, import_tslib13.__classPrivateFieldSet)(this, _Feed_memo, memo, "f");
    (0, import_tslib13.__classPrivateFieldSet)(this, _Feed_actions, actions, "f");
  }
  ...
  get videos() {
    return Feed.getVideosFromMemo((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f"));
  }
  get posts() {
    return (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(BackstagePost_default, Post_default, SharedPost_default);
  }
  get channels() {
    return (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(Channel_default, GridChannel_default);
  }
  get playlists() {
    return Feed.getPlaylistsFromMemo((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f"));
  }
  get memo() {
    return (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f");
  }
  get page_contents() {
    var _a3;
    const tab_content = (_a3 = (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(Tab_default)) === null || _a3 === void 0 ? void 0 : _a3.first().content;
    const reload_continuation_items = (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(ReloadContinuationItemsCommand).first();
    const append_continuation_items = (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(AppendContinuationItemsAction_default).first();
    return tab_content || reload_continuation_items || append_continuation_items;
  }
  get shelves() {
    return (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(Shelf_default, RichShelf_default, ReelShelf_default);
  }
  getShelf(title) {
  ...
  get secondary_contents() {
    var _a3, _b;
    if (!((_a3 = (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").contents) === null || _a3 === void 0 ? void 0 : _a3.is_node))
      return void 0;
    const node = (_b = (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").contents) === null || _b === void 0 ? void 0 : _b.item();
    if (!node.is(TwoColumnBrowseResults_default, TwoColumnSearchResults_default))
      return void 0;
    return node.secondary_contents;
  }
  get actions() {
    return (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_actions, "f");
  }
  get page() {
    return (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f");
  }
  get has_continuation() {
    return ((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f").get("ContinuationItem") || []).length > 0;
  }
  getContinuationData() {
    return (0, import_tslib13.__awaiter)(this, void 0, void 0, function* () {
      if ((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_continuation, "f")) {
        if ((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_continuation, "f").length === 0)
          throw new InnertubeError("There are no continuations.");
        const response = yield (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_continuation, "f")[0].endpoint.call((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_actions, "f"), { parse: true });
        return response;
      }
      (0, import_tslib13.__classPrivateFieldSet)(this, _Feed_continuation, (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(ContinuationItem_default), "f");
      if ((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_continuation, "f"))
...
var TabbedFeed = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    ...
    (0, import_tslib14.__classPrivateFieldSet)(this, _TabbedFeed_actions, actions, "f");
    (0, import_tslib14.__classPrivateFieldSet)(this, _TabbedFeed_tabs, (_a3 = this.page.contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(Tab_default), "f");
  }
  get tabs() {
    var _a3, _b;
    return (_b = (_a3 = (0, import_tslib14.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a3 === void 0 ? void 0 : _a3.map((tab) => tab.title.toString())) !== null && _b !== void 0 ? _b : [];
  }
  getTabByName(title) {
    var _a3;
    return (0, import_tslib14.__awaiter)(this, void 0, void 0, function* () {
      const tab = (_a3 = (0, import_tslib14.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a3 === void 0 ? void 0 : _a3.find((tab2) => tab2.title.toLowerCase() === title.toLowerCase());
      if (!tab)
        throw new InnertubeError(`Tab "${title}" not found`);
      if (tab.selected)
        return this;
      const response = yield tab.endpoint.call((0, import_tslib14.__classPrivateFieldGet)(this, _TabbedFeed_actions, "f"));
      return new TabbedFeed((0, import_tslib14.__classPrivateFieldGet)(this, _TabbedFeed_actions, "f"), response, false);
    });
  }
  getTabByURL(url) {
    var _a3;
    return (0, import_tslib14.__awaiter)(this, void 0, void 0, function* () {
      const tab = (_a3 = (0, import_tslib14.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a3 === void 0 ? void 0 : _a3.find((tab2) => {
        var _a4;
        return ((_a4 = tab2.endpoint.metadata.url) === null || _a4 === void 0 ? void 0 : _a4.split("/").pop()) === url;
      });
      if (!tab)
  ...
  hasTabWithURL(url) {
    var _a3, _b;
    return (_b = (_a3 = (0, import_tslib14.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a3 === void 0 ? void 0 : _a3.some((tab) => {
      var _a4;
      return ((_a4 = tab.endpoint.metadata.url) === null || _a4 === void 0 ? void 0 : _a4.split("/").pop()) === url;
    })) !== null && _b !== void 0 ? _b : false;
  }
  get title() {
    var _a3, _b, _c;
    return (_c = (_b = (_a3 = this.page.contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(Tab_default)) === null || _b === void 0 ? void 0 : _b.find((tab) => tab.selected)) === null || _c === void 0 ? void 0 : _c.title.toString();
  }
};
...
var FilterableFeed = class extends Feed_default {
  ...
  get filter_chips() {
    var _a3, _b;
    if ((0, import_tslib15.__classPrivateFieldGet)(this, _FilterableFeed_chips, "f"))
      return (0, import_tslib15.__classPrivateFieldGet)(this, _FilterableFeed_chips, "f") || [];
    if (((_a3 = this.memo.getType(FeedFilterChipBar_default)) === null || _a3 === void 0 ? void 0 : _a3.length) > 1)
    ...
    (0, import_tslib15.__classPrivateFieldSet)(this, _FilterableFeed_chips, this.memo.getType(ChipCloudChip_default), "f");
    return (0, import_tslib15.__classPrivateFieldGet)(this, _FilterableFeed_chips, "f") || [];
  }
  get filters() {
  ...
  getFilteredFeed(filter) {
    ...
    return (0, import_tslib15.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (target_filter.is_selected)
        return this;
      const response = yield (_a3 = target_filter.endpoint) === null || _a3 === void 0 ? void 0 : _a3.call(this.actions, { parse: true });
      if (!response)
...
var Channel2 = class extends TabbedFeed_default {
  constructor(actions, data, already_parsed = false) {
    var _a3, _b, _c, _d, _e, _f;
    super(actions, data, already_parsed);
    this.header = (_b = (_a3 = this.page.header) === null || _a3 === void 0 ? void 0 : _a3.item()) === null || _b === void 0 ? void 0 : _b.as(C4TabbedHeader_default, CarouselHeader_default, InteractiveTabbedHeader_default, PageHeader_default);
  ...
  applyFilter(filter) {
    var _a3;
    return (0, import_tslib16.__awaiter)(this, void 0, void 0, function* () {
      let target_filter;
      ...
      const page = yield (_a3 = target_filter.endpoint) === null || _a3 === void 0 ? void 0 : _a3.call(this.actions, { parse: true });
      if (!page)
  ...
  applySort(sort) {
    ...
    return (0, import_tslib16.__awaiter)(this, void 0, void 0, function* () {
      ...
      const target_sort = (_a3 = sort_filter_sub_menu === null || sort_filter_sub_menu === void 0 ? void 0 : sort_filter_sub_menu.sub_menu_items) === null || _a3 === void 0 ? void 0 : _a3.find((item) => item.title === sort);
      if (!target_sort)
  ...
  applyContentTypeFilter(content_type_filter) {
    var _a3, _b, _c, _d;
    return (0, import_tslib16.__awaiter)(this, void 0, void 0, function* () {
      const sub_menu = (_c = (_b = (_a3 = this.current_tab) === null || _a3 === void 0 ? void 0 : _a3.content) === null || _b === void 0 ? void 0 : _b.as(SectionList_default).sub_menu) === null || _c === void 0 ? void 0 : _c.as(ChannelSubMenu_default);
      if (!sub_menu)
  ...
  get filters() {
    var _a3, _b;
    return ((_b = (_a3 = this.memo.getType(FeedFilterChipBar_default)) === null || _a3 === void 0 ? void 0 : _a3[0]) === null || _b === void 0 ? void 0 : _b.contents.filterType(ChipCloudChip_default).map((chip) => chip.text)) || [];
  }
  get sort_filters() {
    var _a3;
    const sort_filter_sub_menu = this.memo.getType(SortFilterSubMenu_default).first();
    return ((_a3 = sort_filter_sub_menu === null || sort_filter_sub_menu === void 0 ? void 0 : sort_filter_sub_menu.sub_menu_items) === null || _a3 === void 0 ? void 0 : _a3.map((item) => item.title)) || [];
  }
  ...
  getAbout() {
    ...
    return (0, import_tslib16.__awaiter)(this, void 0, void 0, function* () {
      ...
      return (_a3 = tab.memo.getType(ChannelAboutFullMetadata_default)) === null || _a3 === void 0 ? void 0 : _a3[0];
    });
  }
  search(query) {
    var _a3, _b;
    return (0, import_tslib16.__awaiter)(this, void 0, void 0, function* () {
      const tab = (_a3 = this.memo.getType(ExpandableTab_default)) === null || _a3 === void 0 ? void 0 : _a3[0];
      if (!tab)
  ...
  get has_search() {
    var _a3;
    return ((_a3 = this.memo.getType(ExpandableTab_default)) === null || _a3 === void 0 ? void 0 : _a3.length) > 0;
  }
  getContinuation() {
...
var ChannelListContinuation = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    var _a3, _b;
    super(actions, data, already_parsed);
    this.contents = ((_a3 = this.page.on_response_received_actions) === null || _a3 === void 0 ? void 0 : _a3.first()) || ((_b = this.page.on_response_received_endpoints) === null || _b === void 0 ? void 0 : _b.first());
  }
  getContinuation() {
    const _super = Object.create(null, {
      getContinuationData: { get: () => super.getContinuationData }
...
var Comments = class {
  constructor(actions, data, already_parsed = false) {
    ...
    (0, import_tslib17.__classPrivateFieldSet)(this, _Comments_page, already_parsed ? data : parser_default.parseResponse(data), "f");
    (0, import_tslib17.__classPrivateFieldSet)(this, _Comments_actions, actions, "f");
    const contents = (0, import_tslib17.__classPrivateFieldGet)(this, _Comments_page, "f").on_response_received_endpoints;
    if (!contents)
    ...
    this.header = (_a3 = header_node === null || header_node === void 0 ? void 0 : header_node.contents) === null || _a3 === void 0 ? void 0 : _a3.firstOfType(CommentsHeader_default);
    ...
    this.contents = observe(threads.map((thread) => {
      var _a4;
      (_a4 = thread.comment) === null || _a4 === void 0 ? void 0 : _a4.setActions((0, import_tslib17.__classPrivateFieldGet)(this, _Comments_actions, "f"));
      thread.setActions((0, import_tslib17.__classPrivateFieldGet)(this, _Comments_actions, "f"));
      return thread;
    }));
    (0, import_tslib17.__classPrivateFieldSet)(this, _Comments_continuation, (_c = body_node === null || body_node === void 0 ? void 0 : body_node.contents) === null || _c === void 0 ? void 0 : _c.firstOfType(ContinuationItem_default), "f");
  }
  applySort(sort) {
    var _a3, _b, _c, _d;
    return (0, import_tslib17.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (sort === "TOP_COMMENTS") {
        button = (_b = (_a3 = this.header.sort_menu) === null || _a3 === void 0 ? void 0 : _a3.sub_menu_items) === null || _b === void 0 ? void 0 : _b.at(0);
      ...
      if (button.selected)
        return this;
      const response = yield button.endpoint.call((0, import_tslib17.__classPrivateFieldGet)(this, _Comments_actions, "f"), { parse: true });
      return new Comments((0, import_tslib17.__classPrivateFieldGet)(this, _Comments_actions, "f"), response, true);
    });
  }
  createComment(text) {
    var _a3;
    return (0, import_tslib17.__awaiter)(this, void 0, void 0, function* () {
      ...
      const button = (_a3 = this.header.create_renderer) === null || _a3 === void 0 ? void 0 : _a3.as(CommentSimplebox_default).submit_button;
      if (!button)
      ...
      const response = yield button.endpoint.call((0, import_tslib17.__classPrivateFieldGet)(this, _Comments_actions, "f"), { commentText: text });
      return response;
    });
  }
  getContinuation() {
    return (0, import_tslib17.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib17.__classPrivateFieldGet)(this, _Comments_continuation, "f"))
        throw new InnertubeError("Continuation not found");
      const data = yield (0, import_tslib17.__classPrivateFieldGet)(this, _Comments_continuation, "f").endpoint.call((0, import_tslib17.__classPrivateFieldGet)(this, _Comments_actions, "f"), { parse: true });
      const page = Object.assign({}, (0, import_tslib17.__classPrivateFieldGet)(this, _Comments_page, "f"));
      ...
      return new Comments((0, import_tslib17.__classPrivateFieldGet)(this, _Comments_actions, "f"), page, true);
    });
  }
  get has_continuation() {
    return !!(0, import_tslib17.__classPrivateFieldGet)(this, _Comments_continuation, "f");
  }
  get page() {
    return (0, import_tslib17.__classPrivateFieldGet)(this, _Comments_page, "f");
  }
};
...
var Guide = class {
  constructor(data) {
    ...
    (0, import_tslib18.__classPrivateFieldSet)(this, _Guide_page, parser_exports.parseResponse(data), "f");
    this.contents = (0, import_tslib18.__classPrivateFieldGet)(this, _Guide_page, "f").items.array().as(GuideSection_default, GuideSubscriptionsSection_default);
  }
  get page() {
    return (0, import_tslib18.__classPrivateFieldGet)(this, _Guide_page, "f");
  }
};
__name(Guide, "Guide");
...
var HomeFeed = class extends FilterableFeed_default {
  ...
  getContinuation() {
    ...
    return (0, import_tslib20.__awaiter)(this, void 0, void 0, function* () {
      ...
      (_a3 = feed.page.header_memo) === null || _a3 === void 0 ? void 0 : _a3.set(this.header.type, [this.header]);
      return new HomeFeed(this.actions, feed.page, true);
    });
  }
};
...
var ItemMenu = class {
  ...
  selectItem(item) {
    return (0, import_tslib22.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield endpoint.call((0, import_tslib22.__classPrivateFieldGet)(this, _ItemMenu_actions, "f"), { parse: true });
      return response;
    });
  }
  items() {
...
var Playlist2 = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    ...
    const alert = (_a3 = this.page.alerts) === null || _a3 === void 0 ? void 0 : _a3.firstOfType(Alert_default);
...
_Playlist_instances = /* @__PURE__ */ new WeakSet(), _Playlist_getStat = /* @__PURE__ */ __name(function _Playlist_getStat2(index, primary_info) {
  ...
  if (!primary_info || !primary_info.stats)
    return "N/A";
  return ((_a3 = primary_info.stats[index]) === null || _a3 === void 0 ? void 0 : _a3.toString()) || "N/A";
}, "_Playlist_getStat");
  ...
  constructor(actions, data) {
    ...
    this.sections = shelves.map((shelf) => {
      ...
      return {
        ...
        title: shelf.title,
        contents: ((_a3 = shelf.content) === null || _a3 === void 0 ? void 0 : _a3.key("items").array()) || [],
...
_Library_instances = /* @__PURE__ */ new WeakSet(), _Library_getAll = /* @__PURE__ */ __name(function _Library_getAll2(shelf) {
  ...
  return (0, import_tslib24.__awaiter)(this, void 0, void 0, function* () {
    if (!((_a3 = shelf.menu) === null || _a3 === void 0 ? void 0 : _a3.as(Menu_default).hasKey("top_level_buttons")))
...
var EventEmitterLike = class extends EventTarget {
  ...
  on(type, listener) {
    ...
    (0, import_tslib25.__classPrivateFieldGet)(this, _EventEmitterLike_legacy_listeners, "f").set(listener, wrapper);
  ...
  off(type, listener) {
    const wrapper = (0, import_tslib25.__classPrivateFieldGet)(this, _EventEmitterLike_legacy_listeners, "f").get(listener);
    if (wrapper) {
      this.removeEventListener(type, wrapper);
      (0, import_tslib25.__classPrivateFieldGet)(this, _EventEmitterLike_legacy_listeners, "f").delete(listener);
    }
  }
};
...
var SmoothedQueue = class {
  constructor() {
    ...
    (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_last_update_time, null, "f");
    (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_estimated_update_interval, null, "f");
    (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_callback, null, "f");
    (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_action_queue, [], "f");
    (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_next_update_id, null, "f");
    (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_poll_response_delay_queue, new DelayQueue(), "f");
  }
  enqueueActionGroup(group) {
    if ((0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_last_update_time, "f") !== null) {
      const delay = Date.now() - (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_last_update_time, "f");
      (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").back.push(delay);
      if (5 < (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").front.length + (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").back.length) {
        if (!(0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").front.length) {
          (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").front = (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").back;
          (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").front.reverse();
          (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").back = [];
        }
        (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").front.pop();
      }
      (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_estimated_update_interval, Math.max(...(0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f").getValues()), "f");
    }
    (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_last_update_time, Date.now(), "f");
    (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").push(group);
    if ((0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_next_update_id, "f") === null) {
      (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_next_update_id, setTimeout(this.emitSmoothedActions.bind(this)), "f");
    }
  }
  emitSmoothedActions() {
    (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_next_update_id, null, "f");
    if ((0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").length) {
      let delay = 1e4;
      if ((0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_estimated_update_interval, "f") !== null && (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_last_update_time, "f") !== null) {
        delay = (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_estimated_update_interval, "f") - Date.now() + (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_last_update_time, "f");
      }
      delay = (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").length < delay / 80 ? 1 : Math.ceil((0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").length / (delay / 80));
      const actions = flattenQueue((0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").splice(0, delay));
      if ((0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_callback, "f")) {
        (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_callback, "f").call(this, actions);
      }
      if ((0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f") !== null) {
        delay == 1 ? (delay = (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_estimated_update_interval, "f") / (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f").length, delay *= Math.random() + 0.5, delay = Math.min(1e3, delay), delay = Math.max(80, delay)) : delay = 80;
        (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_next_update_id, setTimeout(this.emitSmoothedActions.bind(this), delay), "f");
      }
    }
  }
  clear() {
    if ((0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_next_update_id, "f") !== null) {
      clearTimeout((0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_next_update_id, "f"));
      (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_next_update_id, null, "f");
    }
    (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_action_queue, [], "f");
  }
  set callback(cb) {
    (0, import_tslib26.__classPrivateFieldSet)(this, _SmoothedQueue_callback, cb, "f");
  }
  get callback() {
    return (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_callback, "f");
  }
  get action_queue() {
    return (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_action_queue, "f");
  }
  get estimated_update_interval() {
    return (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_estimated_update_interval, "f");
  }
  get last_update_time() {
    return (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_last_update_time, "f");
  }
  get next_update_id() {
    return (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_next_update_id, "f");
  }
  get poll_response_delay_queue() {
    return (0, import_tslib26.__classPrivateFieldGet)(this, _SmoothedQueue_poll_response_delay_queue, "f");
  }
};
...
var LiveChat2 = class extends EventEmitterLike_default {
  constructor(video_info) {
    ...
    (0, import_tslib27.__classPrivateFieldSet)(this, _LiveChat_video_id, video_info.basic_info.id, "f");
    (0, import_tslib27.__classPrivateFieldSet)(this, _LiveChat_channel_id, video_info.basic_info.channel_id, "f");
    (0, import_tslib27.__classPrivateFieldSet)(this, _LiveChat_actions, video_info.actions, "f");
    (0, import_tslib27.__classPrivateFieldSet)(this, _LiveChat_continuation, (_a3 = video_info.livechat) === null || _a3 === void 0 ? void 0 : _a3.continuation, "f");
    ...
    this.smoothed_queue.callback = (actions) => (0, import_tslib27.__awaiter)(this, void 0, void 0, function* () {
      if (!actions.length) {
        yield (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
      } else if (actions.length < 10) {
        yield (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_emitSmoothedActions).call(this, actions);
      } else if (this.is_replay) {
        (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_emitSmoothedActions).call(this, actions);
        yield (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
      } else {
        (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_emitSmoothedActions).call(this, actions);
      }
      if (this.running) {
        (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollLivechat).call(this);
      }
    });
  }
  on(type, listener) {
  ...
  start() {
    if (!this.running) {
      this.running = true;
      (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollLivechat).call(this);
      (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollMetadata).call(this);
    }
  }
  stop() {
  ...
  sendMessage(text) {
    return (0, import_tslib27.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_actions, "f").execute("/live_chat/send_message", {
        params: encodeMessageParams((0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_channel_id, "f"), (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_video_id, "f")),
  ...
  applyFilter(filter) {
    ...
    const menu_items = (_c = (_b = (_a3 = this.initial_info) === null || _a3 === void 0 ? void 0 : _a3.header) === null || _b === void 0 ? void 0 : _b.view_selector) === null || _c === void 0 ? void 0 : _c.sub_menu_items;
    if (filter === "TOP_CHAT") {
      if ((_d = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(0)) === null || _d === void 0 ? void 0 : _d.selected)
        return;
      (0, import_tslib27.__classPrivateFieldSet)(this, _LiveChat_continuation, (_e = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(0)) === null || _e === void 0 ? void 0 : _e.continuation, "f");
    } else {
      if ((_f = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(1)) === null || _f === void 0 ? void 0 : _f.selected)
        return;
      (0, import_tslib27.__classPrivateFieldSet)(this, _LiveChat_continuation, (_g = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(1)) === null || _g === void 0 ? void 0 : _g.continuation, "f");
    }
  }
  getItemMenu(item) {
    return (0, import_tslib27.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield item.key("menu_endpoint").instanceof(NavigationEndpoint_default).call((0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_actions, "f"), { parse: true });
      if (!response)
        throw new InnertubeError("Could not retrieve item menu.", item);
      return new ItemMenu_default(response, (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_actions, "f"));
    });
  }
  selectButton(button) {
    return (0, import_tslib27.__awaiter)(this, void 0, void 0, function* () {
      const response = yield button.endpoint.call((0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_actions, "f"), { parse: true });
      return response;
    });
  }
};
...
_LiveChat_actions = /* @__PURE__ */ new WeakMap(), _LiveChat_video_id = /* @__PURE__ */ new WeakMap(), _LiveChat_channel_id = /* @__PURE__ */ new WeakMap(), _LiveChat_continuation = /* @__PURE__ */ new WeakMap(), _LiveChat_mcontinuation = /* @__PURE__ */ new WeakMap(), _LiveChat_retry_count = /* @__PURE__ */ new WeakMap(), _LiveChat_instances = /* @__PURE__ */ new WeakSet(), _LiveChat_pollLivechat = /* @__PURE__ */ __name(function _LiveChat_pollLivechat2() {
  (() => (0, import_tslib27.__awaiter)(this, void 0, void 0, function* () {
    var _a3, _b;
    try {
      const response = yield (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_actions, "f").execute(this.is_replay ? "live_chat/get_live_chat_replay" : "live_chat/get_live_chat", { continuation: (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_continuation, "f"), parse: true });
      ...
      (0, import_tslib27.__classPrivateFieldSet)(this, _LiveChat_continuation, contents.continuation.token, "f");
      if (contents.header) {
        this.initial_info = contents;
        this.emit("start", contents);
        if (this.running)
          (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollLivechat2).call(this);
      } else {
        this.smoothed_queue.enqueueActionGroup(contents.actions);
      }
      (0, import_tslib27.__classPrivateFieldSet)(this, _LiveChat_retry_count, 0, "f");
    } catch (err) {
      this.emit("error", err);
      if (((0, import_tslib27.__classPrivateFieldSet)(this, _LiveChat_retry_count, (_b = (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_retry_count, "f"), _a3 = _b++, _b), "f"), _a3) < 10) {
        yield (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
        (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollLivechat2).call(this);
      } else {
  ...
  return (0, import_tslib27.__awaiter)(this, void 0, void 0, function* () {
    ...
    for (const action of action_queue) {
      yield (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, emit_delay_ms);
  ...
  (() => (0, import_tslib27.__awaiter)(this, void 0, void 0, function* () {
    ...
    try {
      const payload = { videoId: (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_video_id, "f") };
      if ((0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_mcontinuation, "f")) {
        payload.continuation = (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_mcontinuation, "f");
      }
      const response = yield (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_actions, "f").execute("/updated_metadata", payload);
      const data = parser_default.parseResponse(response.data);
      (0, import_tslib27.__classPrivateFieldSet)(this, _LiveChat_mcontinuation, (_a3 = data.continuation) === null || _a3 === void 0 ? void 0 : _a3.token, "f");
      this.metadata = {
      ...
      yield (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 5e3);
      if (this.running)
        (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollMetadata2).call(this);
    } catch (err) {
      yield (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
      if (this.running)
        (0, import_tslib27.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollMetadata2).call(this);
...
var NotificationsMenu = class {
  constructor(actions, response) {
    ...
    (0, import_tslib28.__classPrivateFieldSet)(this, _NotificationsMenu_actions, actions, "f");
    (0, import_tslib28.__classPrivateFieldSet)(this, _NotificationsMenu_page, parser_default.parseResponse(response.data), "f");
    this.header = (0, import_tslib28.__classPrivateFieldGet)(this, _NotificationsMenu_page, "f").actions_memo.getType(SimpleMenuHeader_default).first();
    this.contents = (0, import_tslib28.__classPrivateFieldGet)(this, _NotificationsMenu_page, "f").actions_memo.getType(Notification_default);
  }
  getContinuation() {
    return (0, import_tslib28.__awaiter)(this, void 0, void 0, function* () {
      const continuation = (0, import_tslib28.__classPrivateFieldGet)(this, _NotificationsMenu_page, "f").actions_memo.getType(ContinuationItem_default).first();
      if (!continuation)
        throw new InnertubeError("Continuation not found");
      const response = yield continuation.endpoint.call((0, import_tslib28.__classPrivateFieldGet)(this, _NotificationsMenu_actions, "f"), { parse: false });
      return new NotificationsMenu((0, import_tslib28.__classPrivateFieldGet)(this, _NotificationsMenu_actions, "f"), response);
    });
  }
  get page() {
    return (0, import_tslib28.__classPrivateFieldGet)(this, _NotificationsMenu_page, "f");
  }
};
...
var Search = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    var _a3, _b, _c, _d, _e, _f;
    super(actions, data, already_parsed);
    const contents = ((_a3 = this.page.contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(SectionList_default).first().contents) || ((_b = this.page.on_response_received_commands) === null || _b === void 0 ? void 0 : _b.first().contents);
    if (!contents)
  ...
  selectRefinementCard(card) {
    ...
    return (0, import_tslib29.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (typeof card === "string") {
        ...
        target_card = (_b = (_a3 = this.refinement_cards) === null || _a3 === void 0 ? void 0 : _a3.cards.get({ query: card })) === null || _b === void 0 ? void 0 : _b.as(SearchRefinementCard_default);
        if (!target_card)
  ...
  get refinement_card_queries() {
    var _a3;
    return ((_a3 = this.refinement_cards) === null || _a3 === void 0 ? void 0 : _a3.cards.as(SearchRefinementCard_default).map((card) => card.query)) || [];
  }
  getContinuation() {
    return (0, import_tslib29.__awaiter)(this, void 0, void 0, function* () {
      const response = yield this.getContinuationData();
...
var Settings = class {
  constructor(actions, response) {
    ...
    (0, import_tslib30.__classPrivateFieldSet)(this, _Settings_actions, actions, "f");
    (0, import_tslib30.__classPrivateFieldSet)(this, _Settings_page, parser_default.parseResponse(response.data), "f");
    this.sidebar = (_a3 = (0, import_tslib30.__classPrivateFieldGet)(this, _Settings_page, "f").sidebar) === null || _a3 === void 0 ? void 0 : _a3.as(SettingsSidebar_default);
    if (!(0, import_tslib30.__classPrivateFieldGet)(this, _Settings_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const tab = (0, import_tslib30.__classPrivateFieldGet)(this, _Settings_page, "f").contents.item().as(TwoColumnBrowseResults_default).tabs.array().as(Tab_default).get({ selected: true });
    if (!tab)
    ...
    this.sections = contents === null || contents === void 0 ? void 0 : contents.map((el) => {
      var _a4;
      return {
        title: ((_a4 = el.header) === null || _a4 === void 0 ? void 0 : _a4.title.toString()) || null,
  ...
  selectSidebarItem(target_item) {
    return (0, import_tslib30.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield item.endpoint.call((0, import_tslib30.__classPrivateFieldGet)(this, _Settings_actions, "f"), { parse: false });
      return new Settings((0, import_tslib30.__classPrivateFieldGet)(this, _Settings_actions, "f"), response);
    });
  }
      ...
      for (const el of section.contents) {
        ...
        if (options) {
          for (const option of options) {
            if (option.is(SettingsSwitch_default) && ((_a3 = option.title) === null || _a3 === void 0 ? void 0 : _a3.toString()) === name)
              return option;
          }
        }
      }
  ...
  get setting_options() {
    ...
    return options.map((opt) => {
      var _a3;
      return (_a3 = opt.title) === null || _a3 === void 0 ? void 0 : _a3.toString();
    }).filter((el) => el);
  }
  get sidebar_items() {
    if (!this.sidebar)
  ...
  get page() {
    return (0, import_tslib30.__classPrivateFieldGet)(this, _Settings_page, "f");
  }
};
...
var TimeWatched = class {
  constructor(response) {
    ...
    (0, import_tslib31.__classPrivateFieldSet)(this, _TimeWatched_page, parser_default.parseResponse(response.data), "f");
    if (!(0, import_tslib31.__classPrivateFieldGet)(this, _TimeWatched_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const tab = (0, import_tslib31.__classPrivateFieldGet)(this, _TimeWatched_page, "f").contents.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find target tab.");
    this.contents = (_a3 = tab.content) === null || _a3 === void 0 ? void 0 : _a3.as(SectionList_default).contents.as(ItemSection_default);
  }
  get page() {
    return (0, import_tslib31.__classPrivateFieldGet)(this, _TimeWatched_page, "f");
  }
};
...
var UniversalCache = class {
  constructor(persistent, persistent_directory) {
    ...
    (0, import_tslib33.__classPrivateFieldSet)(this, _UniversalCache_cache, new Platform.shim.Cache(persistent, persistent_directory), "f");
  }
  get cache_dir() {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").cache_dir;
  }
  get(key) {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").get(key);
  }
  set(key, value) {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").set(key, value);
  }
  remove(key) {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").remove(key);
  }
};
...
var HTTPClient = class {
  constructor(session, cookie, fetch) {
    ...
    (0, import_tslib34.__classPrivateFieldSet)(this, _HTTPClient_session, session, "f");
    (0, import_tslib34.__classPrivateFieldSet)(this, _HTTPClient_cookie, cookie, "f");
    (0, import_tslib34.__classPrivateFieldSet)(this, _HTTPClient_fetch, fetch || Platform.shim.fetch, "f");
  }
  get fetch_function() {
    return (0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_fetch, "f");
  }
  fetch(input, init) {
    return (0, import_tslib34.__awaiter)(this, void 0, void 0, function* () {
      const innertube_url = URLS.API.PRODUCTION_1 + (0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_session, "f").api_version;
      ...
      request_headers.set("X-Goog-Visitor-Id", (0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_session, "f").context.client.visitorData || "");
      request_headers.set("X-Origin", request_url.origin);
      request_headers.set("X-Youtube-Client-Version", (0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_session, "f").context.client.clientVersion || "");
      if (Platform.shim.server) {
        request_headers.set("User-Agent", getRandomUserAgent("desktop"));
        request_headers.set("origin", request_url.origin);
      }
      request_url.searchParams.set("key", (0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_session, "f").key);
      ...
      if (content_type === "application/json" && is_innertube_req && typeof body === "string") {
        ...
        const n_body = Object.assign(Object.assign({}, json), {
          context: JSON.parse(JSON.stringify((0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_session, "f").context))
        });
        (0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_instances, "m", _HTTPClient_adjustContext).call(this, n_body.context, n_body.client);
      ...
      if ((0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_session, "f").logged_in && is_innertube_req && !is_web_kids) {
        const oauth = (0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_session, "f").oauth;
        ...
        if ((0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_cookie, "f")) {
          const papisid = getStringBetweenStrings((0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_cookie, "f"), "PAPISID=", ";");
          if (papisid) {
            request_headers.set("authorization", yield generateSidAuth(papisid));
            request_headers.set("x-goog-authuser", (0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_session, "f").account_index.toString());
          }
          request_headers.set("cookie", (0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_cookie, "f"));
        }
      }
      const request = new Platform.shim.Request(request_url, input instanceof Platform.shim.Request ? input : init);
      const response = yield (0, import_tslib34.__classPrivateFieldGet)(this, _HTTPClient_fetch, "f").call(this, request, {
        body: request_body,
...
function getFormatGroupings(formats) {
  ...
  for (const format of formats) {
    ...
    const just_codec = (_a3 = getStringBetweenStrings(format.mime_type, 'codecs="', '"')) === null || _a3 === void 0 ? void 0 : _a3.split(".")[0];
...
function getOTFSegmentTemplate(url, actions) {
  ...
  return (0, import_tslib35.__awaiter)(this, void 0, void 0, function* () {
    ...
    const segment_duration_strings = (_a3 = getStringBetweenStrings(response_text, "Segment-Durations-Ms:", "\r\n")) === null || _a3 === void 0 ? void 0 : _a3.split(",");
...
function getAudioSet(formats, url_transformer, actions, player, cpn) {
  ...
  const set = {
    ...
    language: (_a3 = first_format.language) !== null && _a3 !== void 0 ? _a3 : void 0,
...
function getStoryboardInfo(storyboards) {
  ...
  for (const storyboard of storyboards.boards) {
    ...
    (_a3 = mime_info.get(mime_type)) === null || _a3 === void 0 ? void 0 : _a3.push(storyboard);
  }
  return mime_info;
}
...
function DashManifest({ streamingData, transformURL, rejectFormat, cpn, player, actions, storyboards }) {
  ...
  return createElement(
    ...
    createElement(
      ...
      image_sets.map((set, index) => (0, import_tslib36.__awaiter)(this, void 0, void 0, function* () {
        return createElement("adaptation-set", { id: index + audio_sets.length + video_sets.length, mimeType: yield set.getMimeType(), contentType: "image" }, set.representations.map((rep) => (0, import_tslib36.__awaiter)(this, void 0, void 0, function* () {
          return createElement(
            "representation",
...
function download(options, actions, playability_status, streaming_data, player, cpn) {
  return (0, import_tslib37.__awaiter)(this, void 0, void 0, function* () {
    ...
    const readable_stream = new Platform.shim.ReadableStream({
      ...
      pull: (controller) => (0, import_tslib37.__awaiter)(this, void 0, void 0, function* () {
        if (must_end) {
          controller.close();
          return;
        }
        ...
        return new Promise((resolve, reject) => (0, import_tslib37.__awaiter)(this, void 0, void 0, function* () {
          var _a3, e_1, _b, _c;
          try {
            ...
            if (!body)
              throw new InnertubeError("Could not get ReadableStream from fetch Response.", { error_type: "FETCH_FAILED", response });
            try {
              for (var _d = true, _e = (0, import_tslib37.__asyncValues)(streamToIterable(body)), _f; _f = yield _e.next(), _a3 = _f.done, !_a3; _d = true) {
                _c = _f.value;
                _d = false;
                const chunk = _c;
...
var TranscriptInfo = class {
  constructor(actions, response) {
    ...
    (0, import_tslib38.__classPrivateFieldSet)(this, _TranscriptInfo_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib38.__classPrivateFieldSet)(this, _TranscriptInfo_actions, actions, "f");
    this.transcript = (0, import_tslib38.__classPrivateFieldGet)(this, _TranscriptInfo_page, "f").actions_memo.getType(Transcript_default).first();
  }
  selectLanguage(language) {
    var _a3, _b, _c, _d;
    return (0, import_tslib38.__awaiter)(this, void 0, void 0, function* () {
      const target_menu_item = (_d = (_c = (_b = (_a3 = this.transcript.content) === null || _a3 === void 0 ? void 0 : _a3.footer) === null || _b === void 0 ? void 0 : _b.language_menu) === null || _c === void 0 ? void 0 : _c.sub_menu_items) === null || _d === void 0 ? void 0 : _d.find((item) => item.title.toString() === language);
      if (!target_menu_item)
        throw new Error(`Language not found: ${language}`);
      if (target_menu_item.selected)
        return this;
      const response = yield (0, import_tslib38.__classPrivateFieldGet)(this, _TranscriptInfo_actions, "f").execute("/get_transcript", {
        params: target_menu_item.continuation
      });
      return new TranscriptInfo((0, import_tslib38.__classPrivateFieldGet)(this, _TranscriptInfo_actions, "f"), response);
    });
  }
  get languages() {
    var _a3, _b, _c, _d;
    return ((_d = (_c = (_b = (_a3 = this.transcript.content) === null || _a3 === void 0 ? void 0 : _a3.footer) === null || _b === void 0 ? void 0 : _b.language_menu) === null || _c === void 0 ? void 0 : _c.sub_menu_items) === null || _d === void 0 ? void 0 : _d.map((item) => item.title.toString())) || [];
  }
  get selectedLanguage() {
    var _a3, _b, _c, _d, _e;
    return ((_e = (_d = (_c = (_b = (_a3 = this.transcript.content) === null || _a3 === void 0 ? void 0 : _a3.footer) === null || _b === void 0 ? void 0 : _b.language_menu) === null || _c === void 0 ? void 0 : _c.sub_menu_items) === null || _d === void 0 ? void 0 : _d.find((item) => item.selected)) === null || _e === void 0 ? void 0 : _e.title.toString()) || "";
  }
  get page() {
    return (0, import_tslib38.__classPrivateFieldGet)(this, _TranscriptInfo_page, "f");
  }
};
...
var MediaInfo = class {
  constructor(data, actions, cpn) {
    ...
    (0, import_tslib39.__classPrivateFieldSet)(this, _MediaInfo_actions, actions, "f");
    const info = parser_default.parseResponse(data[0].data);
    const next = ((_a3 = data === null || data === void 0 ? void 0 : data[1]) === null || _a3 === void 0 ? void 0 : _a3.data) ? parser_default.parseResponse(data[1].data) : void 0;
    (0, import_tslib39.__classPrivateFieldSet)(this, _MediaInfo_page, [info, next], "f");
    (0, import_tslib39.__classPrivateFieldSet)(this, _MediaInfo_cpn, cpn, "f");
    if (((_b = info.playability_status) === null || _b === void 0 ? void 0 : _b.status) === "ERROR")
      throw new InnertubeError("This video is unavailable", info.playability_status);
    this.streaming_data = info.streaming_data;
    this.playability_status = info.playability_status;
    (0, import_tslib39.__classPrivateFieldSet)(this, _MediaInfo_playback_tracking, info.playback_tracking, "f");
  }
  toDash(url_transformer, format_filter, options = { include_thumbnails: false }) {
    ...
    return (0, import_tslib39.__awaiter)(this, void 0, void 0, function* () {
      const player_response = (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0];
      ...
      let storyboards;
      if (options.include_thumbnails && ((_a3 = player_response.storyboards) === null || _a3 === void 0 ? void 0 : _a3.is(PlayerStoryboardSpec_default))) {
        storyboards = player_response.storyboards;
      }
      return toDash(this.streaming_data, url_transformer, format_filter, (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f"), (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), storyboards);
    });
  }
  getStreamingInfo(url_transformer, format_filter) {
    var _a3;
    return getStreamingInfo(this.streaming_data, url_transformer, format_filter, this.cpn, (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), ((_a3 = (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0].storyboards) === null || _a3 === void 0 ? void 0 : _a3.is(PlayerStoryboardSpec_default)) ? (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0].storyboards : void 0);
  }
  ...
  download(options = {}) {
    return (0, import_tslib39.__awaiter)(this, void 0, void 0, function* () {
      ...
      return download(options, (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), this.playability_status, this.streaming_data, (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, this.cpn);
    });
  }
  getTranscript() {
    var _a3;
    return (0, import_tslib39.__awaiter)(this, void 0, void 0, function* () {
      ...
      const transcript_continuation = (_a3 = transcript_panel.content) === null || _a3 === void 0 ? void 0 : _a3.as(ContinuationItem_default);
  ...
  addToWatchHistory(client_name = CLIENTS.WEB.NAME, client_version = CLIENTS.WEB.VERSION, replacement = "https://www.") {
    return (0, import_tslib39.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_playback_tracking, "f"))
        throw new InnertubeError("Playback tracking not available");
      const url_params = {
        cpn: (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f"),
        fmt: 251,
        rtn: 0,
        rt: 0
      };
      const url = (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_playback_tracking, "f").videostats_playback_url.replace("https://s.", replacement);
      const response = yield (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").stats(url, {
        client_name,
        client_version
      }, url_params);
      return response;
  ...
  get actions() {
    return (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_actions, "f");
  }
  get cpn() {
    return (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f");
  }
  get page() {
    return (0, import_tslib39.__classPrivateFieldGet)(this, _MediaInfo_page, "f");
  }
};
...
var VideoInfo = class extends MediaInfo_default {
  constructor(data, actions, cpn) {
    var _a3, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17;
    super(data, actions, cpn);
    _VideoInfo_watch_next_continuation.set(this, void 0);
    const [info, next] = this.page;
    if (info.microformat && !((_a3 = info.microformat) === null || _a3 === void 0 ? void 0 : _a3.is(PlayerMicroformat_default, MicroformatData_default)))
    ...
    if (this.streaming_data) {
      const default_audio_track = this.streaming_data.adaptive_formats.find((format) => {
        var _a4;
        return (_a4 = format.audio_track) === null || _a4 === void 0 ? void 0 : _a4.audio_is_default;
      });
    ...
    if (results && secondary_results) {
      ...
      if (this.watch_next_feed && Array.isArray(this.watch_next_feed) && ((_5 = this.watch_next_feed.at(-1)) === null || _5 === void 0 ? void 0 : _5.is(ContinuationItem_default)))
        (0, import_tslib40.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation, (_6 = this.watch_next_feed.pop()) === null || _6 === void 0 ? void 0 : _6.as(ContinuationItem_default), "f");
  ...
  selectFilter(target_filter) {
    ...
    return (0, import_tslib40.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (typeof target_filter === "string") {
        const filter = (_b = (_a3 = this.related_chip_cloud) === null || _a3 === void 0 ? void 0 : _a3.chips) === null || _b === void 0 ? void 0 : _b.get({ text: target_filter });
        if (!filter)
  ...
  getWatchNextContinuation() {
    ...
    return (0, import_tslib40.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (_a3 = (0, import_tslib40.__classPrivateFieldGet)(this, _VideoInfo_watch_next_continuation, "f")) === null || _a3 === void 0 ? void 0 : _a3.endpoint.call(this.actions, { parse: true });
  ...
  like() {
    var _a3, _b;
    return (0, import_tslib40.__awaiter)(this, void 0, void 0, function* () {
      const segmented_like_dislike_button = (_b = (_a3 = this.primary_info) === null || _a3 === void 0 ? void 0 : _a3.menu) === null || _b === void 0 ? void 0 : _b.top_level_buttons.firstOfType(SegmentedLikeDislikeButton_default);
  ...
  getTrailerInfo() {
    var _a3, _b;
    if (this.has_trailer) {
      const player_response = (_b = (_a3 = this.playability_status.error_screen) === null || _a3 === void 0 ? void 0 : _a3.as(PlayerLegacyDesktopYpcTrailer_default).trailer) === null || _b === void 0 ? void 0 : _b.player_response;
      if (player_response) {
  ...
  get filters() {
    var _a3, _b;
    return ((_b = (_a3 = this.related_chip_cloud) === null || _a3 === void 0 ? void 0 : _a3.chips) === null || _b === void 0 ? void 0 : _b.map((chip) => {
      var _a4;
      return (_a4 = chip.text) === null || _a4 === void 0 ? void 0 : _a4.toString();
    })) || [];
  }
  ...
  get autoplay_video_endpoint() {
    var _a3, _b, _c;
    return ((_c = (_b = (_a3 = this.autoplay) === null || _a3 === void 0 ? void 0 : _a3.sets) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.autoplay_video) || null;
  }
  get has_trailer() {
    var _a3;
    return !!((_a3 = this.playability_status.error_screen) === null || _a3 === void 0 ? void 0 : _a3.is(PlayerLegacyDesktopYpcTrailer_default));
  }
  get music_tracks() {
    var _a3, _b, _c, _d, _e, _f;
    const description_content = (_b = (_a3 = this.page[1]) === null || _a3 === void 0 ? void 0 : _a3.engagement_panels) === null || _b === void 0 ? void 0 : _b.filter((panel) => {
      var _a4;
      return (_a4 = panel.content) === null || _a4 === void 0 ? void 0 : _a4.is(StructuredDescriptionContent_default);
    });
    if (description_content !== void 0 && description_content.length > 0) {
      ...
      if (music_section !== void 0 && music_section.length > 0) {
        return (_f = music_section[0].carousel_lockups) === null || _f === void 0 ? void 0 : _f.map((lookup) => {
          var _a4, _b2, _c2, _d2, _e2, _f2, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u;
          let song;
          let artist;
          let album;
          let license;
          let videoId;
          let channelId;
          song = (_b2 = (_a4 = lookup.video_lockup) === null || _a4 === void 0 ? void 0 : _a4.title) === null || _b2 === void 0 ? void 0 : _b2.toString();
...
var Album = class {
  constructor(response) {
    ...
    (0, import_tslib41.__classPrivateFieldSet)(this, _Album_page, parser_default.parseResponse(response.data), "f");
    this.header = (_a3 = (0, import_tslib41.__classPrivateFieldGet)(this, _Album_page, "f").header) === null || _a3 === void 0 ? void 0 : _a3.item().as(MusicDetailHeader_default);
    this.url = ((_b = (0, import_tslib41.__classPrivateFieldGet)(this, _Album_page, "f").microformat) === null || _b === void 0 ? void 0 : _b.as(MicroformatData_default).url_canonical) || null;
    if (!(0, import_tslib41.__classPrivateFieldGet)(this, _Album_page, "f").contents_memo)
      throw new Error("No contents found in the response");
    this.contents = (_c = (0, import_tslib41.__classPrivateFieldGet)(this, _Album_page, "f").contents_memo.getType(MusicShelf_default)) === null || _c === void 0 ? void 0 : _c.first().contents;
    this.sections = (0, import_tslib41.__classPrivateFieldGet)(this, _Album_page, "f").contents_memo.getType(MusicCarouselShelf_default) || [];
  }
  get page() {
    return (0, import_tslib41.__classPrivateFieldGet)(this, _Album_page, "f");
  }
};
__name(Album, "Album");
...
var Artist = class {
  constructor(response, actions) {
    ...
    (0, import_tslib42.__classPrivateFieldSet)(this, _Artist_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib42.__classPrivateFieldSet)(this, _Artist_actions, actions, "f");
    this.header = (_a3 = this.page.header) === null || _a3 === void 0 ? void 0 : _a3.item().as(MusicImmersiveHeader_default, MusicVisualHeader_default, MusicHeader_default);
    const music_shelf = ((_b = (0, import_tslib42.__classPrivateFieldGet)(this, _Artist_page, "f").contents_memo) === null || _b === void 0 ? void 0 : _b.getType(MusicShelf_default)) || [];
    const music_carousel_shelf = ((_c = (0, import_tslib42.__classPrivateFieldGet)(this, _Artist_page, "f").contents_memo) === null || _c === void 0 ? void 0 : _c.getType(MusicCarouselShelf_default)) || [];
  ...
  getAllSongs() {
    ...
    return (0, import_tslib42.__awaiter)(this, void 0, void 0, function* () {
      ...
      const page = yield shelf.endpoint.call((0, import_tslib42.__classPrivateFieldGet)(this, _Artist_actions, "f"), { client: "YTMUSIC", parse: true });
      const contents = (_b = (_a3 = page.contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(MusicPlaylistShelf_default)) === null || _b === void 0 ? void 0 : _b.first();
      return contents;
    });
  }
  get page() {
    return (0, import_tslib42.__classPrivateFieldGet)(this, _Artist_page, "f");
  }
};
...
var Explore = class {
  constructor(response) {
    ...
    (0, import_tslib43.__classPrivateFieldSet)(this, _Explore_page, parser_default.parseResponse(response.data), "f");
    const tab = (_a3 = (0, import_tslib43.__classPrivateFieldGet)(this, _Explore_page, "f").contents) === null || _a3 === void 0 ? void 0 : _a3.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find target tab.");
  ...
  get page() {
    return (0, import_tslib43.__classPrivateFieldGet)(this, _Explore_page, "f");
  }
};
...
var HomeFeed2 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib44.__classPrivateFieldSet)(this, _HomeFeed_actions, actions, "f");
    (0, import_tslib44.__classPrivateFieldSet)(this, _HomeFeed_page, parser_default.parseResponse(response.data), "f");
    const tab = (_a3 = (0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_page, "f").contents) === null || _a3 === void 0 ? void 0 : _a3.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find Home tab.");
    if (tab.content === null) {
      if (!(0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_page, "f").continuation_contents)
        throw new InnertubeError("Continuation did not have any content.");
      (0, import_tslib44.__classPrivateFieldSet)(this, _HomeFeed_continuation, (0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_page, "f").continuation_contents.as(SectionListContinuation).continuation, "f");
      this.sections = (_b = (0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_page, "f").continuation_contents.as(SectionListContinuation).contents) === null || _b === void 0 ? void 0 : _b.as(MusicCarouselShelf_default);
      return;
    }
    ...
    (0, import_tslib44.__classPrivateFieldSet)(this, _HomeFeed_continuation, (_e = tab.content) === null || _e === void 0 ? void 0 : _e.as(SectionList_default).continuation, "f");
  ...
  getContinuation() {
    return (0, import_tslib44.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_continuation, "f")
      });
      return new HomeFeed2(response, (0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_actions, "f"));
    });
  }
  applyFilter(target_filter) {
    ...
    return (0, import_tslib44.__awaiter)(this, void 0, void 0, function* () {
      let cloud_chip;
      if (typeof target_filter === "string") {
        cloud_chip = (_b = (_a3 = this.header) === null || _a3 === void 0 ? void 0 : _a3.chips) === null || _b === void 0 ? void 0 : _b.as(ChipCloudChip_default).get({ text: target_filter });
        if (!cloud_chip)
      ...
      const response = yield cloud_chip.endpoint.call((0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_actions, "f"), { client: "YTMUSIC" });
      return new HomeFeed2(response, (0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_actions, "f"));
    });
  }
  get filters() {
    var _a3, _b;
    return ((_b = (_a3 = this.header) === null || _a3 === void 0 ? void 0 : _a3.chips) === null || _b === void 0 ? void 0 : _b.as(ChipCloudChip_default).map((chip) => chip.text)) || [];
  }
  get has_continuation() {
    return !!(0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_continuation, "f");
  }
  get page() {
    return (0, import_tslib44.__classPrivateFieldGet)(this, _HomeFeed_page, "f");
  }
};
...
var Library2 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib45.__classPrivateFieldSet)(this, _Library_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib45.__classPrivateFieldSet)(this, _Library_actions, actions, "f");
    const section_list = (_a3 = (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(SectionList_default).first();
    ...
    (0, import_tslib45.__classPrivateFieldSet)(this, _Library_continuation, (_e = (_d = this.contents) === null || _d === void 0 ? void 0 : _d.find((list) => list.continuation)) === null || _e === void 0 ? void 0 : _e.continuation, "f");
  }
  applySort(sort_by) {
    var _a3, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    return (0, import_tslib45.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (typeof sort_by === "string") {
        const button = (_a3 = (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(MusicSortFilterButton_default).first();
      ...
      const response = yield (0, import_tslib45.__classPrivateFieldGet)(this, _Library_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: cmd.continuation.reloadContinuationData.continuation,
        parse: true
      });
      const previously_selected_item = (_h = (_g = (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _g === void 0 ? void 0 : _g.getType(MusicMultiSelectMenuItem_default)) === null || _h === void 0 ? void 0 : _h.find((item) => item.selected);
  ...
  applyFilter(filter) {
    ...
    return (0, import_tslib45.__awaiter)(this, void 0, void 0, function* () {
      let target_chip;
      const chip_cloud = (_a3 = (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(ChipCloud_default).first();
      if (typeof filter === "string") {
      ...
      const response = yield target_cmd.call((0, import_tslib45.__classPrivateFieldGet)(this, _Library_actions, "f"), { client: "YTMUSIC" });
      return new Library2(response, (0, import_tslib45.__classPrivateFieldGet)(this, _Library_actions, "f"));
    });
  }
  getContinuation() {
    return (0, import_tslib45.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib45.__classPrivateFieldGet)(this, _Library_continuation, "f"))
        throw new InnertubeError("No continuation available");
      const page = yield (0, import_tslib45.__classPrivateFieldGet)(this, _Library_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib45.__classPrivateFieldGet)(this, _Library_continuation, "f")
      });
      return new LibraryContinuation(page, (0, import_tslib45.__classPrivateFieldGet)(this, _Library_actions, "f"));
    });
  }
  get has_continuation() {
    return !!(0, import_tslib45.__classPrivateFieldGet)(this, _Library_continuation, "f");
  }
  get sort_options() {
    var _a3, _b;
    const button = (_a3 = (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(MusicSortFilterButton_default).first();
  ...
  get filters() {
    var _a3, _b;
    return ((_b = (_a3 = (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(ChipCloud_default)) === null || _b === void 0 ? void 0 : _b.first().chips.map((chip) => chip.text)) || [];
  }
  get page() {
    return (0, import_tslib45.__classPrivateFieldGet)(this, _Library_page, "f");
  }
};
...
var LibraryContinuation = class {
  constructor(response, actions) {
    ...
    (0, import_tslib45.__classPrivateFieldSet)(this, _LibraryContinuation_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib45.__classPrivateFieldSet)(this, _LibraryContinuation_actions, actions, "f");
    if (!(0, import_tslib45.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f").continuation_contents)
      throw new InnertubeError("No continuation contents found");
    this.contents = (0, import_tslib45.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f").continuation_contents.as(MusicShelfContinuation, GridContinuation);
    (0, import_tslib45.__classPrivateFieldSet)(this, _LibraryContinuation_continuation, this.contents.continuation || null, "f");
  }
  getContinuation() {
    return (0, import_tslib45.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib45.__classPrivateFieldGet)(this, _LibraryContinuation_continuation, "f"))
        throw new InnertubeError("No continuation available");
      const response = yield (0, import_tslib45.__classPrivateFieldGet)(this, _LibraryContinuation_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib45.__classPrivateFieldGet)(this, _LibraryContinuation_continuation, "f")
      });
      return new LibraryContinuation(response, (0, import_tslib45.__classPrivateFieldGet)(this, _LibraryContinuation_actions, "f"));
    });
  }
  get has_continuation() {
    return !!(0, import_tslib45.__classPrivateFieldGet)(this, _LibraryContinuation_continuation, "f");
  }
  get page() {
    return (0, import_tslib45.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f");
  }
};
...
var Playlist3 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib46.__classPrivateFieldSet)(this, _Playlist_actions, actions, "f");
    (0, import_tslib46.__classPrivateFieldSet)(this, _Playlist_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib46.__classPrivateFieldSet)(this, _Playlist_last_fetched_suggestions, null, "f");
    (0, import_tslib46.__classPrivateFieldSet)(this, _Playlist_suggestions_continuation, null, "f");
    if ((0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").continuation_contents) {
      const data = (_a3 = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").continuation_contents) === null || _a3 === void 0 ? void 0 : _a3.as(MusicPlaylistShelfContinuation);
      this.items = data.contents;
      (0, import_tslib46.__classPrivateFieldSet)(this, _Playlist_continuation, data.continuation, "f");
    } else {
      if (((_b = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").header) === null || _b === void 0 ? void 0 : _b.item().type) === "MusicEditablePlaylistDetailHeader") {
        this.header = (_d = (_c = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").header) === null || _c === void 0 ? void 0 : _c.item().as(MusicEditablePlaylistDetailHeader_default).header) === null || _d === void 0 ? void 0 : _d.as(MusicDetailHeader_default);
      } else {
        this.header = (_e = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").header) === null || _e === void 0 ? void 0 : _e.item().as(MusicDetailHeader_default);
      }
      this.items = ((_f = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _f === void 0 ? void 0 : _f.getType(MusicPlaylistShelf_default).first().contents) || null;
      (0, import_tslib46.__classPrivateFieldSet)(this, _Playlist_continuation, ((_g = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _g === void 0 ? void 0 : _g.getType(MusicPlaylistShelf_default).first().continuation) || null, "f");
    }
  }
  getContinuation() {
    return (0, import_tslib46.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_continuation, "f")
      });
      return new Playlist3(response, (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_actions, "f"));
    });
  }
  getRelated() {
    var _a3, _b, _c, _d, _e;
    return (0, import_tslib46.__awaiter)(this, void 0, void 0, function* () {
      let section_continuation = (_b = (_a3 = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(SectionList_default)) === null || _b === void 0 ? void 0 : _b[0].continuation;
      while (section_continuation) {
        const data = yield (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_actions, "f").execute("/browse", {
          client: "YTMUSIC",
  ...
  getSuggestions(refresh = true) {
    return (0, import_tslib46.__awaiter)(this, void 0, void 0, function* () {
      const require_fetch = refresh || !(0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_last_fetched_suggestions, "f");
      const fetch_promise = require_fetch ? (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_instances2, "m", _Playlist_fetchSuggestions).call(this) : Promise.resolve(null);
      const fetch_result = yield fetch_promise;
      if (fetch_result) {
        (0, import_tslib46.__classPrivateFieldSet)(this, _Playlist_last_fetched_suggestions, fetch_result.items, "f");
        (0, import_tslib46.__classPrivateFieldSet)(this, _Playlist_suggestions_continuation, fetch_result.continuation, "f");
      }
      return (fetch_result === null || fetch_result === void 0 ? void 0 : fetch_result.items) || (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_last_fetched_suggestions, "f");
    });
  }
  get page() {
    return (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f");
  }
  get has_continuation() {
    return !!(0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_continuation, "f");
  }
};
...
_Playlist_page = /* @__PURE__ */ new WeakMap(), _Playlist_actions = /* @__PURE__ */ new WeakMap(), _Playlist_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_last_fetched_suggestions = /* @__PURE__ */ new WeakMap(), _Playlist_suggestions_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_instances2 = /* @__PURE__ */ new WeakSet(), _Playlist_fetchSuggestions = /* @__PURE__ */ __name(function _Playlist_fetchSuggestions2() {
  var _a3, _b, _c, _d, _e;
  return (0, import_tslib46.__awaiter)(this, void 0, void 0, function* () {
    const continuation = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_suggestions_continuation, "f") || ((_b = (_a3 = (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.get("SectionList")) === null || _b === void 0 ? void 0 : _b[0].as(SectionList_default).continuation);
    if (continuation) {
      const page = yield (0, import_tslib46.__classPrivateFieldGet)(this, _Playlist_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation,
        parse: true
      });
...
var Recap = class {
  constructor(response, actions) {
    ...
    (0, import_tslib47.__classPrivateFieldSet)(this, _Recap_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib47.__classPrivateFieldSet)(this, _Recap_actions, actions, "f");
    const header = (_a3 = (0, import_tslib47.__classPrivateFieldGet)(this, _Recap_page, "f").header) === null || _a3 === void 0 ? void 0 : _a3.item();
    this.header = (header === null || header === void 0 ? void 0 : header.is(MusicElementHeader_default)) ? (_d = (_c = (_b = (0, import_tslib47.__classPrivateFieldGet)(this, _Recap_page, "f").header) === null || _b === void 0 ? void 0 : _b.item().as(MusicElementHeader_default).element) === null || _c === void 0 ? void 0 : _c.model) === null || _d === void 0 ? void 0 : _d.as(HighlightsCarousel_default) : (_e = (0, import_tslib47.__classPrivateFieldGet)(this, _Recap_page, "f").header) === null || _e === void 0 ? void 0 : _e.item().as(MusicHeader_default);
    const tab = (_f = (0, import_tslib47.__classPrivateFieldGet)(this, _Recap_page, "f").contents) === null || _f === void 0 ? void 0 : _f.item().as(SingleColumnBrowseResults_default).tabs.firstOfType(Tab_default);
    if (!tab)
      throw new InnertubeError("Target tab not found");
  ...
  getPlaylist() {
    return (0, import_tslib47.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield endpoint.call((0, import_tslib47.__classPrivateFieldGet)(this, _Recap_actions, "f"), { client: "YTMUSIC" });
      return new Playlist_default3(response, (0, import_tslib47.__classPrivateFieldGet)(this, _Recap_actions, "f"));
    });
  }
  get page() {
    return (0, import_tslib47.__classPrivateFieldGet)(this, _Recap_page, "f");
  }
};
__name(Recap, "Recap");
...
var Search2 = class {
  constructor(response, actions, is_filtered) {
    ...
    (0, import_tslib48.__classPrivateFieldSet)(this, _Search_actions, actions, "f");
    (0, import_tslib48.__classPrivateFieldSet)(this, _Search_page, parser_default.parseResponse(response.data), "f");
    if (!(0, import_tslib48.__classPrivateFieldGet)(this, _Search_page, "f").contents || !(0, import_tslib48.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo)
      throw new InnertubeError("Response did not contain any contents.");
    const tab = (0, import_tslib48.__classPrivateFieldGet)(this, _Search_page, "f").contents.item().as(TabbedSearchResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find target tab.");
    const tab_content = (_a3 = tab.content) === null || _a3 === void 0 ? void 0 : _a3.as(SectionList_default);
    if (!tab_content)
      throw new InnertubeError("Target tab did not have any content.");
    ...
    if (is_filtered) {
      (0, import_tslib48.__classPrivateFieldSet)(this, _Search_continuation, (_c = this.contents.firstOfType(MusicShelf_default)) === null || _c === void 0 ? void 0 : _c.continuation, "f");
    }
  }
  getMore(shelf) {
    return (0, import_tslib48.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield shelf.endpoint.call((0, import_tslib48.__classPrivateFieldGet)(this, _Search_actions, "f"), { client: "YTMUSIC" });
      if (!response)
        throw new InnertubeError("Endpoint did not return any data");
      return new Search2(response, (0, import_tslib48.__classPrivateFieldGet)(this, _Search_actions, "f"), true);
    });
  }
  getContinuation() {
    return (0, import_tslib48.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib48.__classPrivateFieldGet)(this, _Search_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib48.__classPrivateFieldGet)(this, _Search_actions, "f").execute("/search", {
        continuation: (0, import_tslib48.__classPrivateFieldGet)(this, _Search_continuation, "f"),
        client: "YTMUSIC"
      });
      return new SearchContinuation((0, import_tslib48.__classPrivateFieldGet)(this, _Search_actions, "f"), response);
    });
  }
  applyFilter(target_filter) {
    var _a3, _b;
    return (0, import_tslib48.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!cloud_chip.endpoint)
        throw new InnertubeError("Selected filter does not have an endpoint.");
      const response = yield cloud_chip.endpoint.call((0, import_tslib48.__classPrivateFieldGet)(this, _Search_actions, "f"), { client: "YTMUSIC" });
      return new Search2(response, (0, import_tslib48.__classPrivateFieldGet)(this, _Search_actions, "f"), true);
    });
  }
  get filters() {
  ...
  get has_continuation() {
    return !!(0, import_tslib48.__classPrivateFieldGet)(this, _Search_continuation, "f");
  }
  get did_you_mean() {
    var _a3;
    return (_a3 = (0, import_tslib48.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(DidYouMean_default).first();
  }
  get showing_results_for() {
    var _a3;
    return (_a3 = (0, import_tslib48.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(ShowingResultsFor_default).first();
  }
  get message() {
    var _a3;
    return (_a3 = (0, import_tslib48.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(Message_default).first();
  }
  get songs() {
    var _a3;
    return (_a3 = this.contents) === null || _a3 === void 0 ? void 0 : _a3.filterType(MusicShelf_default).find((section) => section.title.toString() === "Songs");
  }
  get videos() {
    var _a3;
    return (_a3 = this.contents) === null || _a3 === void 0 ? void 0 : _a3.filterType(MusicShelf_default).find((section) => section.title.toString() === "Videos");
  }
  get albums() {
    var _a3;
    return (_a3 = this.contents) === null || _a3 === void 0 ? void 0 : _a3.filterType(MusicShelf_default).find((section) => section.title.toString() === "Albums");
  }
  get artists() {
    var _a3;
    return (_a3 = this.contents) === null || _a3 === void 0 ? void 0 : _a3.filterType(MusicShelf_default).find((section) => section.title.toString() === "Artists");
  }
  get playlists() {
    var _a3;
    return (_a3 = this.contents) === null || _a3 === void 0 ? void 0 : _a3.filterType(MusicShelf_default).find((section) => section.title.toString() === "Community playlists");
  }
  get results() {
    var _a3, _b;
    return (_b = (_a3 = this.contents) === null || _a3 === void 0 ? void 0 : _a3.firstOfType(MusicShelf_default)) === null || _b === void 0 ? void 0 : _b.contents;
  }
  get sections() {
    var _a3;
    return (_a3 = this.contents) === null || _a3 === void 0 ? void 0 : _a3.filterType(MusicShelf_default);
  }
  get page() {
    return (0, import_tslib48.__classPrivateFieldGet)(this, _Search_page, "f");
  }
};
...
var SearchContinuation = class {
  constructor(actions, response) {
    ...
    (0, import_tslib48.__classPrivateFieldSet)(this, _SearchContinuation_actions, actions, "f");
    (0, import_tslib48.__classPrivateFieldSet)(this, _SearchContinuation_page, parser_default.parseResponse(response.data), "f");
    this.header = (_a3 = (0, import_tslib48.__classPrivateFieldGet)(this, _SearchContinuation_page, "f").header) === null || _a3 === void 0 ? void 0 : _a3.item().as(MusicHeader_default);
    this.contents = (_b = (0, import_tslib48.__classPrivateFieldGet)(this, _SearchContinuation_page, "f").continuation_contents) === null || _b === void 0 ? void 0 : _b.as(MusicShelfContinuation);
  }
  getContinuation() {
    var _a3;
    return (0, import_tslib48.__awaiter)(this, void 0, void 0, function* () {
      if (!((_a3 = this.contents) === null || _a3 === void 0 ? void 0 : _a3.continuation))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib48.__classPrivateFieldGet)(this, _SearchContinuation_actions, "f").execute("/search", {
        continuation: this.contents.continuation,
        client: "YTMUSIC"
      });
      return new SearchContinuation((0, import_tslib48.__classPrivateFieldGet)(this, _SearchContinuation_actions, "f"), response);
    });
  }
  get has_continuation() {
    var _a3;
    return !!((_a3 = this.contents) === null || _a3 === void 0 ? void 0 : _a3.continuation);
  }
  get page() {
    return (0, import_tslib48.__classPrivateFieldGet)(this, _SearchContinuation_page, "f");
  }
};
...
var TrackInfo = class extends MediaInfo_default {
  constructor(data, actions, cpn) {
    ...
    super(data, actions, cpn);
    const [info, next] = this.page;
    if (!((_a3 = info.microformat) === null || _a3 === void 0 ? void 0 : _a3.is(MicroformatData_default)))
      throw new InnertubeError("Invalid microformat", info.microformat);
  ...
  getTab(title_or_page_type) {
    ...
    return (0, import_tslib49.__awaiter)(this, void 0, void 0, function* () {
      ...
      const target_tab = this.tabs.get({ title: title_or_page_type }) || this.tabs.matchCondition((tab) => {
        var _a4, _b2;
        return ((_b2 = (_a4 = tab.endpoint.payload.browseEndpointContextSupportedConfigs) === null || _a4 === void 0 ? void 0 : _a4.browseEndpointContextMusicConfig) === null || _b2 === void 0 ? void 0 : _b2.pageType) === title_or_page_type;
      }) || ((_a3 = this.tabs) === null || _a3 === void 0 ? void 0 : _a3[0]);
      if (!target_tab)
  ...
  getUpNext(automix = true) {
    ...
    return (0, import_tslib49.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!playlist_panel.playlist_id && automix) {
        ...
        const page = yield (_a3 = automix_preview_video.playlist_video) === null || _a3 === void 0 ? void 0 : _a3.endpoint.call(this.actions, {
...
var Channel3 = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    var _a3, _b;
    super(actions, data, already_parsed);
    this.header = (_a3 = this.page.header) === null || _a3 === void 0 ? void 0 : _a3.item().as(C4TabbedHeader_default);
  ...
  getContinuation() {
    ...
    return (0, import_tslib50.__awaiter)(this, void 0, void 0, function* () {
      const response = yield this.actions.execute("/browse", {
        continuation: (_a3 = this.contents) === null || _a3 === void 0 ? void 0 : _a3.continuation,
        client: "YTKIDS"
      });
...
var HomeFeed3 = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    var _a3, _b;
    super(actions, data, already_parsed);
    this.header = (_a3 = this.page.header) === null || _a3 === void 0 ? void 0 : _a3.item().as(KidsCategoriesHeader_default);
  ...
  selectCategoryTab(tab) {
    ...
    return (0, import_tslib51.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (typeof tab === "string") {
        target_tab = (_a3 = this.header) === null || _a3 === void 0 ? void 0 : _a3.category_tabs.find((t) => t.title.toString() === tab);
  ...
  get categories() {
    var _a3;
    return ((_a3 = this.header) === null || _a3 === void 0 ? void 0 : _a3.category_tabs.map((tab) => tab.title.toString())) || [];
  }
};
...
var VideoInfo2 = class extends MediaInfo_default {
  constructor(data, actions, cpn) {
    ...
    this.captions = info.captions;
    const two_col = (_a3 = next === null || next === void 0 ? void 0 : next.contents) === null || _a3 === void 0 ? void 0 : _a3.item().as(TwoColumnWatchNextResults_default);
    const results = two_col === null || two_col === void 0 ? void 0 : two_col.results;
    const secondary_results = two_col === null || two_col === void 0 ? void 0 : two_col.secondary_results;
    if (results && secondary_results) {
...
var Author = class {
  constructor(item, badges, thumbs, id) {
    var _a3, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12;
    _Author_nav_text.set(this, void 0);
    (0, import_tslib53.__classPrivateFieldSet)(this, _Author_nav_text, new Text(item), "f");
    this.id = id || ((_e = (_d = (_c = (_b = (_a3 = (0, import_tslib53.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _a3 === void 0 ? void 0 : _a3.runs) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.endpoint) === null || _d === void 0 ? void 0 : _d.payload) === null || _e === void 0 ? void 0 : _e.browseId) || ((_h = (_g = (_f = (0, import_tslib53.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _f === void 0 ? void 0 : _f.endpoint) === null || _g === void 0 ? void 0 : _g.payload) === null || _h === void 0 ? void 0 : _h.browseId) || "N/A";
    this.name = ((_j = (0, import_tslib53.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _j === void 0 ? void 0 : _j.text) || "N/A";
    this.thumbnails = thumbs ? Thumbnail.fromResponse(thumbs) : [];
    this.endpoint = ((_m = (_l = (_k = (0, import_tslib53.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _k === void 0 ? void 0 : _k.runs) === null || _l === void 0 ? void 0 : _l[0]) === null || _m === void 0 ? void 0 : _m.endpoint) || ((_o = (0, import_tslib53.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _o === void 0 ? void 0 : _o.endpoint);
    ...
    this.url = ((_w = (_v = (_u = (_t = (_s = (0, import_tslib53.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _s === void 0 ? void 0 : _s.runs) === null || _t === void 0 ? void 0 : _t[0]) === null || _u === void 0 ? void 0 : _u.endpoint) === null || _v === void 0 ? void 0 : _v.metadata) === null || _w === void 0 ? void 0 : _w.api_url) === "/browse" && `${URLS.YT_BASE}${((_1 = (_0 = (_z = (_y = (_x = (0, import_tslib53.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _x === void 0 ? void 0 : _x.runs) === null || _y === void 0 ? void 0 : _y[0]) === null || _z === void 0 ? void 0 : _z.endpoint) === null || _0 === void 0 ? void 0 : _0.payload) === null || _1 === void 0 ? void 0 : _1.canonicalBaseUrl) || `/u/${(_6 = (_5 = (_4 = (_3 = (_2 = (0, import_tslib53.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _2 === void 0 ? void 0 : _2.runs) === null || _3 === void 0 ? void 0 : _3[0]) === null || _4 === void 0 ? void 0 : _4.endpoint) === null || _5 === void 0 ? void 0 : _5.payload) === null || _6 === void 0 ? void 0 : _6.browseId}`}` || `${URLS.YT_BASE}${((_9 = (_8 = (_7 = (0, import_tslib53.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _7 === void 0 ? void 0 : _7.endpoint) === null || _8 === void 0 ? void 0 : _8.payload) === null || _9 === void 0 ? void 0 : _9.canonicalBaseUrl) || `/u/${(_12 = (_11 = (_10 = (0, import_tslib53.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _10 === void 0 ? void 0 : _10.endpoint) === null || _11 === void 0 ? void 0 : _11.payload) === null || _12 === void 0 ? void 0 : _12.browseId}`}`;
  }
  get best_thumbnail() {
    return this.thumbnails[0];
  }
...
var Platform = class {
  static load(platform) {
    (0, import_tslib54.__classPrivateFieldSet)(Platform, _a, platform, "f", _Platform_shim);
  }
  static get shim() {
    if (!(0, import_tslib54.__classPrivateFieldGet)(Platform, _a, "f", _Platform_shim)) {
      throw new Error("Platform is not loaded");
    }
    return (0, import_tslib54.__classPrivateFieldGet)(Platform, _a, "f", _Platform_shim);
  }
};
...
var CustomEvent = class extends Event {
  constructor(type, options) {
    ...
    (0, import_tslib55.__classPrivateFieldSet)(this, _CustomEvent_detail, (_a3 = options === null || options === void 0 ? void 0 : options.detail) !== null && _a3 !== void 0 ? _a3 : null, "f");
  }
  get detail() {
...
var Actions = class {
  constructor(session) {
    ...
    (0, import_tslib56.__classPrivateFieldSet)(this, _Actions_session, session, "f");
  }
  get session() {
    return (0, import_tslib56.__classPrivateFieldGet)(this, _Actions_session, "f");
  }
  stats(url, client, params) {
    return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _Actions_session, "f").http.fetch(s_url);
      return response;
    });
  }
    ...
    return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (args && !args.protobuf) {
        ...
        if (Reflect.has(data, "browseId")) {
          if ((0, import_tslib56.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_needsLogin).call(this, data.browseId) && !(0, import_tslib56.__classPrivateFieldGet)(this, _Actions_session, "f").logged_in)
      ...
      const response = yield (0, import_tslib56.__classPrivateFieldGet)(this, _Actions_session, "f").http.fetch(target_endpoint, {
        method: "POST",
      ...
      if (args === null || args === void 0 ? void 0 : args.parse) {
        ...
        if ((0, import_tslib56.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_isBrowse).call(this, parsed_response) && ((_b = (_a3 = parsed_response.on_response_received_actions) === null || _a3 === void 0 ? void 0 : _a3.first()) === null || _b === void 0 ? void 0 : _b.type) === "navigateAction") {
      ...
      return (0, import_tslib56.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_wrap).call(this, response);
    });
  }
};
...
var Player = class {
  constructor(signature_timestamp, sig_sc, nsig_sc, player_id) {
    ...
    _Player_nsig_cache.set(this, void 0);
    _Player_sig_sc.set(this, void 0);
    _Player_sig_sc_timestamp.set(this, void 0);
    _Player_player_id.set(this, void 0);
    (0, import_tslib57.__classPrivateFieldSet)(this, _Player_nsig_sc, nsig_sc, "f");
    (0, import_tslib57.__classPrivateFieldSet)(this, _Player_sig_sc, sig_sc, "f");
    (0, import_tslib57.__classPrivateFieldSet)(this, _Player_sig_sc_timestamp, signature_timestamp, "f");
    (0, import_tslib57.__classPrivateFieldSet)(this, _Player_player_id, player_id, "f");
    (0, import_tslib57.__classPrivateFieldSet)(this, _Player_nsig_cache, /* @__PURE__ */ new Map(), "f");
  }
  ...
  decipher(url, signature_cipher, cipher, this_response_nsig_cache) {
    ...
    if (signature_cipher || cipher) {
      const signature = Platform.shim.eval((0, import_tslib57.__classPrivateFieldGet)(this, _Player_sig_sc, "f"), {
        sig: args.get("s")
      });
    ...
    if (n) {
      ...
      if (this_response_nsig_cache && this_response_nsig_cache.has(n)) {
        ...
        nsig = Platform.shim.eval((0, import_tslib57.__classPrivateFieldGet)(this, _Player_nsig_sc, "f"), {
          nsig: n
        });
  ...
  cache(cache) {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      ...
      const sig_buf = encoder.encode((0, import_tslib57.__classPrivateFieldGet)(this, _Player_sig_sc, "f"));
      const nsig_buf = encoder.encode((0, import_tslib57.__classPrivateFieldGet)(this, _Player_nsig_sc, "f"));
      const buffer = new ArrayBuffer(12 + sig_buf.byteLength + nsig_buf.byteLength);
      const view = new DataView(buffer);
      view.setUint32(0, Player.LIBRARY_VERSION, true);
      view.setUint32(4, (0, import_tslib57.__classPrivateFieldGet)(this, _Player_sig_sc_timestamp, "f"), true);
      ...
      yield cache.set((0, import_tslib57.__classPrivateFieldGet)(this, _Player_player_id, "f"), new Uint8Array(buffer));
    });
  }
  ...
  static extractSigSourceCode(data) {
    ...
    const obj_name = (_c = (_b = (_a3 = calls === null || calls === void 0 ? void 0 : calls.split(/\.|\[/)) === null || _a3 === void 0 ? void 0 : _a3[0]) === null || _b === void 0 ? void 0 : _b.replace(";", "")) === null || _c === void 0 ? void 0 : _c.trim();
  ...
  get url() {
    return new URL(`/s/player/${(0, import_tslib57.__classPrivateFieldGet)(this, _Player_player_id, "f")}/player_ias.vflset/en_US/base.js`, URLS.YT_BASE).toString();
  }
  get sts() {
    return (0, import_tslib57.__classPrivateFieldGet)(this, _Player_sig_sc_timestamp, "f");
  }
  get nsig_sc() {
    return (0, import_tslib57.__classPrivateFieldGet)(this, _Player_nsig_sc, "f");
  }
  get sig_sc() {
    return (0, import_tslib57.__classPrivateFieldGet)(this, _Player_sig_sc, "f");
  }
...
_Player_nsig_sc = /* @__PURE__ */ new WeakMap(), _Player_nsig_cache = /* @__PURE__ */ new WeakMap(), _Player_sig_sc = /* @__PURE__ */ new WeakMap(), _Player_sig_sc_timestamp = /* @__PURE__ */ new WeakMap(), _Player_player_id = /* @__PURE__ */ new WeakMap();
...
var OAuth = class {
  constructor(session) {
    ...
    (0, import_tslib58.__classPrivateFieldSet)(this, _OAuth_session, session, "f");
  }
  init(credentials) {
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      (0, import_tslib58.__classPrivateFieldSet)(this, _OAuth_credentials, credentials, "f");
      if (this.validateCredentials()) {
        if (!this.has_access_token_expired)
          (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth", {
            credentials: (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f"),
            status: "SUCCESS"
          });
      } else if (!(yield (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_loadCachedCredentials).call(this))) {
        yield (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getUserCode).call(this);
      }
    });
  }
  cacheCredentials() {
    ...
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      const encoder = new TextEncoder();
      const data = encoder.encode(JSON.stringify((0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f")));
      yield (_a3 = (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").cache) === null || _a3 === void 0 ? void 0 : _a3.set("youtubei_oauth_credentials", data.buffer);
    });
  }
  removeCache() {
    var _a3;
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      yield (_a3 = (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").cache) === null || _a3 === void 0 ? void 0 : _a3.remove("youtubei_oauth_credentials");
    });
  }
  refreshIfRequired() {
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      if (this.has_access_token_expired) {
        yield (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_refreshAccessToken).call(this);
      }
    });
  }
  revokeCredentials() {
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f"))
        return;
      yield this.removeCache();
      return (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL(`/o/oauth2/revoke?token=${encodeURIComponent((0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f").access_token)}`, URLS.YT_BASE), {
        method: "post"
      });
    });
  }
  get credentials() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f");
  }
  get has_access_token_expired() {
    const timestamp = (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f") ? new Date((0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f").expires).getTime() : -Infinity;
    return new Date().getTime() > timestamp;
  }
  validateCredentials() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f") && Reflect.has((0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f"), "access_token") && Reflect.has((0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f"), "refresh_token") && Reflect.has((0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f"), "expires") || false;
  }
};
__name(OAuth, "OAuth");
_OAuth_identity = /* @__PURE__ */ new WeakMap(), _OAuth_session = /* @__PURE__ */ new WeakMap(), _OAuth_credentials = /* @__PURE__ */ new WeakMap(), _OAuth_polling_interval = /* @__PURE__ */ new WeakMap(), _OAuth_instances = /* @__PURE__ */ new WeakSet(), _OAuth_loadCachedCredentials = /* @__PURE__ */ __name(function _OAuth_loadCachedCredentials2() {
  var _a3;
  return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
    const data = yield (_a3 = (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").cache) === null || _a3 === void 0 ? void 0 : _a3.get("youtubei_oauth_credentials");
    if (!data)
      return false;
    const decoder = new TextDecoder();
    const credentials = JSON.parse(decoder.decode(data));
    (0, import_tslib58.__classPrivateFieldSet)(this, _OAuth_credentials, {
  ...
  return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
    (0, import_tslib58.__classPrivateFieldSet)(this, _OAuth_identity, yield (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getClientIdentity).call(this), "f");
    const data = {
      client_id: (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_identity, "f").client_id,
      scope: OAUTH.SCOPE,
      device_id: Platform.shim.uuidv4(),
      device_model: OAUTH.MODEL_NAME
    };
    const response = yield (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/device/code", URLS.YT_BASE), {
    ...
    (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-pending", response_data);
    (0, import_tslib58.__classPrivateFieldSet)(this, _OAuth_polling_interval, response_data.interval, "f");
    (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_startPolling).call(this, response_data.device_code);
  });
}, "_OAuth_getUserCode"), _OAuth_startPolling = /* @__PURE__ */ __name(function _OAuth_startPolling2(device_code) {
  const poller = setInterval(() => (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
    const data = Object.assign(Object.assign({}, (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_identity, "f")), { code: device_code, grant_type: OAUTH.GRANT_TYPE });
    try {
      const response = yield (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/token", URLS.YT_BASE), {
        body: JSON.stringify(data),
        method: "POST",
        headers: {
          "Content-Type": "application/json"
      ...
      if (response_data.error) {
        switch (response_data.error) {
          case "access_denied":
            (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-error", new OAuthError("Access was denied.", { status: "ACCESS_DENIED" }));
            break;
          case "expired_token":
            (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-error", new OAuthError("The device code has expired, restarting auth flow.", { status: "DEVICE_CODE_EXPIRED" }));
            clearInterval(poller);
            (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getUserCode).call(this);
            break;
          default:
            break;
        }
      ...
      clearInterval(poller);
      return (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("auth-error", new OAuthError("Could not obtain user code.", { status: "FAILED", error: err }));
    }
  }), (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_polling_interval, "f") * 1e3);
}, "_OAuth_startPolling"), _OAuth_refreshAccessToken = /* @__PURE__ */ __name(function _OAuth_refreshAccessToken2() {
  return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
    if (!(0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f"))
      return;
    (0, import_tslib58.__classPrivateFieldSet)(this, _OAuth_identity, yield (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_instances, "m", _OAuth_getClientIdentity).call(this), "f");
    const data = Object.assign(Object.assign({}, (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_identity, "f")), { refresh_token: (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f").refresh_token, grant_type: "refresh_token" });
    const response = yield (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/token", URLS.YT_BASE), {
      body: JSON.stringify(data),
      method: "POST",
      headers: {
    ...
    (0, import_tslib58.__classPrivateFieldSet)(this, _OAuth_credentials, {
      access_token: response_data.access_token,
      refresh_token: response_data.refresh_token || (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f").refresh_token,
      expires: expiration_date
    }, "f");
    (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").emit("update-credentials", {
      credentials: (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f"),
      status: "SUCCESS"
    });
  });
  ...
  var _a3;
  return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
    const response = yield (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/tv", URLS.YT_BASE), { headers: OAUTH.HEADERS });
    const response_data = yield response.text();
    const url_body = (_a3 = OAUTH.REGEX.AUTH_SCRIPT.exec(response_data)) === null || _a3 === void 0 ? void 0 : _a3[1];
    if (!url_body)
      throw new OAuthError("Could not obtain script url.", { status: "FAILED" });
    const script = yield (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch(url_body, { baseURL: URLS.YT_BASE });
...
var Session = class extends EventEmitterLike_default {
  constructor(context, api_key, api_version, account_index, player, cookie, fetch, cache) {
    ...
    (0, import_tslib59.__classPrivateFieldSet)(this, _Session_context, context, "f");
    (0, import_tslib59.__classPrivateFieldSet)(this, _Session_account_index, account_index, "f");
    (0, import_tslib59.__classPrivateFieldSet)(this, _Session_key, api_key, "f");
    (0, import_tslib59.__classPrivateFieldSet)(this, _Session_api_version, api_version, "f");
    (0, import_tslib59.__classPrivateFieldSet)(this, _Session_player, player, "f");
  ...
  static getSessionData(lang = "", location = "", account_index = 0, visitor_data = "", enable_safety_mode = false, generate_session_locally = false, device_category = "desktop", client_name = ClientType.WEB, tz = Intl.DateTimeFormat().resolvedOptions().timeZone, fetch = Platform.shim.fetch, on_behalf_of_user) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (generate_session_locally) {
        session_data = (0, import_tslib59.__classPrivateFieldGet)(this, _a2, "m", _Session_generateSessionData).call(this, session_args);
      } else {
        try {
          session_data = yield (0, import_tslib59.__classPrivateFieldGet)(this, _a2, "m", _Session_retrieveSessionData).call(this, session_args, fetch);
        } catch (err) {
          session_data = (0, import_tslib59.__classPrivateFieldGet)(this, _a2, "m", _Session_generateSessionData).call(this, session_args);
        }
      }
  ...
  get key() {
    return (0, import_tslib59.__classPrivateFieldGet)(this, _Session_key, "f");
  }
  get api_version() {
    return (0, import_tslib59.__classPrivateFieldGet)(this, _Session_api_version, "f");
  }
  get client_version() {
    return (0, import_tslib59.__classPrivateFieldGet)(this, _Session_context, "f").client.clientVersion;
  }
  get client_name() {
    return (0, import_tslib59.__classPrivateFieldGet)(this, _Session_context, "f").client.clientName;
  }
  get account_index() {
    return (0, import_tslib59.__classPrivateFieldGet)(this, _Session_account_index, "f");
  }
  get context() {
    return (0, import_tslib59.__classPrivateFieldGet)(this, _Session_context, "f");
  }
  get player() {
    return (0, import_tslib59.__classPrivateFieldGet)(this, _Session_player, "f");
  }
  get lang() {
    return (0, import_tslib59.__classPrivateFieldGet)(this, _Session_context, "f").client.hl;
  }
};
...
var PATH25 = "/kids/get_kids_blocklist_picker";
function build23(options) {
...
var Kids = class {
  ...
  search(query) {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Search_default3((0, import_tslib60.__classPrivateFieldGet)(this, _Kids_session, "f").actions, response);
    });
  }
  getInfo(video_id) {
    var _a3;
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      const player_payload = PlayerEndpoint_exports.build({
        sts: (_a3 = (0, import_tslib60.__classPrivateFieldGet)(this, _Kids_session, "f").player) === null || _a3 === void 0 ? void 0 : _a3.sts,
        client: "YTKIDS",
        video_id
      });
      ...
      return new VideoInfo_default2(response, (0, import_tslib60.__classPrivateFieldGet)(this, _Kids_session, "f").actions, cpn);
    });
  }
  getChannel(channel_id) {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Channel_default2((0, import_tslib60.__classPrivateFieldGet)(this, _Kids_session, "f").actions, response);
    });
  }
  getHomeFeed() {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new HomeFeed_default2((0, import_tslib60.__classPrivateFieldGet)(this, _Kids_session, "f").actions, response);
    });
  }
  blockChannel(channel_id) {
    ...
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      const kid_picker = parser_default.parseResponse(popup_fragment);
      const kids = (_a3 = kid_picker.contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(KidsBlocklistPickerItem_default);
      if (!kids)
...
var Music = class {
  ...
  search(query, filters = {}) {
    return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Search_default2(response, (0, import_tslib61.__classPrivateFieldGet)(this, _Music_actions, "f"), Reflect.has(filters, "type") && filters.type !== "all");
    });
  }
  getHomeFeed() {
    return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
  ...
  getUpNext(video_id, automix = true) {
    ...
    return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
      ...
      const tabs = (_a3 = response.contents_memo) === null || _a3 === void 0 ? void 0 : _a3.getType(Tab_default);
  ...
  getRelated(video_id) {
    ...
    return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
      ...
      const tab = tabs === null || tabs === void 0 ? void 0 : tabs.matchCondition((tab2) => {
        var _a4, _b;
        return ((_b = (_a4 = tab2.endpoint.payload.browseEndpointContextSupportedConfigs) === null || _a4 === void 0 ? void 0 : _a4.browseEndpointContextMusicConfig) === null || _b === void 0 ? void 0 : _b.pageType) === "MUSIC_PAGE_TYPE_TRACK_RELATED";
      });
      if (!tab)
        throw new InnertubeError("Could not find target tab.");
  ...
  getLyrics(video_id) {
    ...
    return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
      ...
      const tab = tabs === null || tabs === void 0 ? void 0 : tabs.matchCondition((tab2) => {
        var _a4, _b;
        return ((_b = (_a4 = tab2.endpoint.payload.browseEndpointContextSupportedConfigs) === null || _a4 === void 0 ? void 0 : _a4.browseEndpointContextMusicConfig) === null || _b === void 0 ? void 0 : _b.pageType) === "MUSIC_PAGE_TYPE_TRACK_LYRICS";
      });
      if (!tab)
        throw new InnertubeError("Could not find target tab.");
      const page = yield tab.endpoint.call((0, import_tslib61.__classPrivateFieldGet)(this, _Music_actions, "f"), { client: "YTMUSIC", parse: true });
...
_Music_session = /* @__PURE__ */ new WeakMap(), _Music_actions = /* @__PURE__ */ new WeakMap(), _Music_instances = /* @__PURE__ */ new WeakSet(), _Music_fetchInfoFromVideoId = /* @__PURE__ */ __name(function _Music_fetchInfoFromVideoId2(video_id) {
  ...
  return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
    const player_payload = PlayerEndpoint_exports.build({
      video_id,
      sts: (_a3 = (0, import_tslib61.__classPrivateFieldGet)(this, _Music_session, "f").player) === null || _a3 === void 0 ? void 0 : _a3.sts,
      client: "YTMUSIC"
    });
    const next_payload = NextEndpoint_exports.build({
      video_id,
    ...
    const player_response = list_item.endpoint.call((0, import_tslib61.__classPrivateFieldGet)(this, _Music_actions, "f"), {
      ...
      playbackContext: {
        contentPlaybackContext: Object.assign({
          signatureTimestamp: (_a3 = (0, import_tslib61.__classPrivateFieldGet)(this, _Music_session, "f").player) === null || _a3 === void 0 ? void 0 : _a3.sts
        })
      }
    });
  ...
  getAnalytics() {
    ...
    return (0, import_tslib63.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib63.__classPrivateFieldGet)(this, _AccountManager_actions, "f").execute(BrowseEndpoint_exports.PATH, BrowseEndpoint_exports.build({
        ...
        params: encodeChannelAnalyticsParams((_a3 = info.footers) === null || _a3 === void 0 ? void 0 : _a3.endpoint.payload.browseId),
        client: "ANDROID"
      }));
...
var Innertube = class {
    ...
    return (0, import_tslib66.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (target instanceof NavigationEndpoint_default) {
        next_payload = NextEndpoint_exports.build({
          video_id: (_a3 = target.payload) === null || _a3 === void 0 ? void 0 : _a3.videoId,
  ...
  getBasicInfo(video_id, client) {
    ...
    return (0, import_tslib66.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield this.actions.execute(PlayerEndpoint_exports.PATH, PlayerEndpoint_exports.build({
        video_id,
        client,
        sts: (_a3 = (0, import_tslib66.__classPrivateFieldGet)(this, _Innertube_session, "f").player) === null || _a3 === void 0 ? void 0 : _a3.sts
      }));
      const cpn = generateRandomString(16);
      return new VideoInfo_default([response], this.actions, cpn);
    });
  ...
  getUnseenNotificationsCount() {
    ...
    return (0, import_tslib66.__awaiter)(this, void 0, void 0, function* () {
      ...
      return ((_a3 = response.data) === null || _a3 === void 0 ? void 0 : _a3.unseenCount) || ((_d = (_c = (_b = response.data) === null || _b === void 0 ? void 0 : _b.actions) === null || _c === void 0 ? void 0 : _c[0].updateNotificationsUnseenCountAction) === null || _d === void 0 ? void 0 : _d.unseenCount) || 0;
    });
  }
  getPlaylist(id) {
    return (0, import_tslib66.__awaiter)(this, void 0, void 0, function* () {
...
var { homepage, version, bugs } = { "homepage": "https://github.com/LuanRT/YouTube.js#readme", "version": "7.0.0", "bugs": { "url": "https://github.com/LuanRT/YouTube.js/issues" } };
