...
function getFormatGroupings(formats) {
    ...
    for (const format of formats) {
        ...
        const just_codec = (_a = getStringBetweenStrings(format.mime_type, 'codecs="', '"')) === null || _a === void 0 ? void 0 : _a.split('.')[0];
...
function getAudioSet(formats, url_transformer, actions, player, cpn) {
    ...
    const set = {
        ...
        language: (_a = first_format.language) !== null && _a !== void 0 ? _a : undefined,
...
function getColorInfo(format) {
    ...
    const primaries = (color_info === null || color_info === void 0 ? void 0 : color_info.primaries) ? COLOR_PRIMARIES[color_info.primaries] : undefined;
    const transfer_characteristics = (color_info === null || color_info === void 0 ? void 0 : color_info.transfer_characteristics) ? COLOR_TRANSFER_CHARACTERISTICS[color_info.transfer_characteristics] : undefined;
    const matrix_coefficients = (color_info === null || color_info === void 0 ? void 0 : color_info.matrix_coefficients) ? COLOR_MATRIX_COEFFICIENTS[color_info.matrix_coefficients] : undefined;
...
function getStoryboardInfo(storyboards) {
    ...
    for (const storyboard of storyboards.boards) {
        ...
        (_a = mime_info.get(mime_type)) === null || _a === void 0 ? void 0 : _a.push(storyboard);
    }
    return mime_info;
}
...
export function getStreamingInfo(streaming_data, url_transformer = (url) => url, format_filter, cpn, player, actions, storyboards) {
    if (!streaming_data)
...
//# sourceMappingURL=StreamingInfo.js.map