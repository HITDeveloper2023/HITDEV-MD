var _Player_nsig_sc, _Player_nsig_cache, _Player_sig_sc, _Player_sig_sc_timestamp, _Player_player_id;
...
class Player {
    constructor(signature_timestamp, sig_sc, nsig_sc, player_id) {
        ...
        __classPrivateFieldSet(this, _Player_nsig_cache, new Map(), "f");
    }
...
_Player_nsig_sc = new WeakMap(), _Player_nsig_cache = new WeakMap(), _Player_sig_sc = new WeakMap(), _Player_sig_sc_timestamp = new WeakMap(), _Player_player_id = new WeakMap();
