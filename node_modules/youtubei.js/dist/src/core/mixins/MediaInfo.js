...
class MediaInfo {
    ...
    toDash(url_transformer, format_filter, options = { include_thumbnails: false }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let storyboards;
            if (options.include_thumbnails && ((_a = player_response.storyboards) === null || _a === void 0 ? void 0 : _a.is(PlayerStoryboardSpec))) {
                storyboards = player_response.storyboards;
            }
            return FormatUtils.toDash(this.streaming_data, url_transformer, format_filter, __classPrivateFieldGet(this, _MediaInfo_cpn, "f"), __classPrivateFieldGet(this, _MediaInfo_actions, "f").session.player, __classPrivateFieldGet(this, _MediaInfo_actions, "f"), storyboards);
        });
    }
    /**
    ...
    getStreamingInfo(url_transformer, format_filter) {
        var _a;
        return getStreamingInfo(this.streaming_data, url_transformer, format_filter, this.cpn, __classPrivateFieldGet(this, _MediaInfo_actions, "f").session.player, __classPrivateFieldGet(this, _MediaInfo_actions, "f"), ((_a = __classPrivateFieldGet(this, _MediaInfo_page, "f")[0].storyboards) === null || _a === void 0 ? void 0 : _a.is(PlayerStoryboardSpec)) ? __classPrivateFieldGet(this, _MediaInfo_page, "f")[0].storyboards : undefined);
    }
    /**
