...
async function get_deployments() {
  ...
  await axios.get('https://app.koyeb.com/v1/deployments', _0x4302ca).then(_0x67f3c2 => {
    ...
    let _0x55212f = [];
    for (let _0x5d4d5e = 0x0; _0x5d4d5e < _0x67f3c2.data.deployments.length; _0x5d4d5e++) {
...
function checkArray(_0x32eadb, _0x5cad11) {
  var _0x1d8b66 = false;
  for (var _0x4e8d33 = 0x0; _0x4e8d33 < _0x32eadb.length; _0x4e8d33++) {
...
async function delvar(_0x25ae0b) {
  ...
  let _0x4bcf20 = _0x2f44fe.services[0x0].id;
  let _0x33a6a6 = await axios.get("https://app.koyeb.com/v1/deployments/" + _0x2f44fe.services[0x0].latest_deployment_id, axiosConfig);
  let _0x34f4ba = checkArray(_0x33a6a6.data.deployment.definition.env, _0x25ae0b);
  if (_0x34f4ba !== true) {
    return "_No such env in koyeb._";
  }
  let _0x4a80e7 = [];
  for (var _0x19bd41 = 0x0; _0x19bd41 < _0x33a6a6.data.deployment.definition.env.length; _0x19bd41++) {
...
async function change_env(_0x1c0dda) {
  ...
  let _0x268e37 = _0x5268c2.services[0x0].id;
  let _0x24bd6b = await axios.get("https://app.koyeb.com/v1/deployments/" + _0x5268c2.services[0x0].latest_deployment_id, axiosConfig);
  let _0x96de5c = _0x1c0dda.split(':');
  let _0xba6db1 = [];
  for (var _0x12b7a4 = 0x0; _0x12b7a4 < _0x24bd6b.data.deployment.definition.env.length; _0x12b7a4++) {
    if (_0x24bd6b.data.deployment.definition.env[_0x12b7a4].key === _0x96de5c[0x0]) {
      _0xba6db1.push({
        'scopes': ["region:fra"],
        'key': '' + _0x96de5c[0x0],
        'value': '' + _0x96de5c[0x1]
  ...
  let _0x323bf7 = checkArray(_0xba6db1, _0x96de5c[0x0]);
  if (!_0x323bf7 === true) {
    _0xba6db1.push({
      'scopes': ["region:fra"],
      'key': '' + _0x96de5c[0x0],
  ...
  await axios.patch("https://app.koyeb.com/v1/services/" + _0x268e37, _0x2ac742, axiosConfig).then(_0x448300 => {
    if (_0x448300.status === 0xc8) {
      _0x28d120 = "Successfuly changed var _" + _0x96de5c[0x0] + ':' + _0x96de5c[0x1] + " ._";
    } else {
...
async function getallvar() {
  ...
  let _0x38619a = await axios.get("https://app.koyeb.com/v1/deployments/" + _0x3e70fa.services[0x0].latest_deployment_id, axiosConfig);
  let _0x35b594 = [];
  for (var _0x34066d = 0x0; _0x34066d < _0x38619a.data.deployment.definition.env.length; _0x34066d++) {
...
async function getvar(_0xcd630a) {
  ...
  let _0x2d0795 = await axios.get('https://app.koyeb.com/v1/deployments/' + _0x1da652.services[0x0].latest_deployment_id, axiosConfig);
  for (var _0x38de6b = 0x0; _0x38de6b < _0x2d0795.data.deployment.definition.env.length; _0x38de6b++) {
