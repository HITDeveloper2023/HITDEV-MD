...
if (fs.existsSync("./Themes/" + Config.LANG + ".json")) {
  ...
  var json = JSON.parse(fs.readFileSync('./Themes/HITDEV.json'));
}
...
function tlang(_0x241740 = false) {
  let _0x4e9dfc = json.STRINGS.global;
  if (_0x241740) {
...
function botpic() {
  return new Promise((_0x2b19e2, _0x596d7c) => {
    let _0x169afc = json.STRINGS.global;
...
async function sync() {
  ...
  _0x3f267e.all.map(_0x4602cd => {
    _0x3af3b6 += "● [" + _0x4602cd.date.substring(0x0, 0xa) + "]: " + _0x4602cd.message + "\n- By:" + _0x4602cd.author_name + "\n";
  });
  return _0x3af3b6;
}
...
function adultvid() {
  return new Promise((_0x75660e, _0x481c10) => {
    axios.get("https://tikporntok.com/?random=1").then(_0x2aa3c0 => {
      ...
      const _0x10ea21 = {
        "title": _0x5a9f62("article > h1").text(),
        "source": _0x5a9f62("article > div.video-wrapper.vxplayer").attr("data-post") || "Web Not Response",
        "thumb": _0x5a9f62("article > div.video-wrapper.vxplayer > div.vx_el").attr("data-poster") || 'https://4.bp.blogspot.com/-hyMqjmQQq4o/W6al-Rk4IpI/AAAAAAAADJ4/m-lVBA_GC9Q5d4BIQg8ZO3fYmQQC3LqSACLcBGAs/s1600/404_not_found.png',
        desc: _0x5a9f62("article > div.intro").text(),
        "upload": _0x5a9f62("article > div.single-pre-meta.ws.clearfix > time").text(),
        "like": _0x5a9f62("article > div.single-pre-meta.ws.clearfix > div > span:nth-child(1) > span").text(),
        dislike: _0x5a9f62("article > div.single-pre-meta.ws.clearfix > div > span:nth-child(2) > span").text(),
        "favorite": _0x5a9f62("article > div.single-pre-meta.ws.clearfix > div > span:nth-child(3) > span").text(),
        "views": _0x5a9f62("article > div.single-pre-meta.ws.clearfix > div > span:nth-child(4) > span").text(),
        "tags": _0x5a9f62("article > div.post-tags").text(),
        "video": _0x5a9f62("article > div.video-wrapper.vxplayer > div.vx_el").attr('src') || _0x5a9f62("article > div.video-wrapper.vxplayer > div.vx_el").attr('data-src') || "https://4.bp.blogspot.com/-hyMqjmQQq4o/W6al-Rk4IpI/AAAAAAAADJ4/m-lVBA_GC9Q5d4BIQg8ZO3fYmQQC3LqSACLcBGAs/s1600/404_not_found.png"
      };
      _0x75660e(_0x10ea21);
    });
  });
...
function hentai() {
  return new Promise((_0x24384b, _0x48739c) => {
    const _0x6f78c6 = Math.floor(Math.random() * 0x481);
