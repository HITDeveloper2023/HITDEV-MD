...
let yt = {
  "getInfo": async (_0x3c2895, _0x49e43c = {}) => {
    try {
      ...
      let _0x1cb8d4 = [];
      for (let _0x21836a = 0x0; _0x21836a < _0x538e69.streaming_data.formats.length; _0x21836a++) {
      ...
      let _0x3296e8 = {
        ...
        'thumbnail': _0x538e69.basic_info.thumbnail[0x0].url,
      ...
      console.log("./lib/hitdev/yt.getInfo()\n", _0x39b819.message);
      return {
        'status': false
      };
    }
  },
  download: async (_0x1ea0cb, _0x5c75ae = {
    'type': "video",
    'quality': 'best',
    'format': "mp4"
  }) => {
    try {
      ...
      let _0x3991fc = "./temp/HITDEV-MD " + _0x1ea0cb + '.' + _0x35b4d2;
      ...
      console.log("./lib/hitdev/yt.dowanload()\n", _0x26244e.message);
      return false;
    }
  }
};
async function sendAnimeReaction(_0x5c448a, _0x46face = "punch", _0x50961f = '', _0x426154 = '') {
  try {
    ...
    let _0x5b40dd = _0x5c448a.mentionedJid ? _0x5c448a.mentionedJid[0x0] : _0x5c448a.quoted ? _0x5c448a.quoted.sender : false;
    let _0x21964f = await GIFBufferToVideoBuffer(_0x43f098);
    let _0x51f2b9 = _0x5b40dd ? "*@" + _0x5c448a.sender.split('@')[0x0] + " " + _0x50961f + " @" + _0x5b40dd.split('@')[0x0] + '*' : "*@" + _0x5c448a.sender.split('@')[0x0] + " " + _0x426154 + '*';
    return _0x5b40dd ? await _0x5c448a.bot.sendMessage(_0x5c448a.chat, {
      'video': _0x21964f,
      'gifPlayback': true,
    ...
    }) : await _0x5c448a.bot.sendMessage(_0x5c448a.chat, {
      'video': _0x21964f,
      'gifPlayback': true,
    ...
    return await _0x5c448a.error(_0x1b7c90 + "\nERROR AT : /lib/Hitdev.js/sendAnimeReaction()\n\ncommand: " + _0x46face);
  }
}
async function sendGImages(_0x4a189d, _0x4eee7c, _0x205b7c = caption, _0x1caf0d = '') {
  try {
    ...
    return console.log("./lib/Hitdev.js/sendGImages()\n", _0x36d8e7);
  }
}
async function AudioToBlackVideo(_0x2bac4d, _0x568b06) {
  try {
    ...
    const _0x32b4ee = "ffmpeg -f lavfi -i color=c=black:s=1280x720:d=" + _0x4ffac3 + " -vf \"format=yuv420p\" " + "./temp/blackScreen.mp4";
    await exec(_0x32b4ee);
    const _0x332e3c = "ffmpeg -i ./temp/blackScreen.mp4 -i " + _0x2bac4d + " -c:v copy -c:a aac -map 0:v:0 -map 1:a:0 " + _0x568b06;
  ...
  try {
    ...
    if (_0x4280e5.toLowerCase() === "install") {
      ...
      for (let _0x347ccf of isUrl(_0x76cd91)) {
        ...
        let _0x4cfa49 = _0x79382e[0x1].split(" ")[0x0] || Math.random().toString(0x24).slice(-0x5);
      ...
      if (_0x4280e5.toLowerCase() === "remove") {
        if (_0x76cd91 === "all") {
          let _0x15e8b6 = '';
  ...
  try {
    if (_0x42b490 === 'pp' || _0x42b490 === "gpp") {
      ...
      async function _0x2e4ae1(_0x2fed3e) {
        ...
        const _0xa030b1 = _0x451493.crop(0x0, 0x0, _0x160ea5, _0x130adc);
        return {
          'img': await _0xa030b1.scaleToFit(0x144, 0x2d0).getBufferAsync(Jimp.MIME_JPEG),
...
async function forwardMessage(_0x56dbe1, _0x5eaf75, _0x561de2 = '') {
      ...
      if (_0x48c6f4 === "imageMessage") {
        ...
        if (_0x48c6f4 === 'audioMessage') {
          ...
          if (_0x48c6f4 === 'documentMessage') {
            ...
            if (_0x48c6f4 === 'conversation' || _0x48c6f4 === 'extendedTextMessage') {
  ...
  if (_0x3af25e) {
    try {
      await Hitdev.bot.relayMessage(_0x56dbe1, _0x3af25e, {
...
async function getRandom(_0xf0461b = ".jpg", _0x48110d = 0x2710) {
...
async function randomeFunfacts(_0x1be35e) {
  try {
    ...
    msg.error(_0x1147af);
    console.log("./lib/Hitdev.js/randomeFunfacts()\n", _0x1147af);
  }
}
async function audioEditor(_0x1ef339, _0x567a0f = "bass", _0x730356 = '') {
  ...
  try {
    ...
    let _0x58830b = 'temp/' + (_0x1ef339.sender.slice(0x6) + _0x567a0f) + ".mp3";
    exec("ffmpeg -i " + _0x25e2bd + " " + _0x3497f6 + " " + _0x58830b, async (_0x43e1ec, _0x22acc9, _0x3cea68) => {
      ...
      if (_0x43e1ec) {
        ...
        return _0x1ef339.bot.sendMessage(_0x1ef339.chat, {
          'audio': _0x11bfca,
          'mimetype': "audio/mpeg",
          'ptt': !!/ptt|voice/.test(_0x1ef339.test || ''),
    ...
    return console.log("./lib/Hitdev.js/audioEditor()\n", _0x48606a);
  }
}
async function send(_0x38fbe8, _0x3e1faf, _0x38564b = {
  ...
  try {
    ...
    console.log("./lib/Hitdev.js/send()\n", _0x164757);
  }
}
...
let note = {
  ...
  "delnote": async (_0x32bcc1, _0x2c426a) => {
    try {
  ...
  "delallnote": async (_0x3ac5ea, _0x5f348f = '') => {
    try {
      await bot_.updateOne({
  ...
  "allnotes": async (_0x32ce57, _0x11e475 = '') => {
    try {
...
async function sendWelcome(_0x50ffa3, _0x3417a5 = '', _0x27d774 = '', _0x3fa550 = '', _0x7317df = "msg", _0x495ef9 = false) {
  try {
    ...
    if (_0x3417a5) {
      ...
      let _0x23df3f = _0x3417a5.replace(/@user|&user/gi, '@' + _0x50ffa3.senderNum).replace(/@name|&name/gi, _0x50ffa3.senderName || '_').replace(/@gname|&gname/gi, '').replace(/@desc|&desc/gi, '').replace(/@count|&count/gi, '1').replace(/@pp|&pp|@gpp|&gpp|@context|&context/g, '').replace(/@time|&time/gi, _0x50ffa3.time).replace(/@date|&date/gi, _0x50ffa3.date).replace(/@bot|&bot/gi, '' + Config.botname).replace(/@owner|&owner/gi, '' + Config.ownername).replace(/@caption|&caption/gi, caption).replace(/@gurl|@website|&gurl|&website|@link|&link/gi, gurl).replace(/@myyt|&myyt/gi, 'www.youtube.com/HITDeveloper2023').replace(/@telegram|&telegram/gi, global.telegram || 'https://t.me/hitdev_md0').replace(/@channel|@yt_channel|&channel|&yt_channel/gi, global.YT_PRODUCT || global.YT_CHANNEL || global.YT_PROMOTE || global.YT || "www.youtube.com/HITDeveloper2023").replace(/@runtime|&runtime|@uptime|&uptime/gi, '' + runtime(process.uptime())).trim();
      try {
      ...
      if (!_0x7317df || _0x7317df === "msg") {
        ...
        if (/@pp/g.test(_0x3417a5)) {
          ...
          return _0x50ffa3.jid && /@gpp/g.test(_0x3417a5) ? await _0x50ffa3.send(await _0x50ffa3.getpp(_0x50ffa3.jid), {
            'caption': _0x23df3f,
            'mentions': _0x3fa550,
            'contextInfo': _0x3e5cf0
          }, "image", _0x27d774) : await _0x50ffa3.send(_0x23df3f, {
            'mentions': _0x3fa550,
            'contextInfo': _0x3e5cf0
          }, "hitdev", _0x27d774);
        }
    ...
    console.log("./lib/Hitdev.js/sendWelcome()\n", _0x30453c);
  }
}
async function aitts(_0x33c126, _0x2b48e0 = '', _0x30230a = true) {
  try {
    ...
    var _0x30713a = 0x0 || Math.floor(Math.random() * _0x1afcdb.length);
    let _0x53e63c = false;
    if (!isNaN(_0x1cf518) && _0x1cf518 > 0x0 && _0x1cf518 < 0x27) {
      _0x53e63c = true;
      _0x30713a = _0x1cf518;
    }
    if (_0x2b48e0 && _0x2b48e0.includes(':')) {
      let _0x1e4230 = _0x2b48e0.split(':');
      let _0x2d4089 = _0x1e4230[_0x1e4230.length - 0x1].trim() || '';
      _0x19e7c5 = _0x1e4230.slice(0x0, _0x1e4230.length - 0x1).join(':');
      if (_0x2d4089.toLowerCase() === "richel" || _0x2d4089 === '1') {
        _0x30713a = 0x0;
      } else {
        if (_0x2d4089.toLowerCase() === "clyde" || _0x2d4089 === '2') {
          _0x30713a = 0x1;
        } else {
          if (_0x2d4089.toLowerCase() === "domi" || _0x2d4089 === '3') {
            _0x30713a = 0x2;
          } else {
            if (_0x2d4089.toLowerCase() === "dave" || _0x2d4089 === '4') {
              _0x30713a = 0x3;
            } else {
              if (_0x2d4089.toLowerCase() === 'fin' || _0x2d4089 === '5') {
                _0x30713a = 0x4;
              } else {
                if (_0x2d4089.toLowerCase() === "bella" || _0x2d4089 === '6') {
                  _0x30713a = 0x5;
                } else {
                  if (_0x2d4089.toLowerCase() === 'antoni' || _0x2d4089 === '7') {
                    _0x30713a = 0x6;
                  } else {
                    if (_0x2d4089.toLowerCase() === 'thomas' || _0x2d4089 === '8') {
                      _0x30713a = 0x7;
                    } else {
                      if (_0x2d4089.toLowerCase() === 'charlie' || _0x2d4089 === '9') {
                        _0x30713a = 0x8;
                      } else {
                        if (_0x2d4089.toLowerCase() === "emily" || _0x2d4089 === '10') {
                          _0x30713a = 0x9;
                        } else {
                          if (_0x2d4089.toLowerCase() === "elli" || _0x2d4089 === '11') {
                            _0x30713a = 0xa;
                          } else {
                            if (_0x2d4089.toLowerCase() === "callum" || _0x2d4089 === '12') {
                              _0x30713a = 0xb;
                            } else {
                              if (_0x2d4089.toLowerCase() === "patrick" || _0x2d4089 === '13') {
                                _0x30713a = 0xc;
                              } else {
                                if (_0x2d4089.toLowerCase() === "harry" || _0x2d4089 === '14') {
                                  _0x30713a = 0xd;
                                } else {
                                  if (_0x2d4089.toLowerCase() === "liam" || _0x2d4089 === '15') {
                                    _0x30713a = 0xe;
                                  } else {
                                    if (_0x2d4089.toLowerCase() === "dorothy" || _0x2d4089 === '16') {
                                      _0x30713a = 0xf;
                                    } else {
                                      if (_0x2d4089.toLowerCase() === "josh" || _0x2d4089 === '17') {
                                        _0x30713a = 0x10;
                                      } else {
                                        if (_0x2d4089.toLowerCase() === "arnold" || _0x2d4089 === '18') {
                                          _0x30713a = 0x11;
                                        } else {
                                          if (_0x2d4089.toLowerCase() === 'charlotte' || _0x2d4089 === '19') {
                                            _0x30713a = 0x12;
                                          } else {
                                            if (_0x2d4089.toLowerCase() === "matilda" || _0x2d4089 === '20') {
                                              _0x30713a = 0x13;
                                            } else {
                                              if (_0x2d4089.toLowerCase() === "matthew" || _0x2d4089 === '21') {
                                                _0x30713a = 0x14;
                                              } else {
                                                if (_0x2d4089.toLowerCase() === 'james' || _0x2d4089 === '22') {
                                                  _0x30713a = 0x15;
                                                } else {
                                                  if (_0x2d4089.toLowerCase() === "joseph" || _0x2d4089 === '23') {
                                                    _0x30713a = 0x16;
                                                  } else {
                                                    if (_0x2d4089.toLowerCase() === "jeremy" || _0x2d4089 === '24') {
                                                      _0x30713a = 0x17;
                                                    } else {
                                                      if (_0x2d4089.toLowerCase() === "michael" || _0x2d4089 === '25') {
                                                        _0x30713a = 0x18;
                                                      } else {
                                                        if (_0x2d4089.toLowerCase() === "ethan" || _0x2d4089 === '26') {
                                                          _0x30713a = 0x19;
                                                        } else {
                                                          if (_0x2d4089.toLowerCase() === "gigi" || _0x2d4089 === '27') {
                                                            _0x30713a = 0x1a;
                                                          } else {
                                                            if (_0x2d4089.toLowerCase() === "freya" || _0x2d4089 === '28') {
                                                              _0x30713a = 0x1b;
                                                            } else {
                                                              if (_0x2d4089.toLowerCase() === 'grace' || _0x2d4089 === '29') {
                                                                _0x30713a = 0x1c;
                                                              } else {
                                                                if (_0x2d4089.toLowerCase() === 'daniel' || _0x2d4089 === '30') {
                                                                  _0x30713a = 0x1d;
                                                                } else {
                                                                  if (_0x2d4089.toLowerCase() === "serena" || _0x2d4089 === '31') {
                                                                    _0x30713a = 0x1e;
                                                                  } else {
                                                                    if (_0x2d4089.toLowerCase() === "adam" || _0x2d4089 === '32') {
                                                                      _0x30713a = 0x1f;
                                                                    } else {
                                                                      if (_0x2d4089.toLowerCase() === "nicole" || _0x2d4089 === '33') {
                                                                        _0x30713a = 0x20;
                                                                      } else {
                                                                        if (_0x2d4089.toLowerCase() === "jessie" || _0x2d4089 === '34') {
                                                                          _0x30713a = 0x21;
                                                                        } else {
                                                                          if (_0x2d4089.toLowerCase() === "ryan" || _0x2d4089 === '35') {
                                                                            _0x30713a = 0x22;
                                                                          } else {
                                                                            if (_0x2d4089.toLowerCase() === "hitdev" || _0x2d4089 === '36') {
                                                                              _0x30713a = 0x23;
                                                                            } else {
                                                                              if (_0x2d4089.toLowerCase() === "glinda" || _0x2d4089 === '37') {
                                                                                _0x30713a = 0x24;
                                                                              } else {
                                                                                if (_0x2d4089.toLowerCase() === 'giovanni' || _0x2d4089 === '38') {
                                                                                  _0x30713a = 0x25;
...
let setMention = {
  "mention": false,
  "status": async (_0x280219, _0x510e3f = false) => {
    try {
  ...
  "typesArray": _0x59ae98 => {
    try {
      ...
      for (const _0x55bb42 of _0x55b13f) {
        ...
        if (_0x1cf682.length >= 0x1) {
          const _0x243ab6 = _0x1cf682.findIndex(_0x75df3c => _0x75df3c.startsWith("type/"));
          if (_0x243ab6 !== -0x1) {
            _0xef10c6 = _0x1cf682[_0x243ab6].slice(0x5).toLowerCase();
            let _0x192321 = /hitdev|smd|message|chat/gi.test(_0xef10c6);
            if (!_0x4656bb[_0x192321 ? "hitdev" : _0xef10c6]) {
              _0x4656bb[_0x192321 ? "hitdev" : _0xef10c6] = [];
            }
          }
          const _0x26ebaf = _0x1cf682.filter(_0x1fa91c => _0x1fa91c !== "type/" + _0xef10c6 && _0x1fa91c !== '');
          _0xef10c6 = /hitdev|smd|message|chat/gi.test(_0xef10c6) ? "hitdev" : _0xef10c6;
          if (_0x26ebaf.length > 0x0) {
            if (_0x22e9cc.includes(_0xef10c6)) {
              ...
              _0x4656bb[/hitdev/gi.test(_0xef10c6) ? 'hitdev' : 'text'].push(_0x26ebaf.join(" "));
            }
          }
        }
        _0xef10c6 = null;
  ...
  "update": async (_0x526d31, _0x1520b5) => {
    try {
      setMention.mention = false;
      let _0x50fd1f = {
        "status": true,
  ...
  "cmd": async (_0x501ec5, _0x2a1c43 = '') => {
    try {
      let _0x22516b = false || false;
      if (!_0x22516b) {
      ...
      if (_0x2a1c43 === 'get' || _0x2a1c43 === "info" || !_0x2a1c43 && _0x22516b.status && _0x22516b.get) {
        ...
        if (!_0x2a1c43) {
          _0x501ec5.reply("_Read wiki to set mention message https://github.com/HITDeveloper2023/HITDEV-MD/wiki/mention_", {}, 'smd');
        } else {
          if (['off', "deact", 'disable', "false"].includes(_0x2a1c43.toLowerCase() || _0x2a1c43)) {
            setMention.status(_0x501ec5, false);
          } else {
            if (['on', 'act', "enable", 'true', "active"].includes(_0x2a1c43.toLowerCase() || _0x2a1c43)) {
              setMention.status(_0x501ec5, true);
            } else {
              if (["check", "test", 'me'].includes(_0x2a1c43.toLowerCase() || _0x2a1c43)) {
  ...
  "randome": _0x464e51 => {
    try {
      ...
      if (_0x47aeca.length > 0x1) {
        const _0x2589e6 = _0x47aeca[Math.floor(Math.random() * (_0x47aeca.length - 0x1)) + 0x1];
        const _0x3755b9 = _0x464e51[_0x2589e6];
        if (_0x3755b9 && _0x3755b9.length > 0x0) {
      ...
      return _0x464e51 && _0x464e51.text ? {
...
global.mentionhitdev = process.env.MENTIONHITDEV || true;
setMention.check = async (_0x373988, _0x3c756b = '', _0xde3e80 = false) => {
  try {
    const _0x313fc4 = _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes('@' + _0x373988.user.split('@')[0x0]) || global.mentionhitdev && (_0x373988.mentionedJid.includes("@50944727644@s.whatsapp.net") || _0x373988.mentionedJid.includes("@923004591719@s.whatsapp.net") || /@50944727644|@923004591719/g.test(_0x3c756b));
    if (_0x313fc4) {
      if (global.SmdOfficial !== "yes") {
        return;
      }
      let _0x5f58a2 = false || false;
      if (!_0x5f58a2) {
...
let setFilter = {
  ...
  stop: async (_0x103724, _0xc4e239 = '') => {
    try {
      if (!_0xc4e239) {
  ...
  "list": async (_0xdb3bd0, _0x43f090 = '') => {
    try {
  ...
  "check": async (_0x26e5fd, _0x1061b1 = '') => {
    try {
      let _0x148446 = false || false;
      if (!_0x148446) {
